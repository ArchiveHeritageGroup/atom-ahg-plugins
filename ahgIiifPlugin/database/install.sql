...
CREATE TABLE IF NOT EXISTS `iiif_annotation` (
  ...
  `motivation` VARCHAR(94) COMMENT 'commenting, tagging, describing, linking, transcribing, identifying, supplementing' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'commenting',
...
CREATE TABLE IF NOT EXISTS `iiif_collection` (
  ...
  `viewing_hint` VARCHAR(59) COMMENT 'individuals, paged, continuous, multi-part, top' DEFAULT 'individuals',
...
CREATE TABLE IF NOT EXISTS `iiif_collection_item` (
  ...
  `item_type` VARCHAR(32) COMMENT 'manifest, collection' DEFAULT 'manifest',
...
CREATE TABLE IF NOT EXISTS `iiif_ocr_block` (
  ...
  `block_type` VARCHAR(41) COMMENT 'word, line, paragraph, region' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'word',
...
CREATE TABLE IF NOT EXISTS `iiif_ocr_text` (
  ...
  `format` VARCHAR(29) COMMENT 'plain, alto, hocr' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'plain',
...
CREATE TABLE IF NOT EXISTS `iiif_auth_access_log` (
    ...
    `action` VARCHAR(74) COMMENT 'view, download, token_request, token_grant, token_deny, logout' NOT NULL,
    `ip_address` VARCHAR(45) NULL,
    `user_agent` VARCHAR(500) NULL,
    `details` JSON NULL,
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
