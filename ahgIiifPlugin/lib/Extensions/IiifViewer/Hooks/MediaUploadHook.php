 ...
 * 
 * Installation:
 * 1. Copy to: ' . sfConfig::get('sf_plugins_dir') . '/ahgThemeB5Plugin/lib/
...
class MediaUploadHook
{
    ...
    {
        $settings = [
            'uploads_dir' => sfConfig::get('sf_upload_dir', sfConfig::get('sf_root_dir') . '/uploads'),
            'derivatives_dir' => sfConfig::get('sf_upload_dir', sfConfig::get('sf_root_dir') . '/uploads') . '/derivatives',
        ];
