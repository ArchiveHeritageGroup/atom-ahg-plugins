...
class IiifAnnotationService
{
    ...
    public function __construct($baseUrl = null)
    {
        ...
        $this->baseUrl = null !== $baseUrl
            ? rtrim($baseUrl, '/')
            : self::detectBaseUrl();
    }

    /**
     * Base URL for minted annotation identifiers.
     *
     * An annotation `@id` is a durable identifier, not a convenience URL, so
     * getting this wrong outlives the request that got it wrong. This method
     * previously read:
     *
