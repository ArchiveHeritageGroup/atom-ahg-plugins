...
<div class="mb-4">
  <a href="<?php echo url_for(['module' => 'ahgMediaSettings', 'action' => 'processQueue', 'limit' => 5]) ?>" class="btn btn-primary">
    <i class="fas fa-play me-1"></i>
    <?php echo __('Process Next 5 Items') ?>
  </a>
  <a href="<?php echo url_for(['module' => 'ahgMediaSettings', 'action' => 'clearQueue']) ?>" class="btn btn-outline-danger"
     onclick="return confirm('<?php echo __('Clear all completed and failed items?') ?>')">
    <i class="fas fa-trash me-1"></i>
    <?php echo __('Clear Completed') ?>
  </a>
  <a href="<?php echo url_for(['module' => 'ahgMediaSettings', 'action' => 'index']) ?>" class="btn btn-outline-secondary">
