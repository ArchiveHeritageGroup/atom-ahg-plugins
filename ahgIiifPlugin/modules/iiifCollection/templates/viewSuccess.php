...
<div class="sidebar-content">
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <a href="<?php echo url_for(['module' => 'iiifCollection', 'action' => 'addItems', 'id' => $collection->id]) ?>" class="btn btn-success w-100 mb-2">
                <i class="fas fa-plus me-2"></i><?php echo __('Add Items') ?>
            </a>
            <a href="<?php echo url_for(['module' => 'iiifCollection', 'action' => 'edit', 'id' => $collection->id]) ?>" class="btn btn-warning w-100 mb-2">
                <i class="fas fa-edit me-2"></i><?php echo __('Edit Collection') ?>
            </a>
            <a href="<?php echo url_for(['module' => 'iiifCollection', 'action' => 'new', 'parent_id' => $collection->id]) ?>" class="btn btn-outline-success w-100 mb-2">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <dl class="mb-0">
                ...
                <dd><small><code><?php echo url_for(['module' => 'iiifCollection', 'action' => 'manifest', 'slug' => $collection->slug], true) ?></code></small></dd>
            </dl>
        </div>
    </div>
</div>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb mb-2">
        <li class="breadcrumb-item"><a href="<?php echo url_for(['module' => 'iiifCollection', 'action' => 'index']) ?>"><?php echo __('Collections') ?></a></li>
        <?php foreach ($breadcrumbs as $bc): ?>
            <?php if ($bc->id === $collection->id): ?>
            <li class="breadcrumb-item active"><?php echo esc_entities($bc->display_name) ?></li>
            <?php else: ?>
            <li class="breadcrumb-item"><a href="<?php echo url_for(['module' => 'iiifCollection', 'action' => 'view', 'id' => $bc->id]) ?>"><?php echo esc_entities($bc->display_name) ?></a></li>
            <?php endif ?>
        <?php endforeach ?>
    </ol>
</nav>
            ...
            <div class="row row-cols-1 row-cols-md-3 g-3">
                ...
                <div class="col">
                    <div class="card h-100">
                        <div class="card-body">
                            <h6 class="card-title">
                                <a href="<?php echo url_for(['module' => 'iiifCollection', 'action' => 'view', 'id' => $sub->id]) ?>">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info mb-0">
                ...
                <?php if ($sf_user->isAuthenticated()): ?>
                <a href="<?php echo url_for(['module' => 'iiifCollection', 'action' => 'addItems', 'id' => $collection->id]) ?>"><?php echo __('Add items') ?></a>
                <?php endif ?>
            </div>
            <?php else: ?>
    ...
    if (tbody) {
        new Sortable(tbody, {
            ...
            onEnd: function(evt) {
                ...
                fetch('<?php echo url_for(['module' => 'iiifCollection', 'action' => 'reorder']) ?>', {
                    method: 'POST',
