...
require_once sfConfig::get('sf_plugins_dir') . '/ahgDisplayPlugin/lib/helper/DisplayHelper.php';
...
<div class="display-object display-<?php echo $layout; ?> type-<?php echo $objectType; ?> <?php echo $data['css_class'] ?? ''; ?>" 
    ...
    $layoutTemplate = sfConfig::get('sf_plugins_dir') . '/ahgDisplayPlugin/templates/layouts/_' . $layout . '.php';
    if (file_exists($layoutTemplate)) {
        include $layoutTemplate;
    } else {
        include sfConfig::get('sf_plugins_dir') . '/ahgDisplayPlugin/templates/layouts/_detail.php';
    }
    ?>
    ...
    <div class="object-actions mt-4 pt-3 border-top d-print-none">
        <?php foreach ($data['actions'] as $action): 
            $actionTemplate = sfConfig::get('sf_plugins_dir') . '/ahgDisplayPlugin/templates/actions/_' . $action . '.php';
