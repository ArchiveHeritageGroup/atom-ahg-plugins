...
class DisplaySearchResultAdapter
{
    ...
    public function renderHit(array $hit): string
    {
        ...
        $layoutTemplate = sfConfig::get('sf_plugins_dir') . '/ahgDisplayPlugin/templates/layouts/_' . $data['layout'] . '.php';
        ...
        if (file_exists($layoutTemplate)) {
            ...
            include sfConfig::get('sf_plugins_dir') . '/ahgDisplayPlugin/templates/layouts/_card.php';
        }
