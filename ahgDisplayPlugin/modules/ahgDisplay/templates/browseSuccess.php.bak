              ...
              <tr>
                <td class="text-center p-1">
                  <?php if ($obj->thumbnail): ?>
                    <a href="<?php echo getItemUrl($obj) ?>"><img src="<?php echo $obj->thumbnail ?>" alt="" class="rounded img-thumbnail" style="width:200px;height:200px;object-fit:cover;"></a>
                  <?php else: ?>
                    <a href="<?php echo getItemUrl($obj) ?>"><div class="bg-light rounded d-flex align-items-center justify-content-center" style="width:160px;height:160px;"><i class="fas <?php echo $cfg['icon'] ?> text-<?php echo $cfg['color'] ?>"></i></div></a>
                  <?php endif ?>
                </td>
