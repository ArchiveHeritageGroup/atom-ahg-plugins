            ...
            <div class="results-header d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <div class="btn-group btn-group-sm">
                        ...
                        <a href="?<?php echo http_build_query(array_merge($_GET, ['layout' => 'masonry'])); ?>" 
                    ...
                    <select class="form-select form-select-sm" style="width: auto;" onchange="location=this.value">
                        ...
                        <option value="?<?php echo http_build_query(array_merge($_GET, ['sort' => 'identifier'])); ?>" <?php echo ($params['sort'] ?? '') === 'identifier' ? 'selected' : ''; ?>>Identifier</option>
                    </select>
                </div>
            </div>
