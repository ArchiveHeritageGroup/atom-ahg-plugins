...
<div class="tab-content mb-3" id="treeview-content">
  ...
  <div class="tab-pane fade<?php echo ('sidebar' != $treeviewType) ? ' show active' : ''; ?>" id="treeview-search" role="tabpanel" aria-labelledby="treeview-search-tab">
    ...
    <form method="get" role="search" class="p-2 bg-white border" action="<?php echo url_for(['module' => 'ahgSearch', 'action' => 'index', 'collection' => $resource->getCollectionRoot()->id]); ?>" data-not-found="<?php echo __('No results found.'); ?>">
