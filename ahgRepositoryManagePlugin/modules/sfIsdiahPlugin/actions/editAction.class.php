<?php
use AtomFramework\Http\Controllers\AhgRepositoryEditController;
...
// Load base RepositoryEditAction from core
require_once sfConfig::get('sf_root_dir').'/apps/qubit/modules/repository/actions/editAction.class.php';
 ...
 */
class sfIsdiahPluginEditAction extends AhgRepositoryEditController
{
