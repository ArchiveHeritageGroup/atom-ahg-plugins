    ...
    <div class="accordion-item">
      ...
      <div id="collapse-adv-search" class="accordion-collapse collapse<?php echo $show ? ' show' : ''; ?>" aria-labelledby="heading-adv-search">
        <div class="accordion-body">
          <?php include_partial('repositoryManage/advancedFilters', [
...
<?php slot('content'); ?>
  <?php if (in_array($currentDisplayMode, ['list', 'tree'])) { ?>
    <?php include_partial('repositoryManage/browseTableView', [
        'pager' => $pager,
  ...
  <?php } else { ?>
    <?php include_partial('repositoryManage/browseCardView', [
        'pager' => $pager,
        'selectedCulture' => $selectedCulture,
    ]); ?>
  <?php } ?>
