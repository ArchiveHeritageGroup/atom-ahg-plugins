...
CREATE TABLE IF NOT EXISTS marketplace_settings (
    ...
    setting_type ENUM('text','number','boolean','json','currency') DEFAULT 'text',
...
CREATE TABLE IF NOT EXISTS marketplace_category (
    id INT AUTO_INCREMENT PRIMARY KEY,
    sector ENUM('gallery','museum','archive','library','dam') NOT NULL,
    parent_id INT NULL,
    name VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS marketplace_seller (
    ...
    seller_type ENUM('artist','gallery','institution','collector','estate') NOT NULL,
    actor_id INT NULL,
    ...
    payout_method ENUM('bank_transfer','paypal','payfast','manual') DEFAULT 'bank_transfer',
    ...
    trust_level ENUM('new','active','trusted','premium') DEFAULT 'new',
...
CREATE TABLE IF NOT EXISTS marketplace_listing (
    ...
    sector ENUM('gallery','museum','archive','library','dam') NOT NULL,
    listing_type ENUM('fixed_price','auction','offer_only') NOT NULL,
    status ENUM('draft','pending_review','active','reserved','sold','expired','withdrawn','suspended') DEFAULT 'draft',
    ...
    condition_rating ENUM('mint','excellent','good','fair','poor') NULL,
...
CREATE TABLE IF NOT EXISTS marketplace_auction (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    listing_id BIGINT UNSIGNED NOT NULL,
    auction_type ENUM('english','sealed_bid','dutch') DEFAULT 'english',
...
CREATE TABLE IF NOT EXISTS marketplace_transaction (
    ...
    seller_id BIGINT UNSIGNED NOT NULL,
    buyer_id INT NOT NULL,
    source ENUM('fixed_price','auction','offer') NOT NULL,
    ...
    payment_status ENUM('pending','paid','failed','refunded','disputed') DEFAULT 'pending',
    payment_gateway VARCHAR(50) NULL,
    payment_transaction_id VARCHAR(255) NULL,
    gateway_response JSON NULL,
    paid_at DATETIME NULL,
    shipping_status ENUM('pending','preparing','shipped','in_transit','delivered','returned') DEFAULT 'pending',
    ...
    status ENUM('pending_payment','paid','shipping','delivered','completed','cancelled','disputed','refunded') DEFAULT 'pending_payment',
...
CREATE TABLE IF NOT EXISTS marketplace_payout (
    ...
    currency VARCHAR(3) DEFAULT 'ZAR',
    method ENUM('bank_transfer','paypal','payfast','manual','stripe_connect') NOT NULL,
...
CREATE TABLE IF NOT EXISTS marketplace_collection (
    ...
    collection_type ENUM('curated','exhibition','seasonal','featured','genre','sale') DEFAULT 'curated',
...
-- Platform settings
INSERT INTO marketplace_settings (setting_key, setting_value, setting_type, setting_group, description) VALUES
...
-- Currencies
INSERT INTO marketplace_currency (code, name, symbol, exchange_rate_to_zar, is_active, sort_order) VALUES
...
INSERT INTO marketplace_category (sector, name, slug, sort_order) VALUES
