...
class DataSourceRegistry
{
    ...
    private static array $sources = [
        ...
        'geospatial_repository' => [
            ...
            'class_name' => null,
            'icon' => 'bi-geo-alt',
            'description' => 'Geographic coordinates of archival repositories',
            'category' => 'Geospatial',
        ],
        'geospatial_digital' => [
            'label' => 'Digital Object GPS',
            'table' => 'digital_object_metadata',
            'i18n_table' => null,
            'object_table' => null,
            'class_name' => null,
            'icon' => 'bi-pin-map',
            'description' => 'GPS coordinates from digital asset EXIF data',
            'category' => 'Geospatial',
        ],
        'geospatial_dam' => [
            'label' => 'DAM Asset GPS',
            ...
            'class_name' => null,
            'icon' => 'bi-geo',
            'description' => 'GPS coordinates from IPTC metadata',
            'category' => 'Geospatial',
        ],
        'geospatial_sites' => [
            'label' => 'Archaeological Sites',
            'table' => 'nmmz_archaeological_site',
            'i18n_table' => null,
            'object_table' => null,
            'class_name' => null,
            'icon' => 'bi-signpost-2',
            'description' => 'Archaeological site locations with GPS coordinates',
            'category' => 'Geospatial',
        ],
        'geospatial_monuments' => [
            'label' => 'Monuments',
            'table' => 'nmmz_monument',
            'i18n_table' => null,
            'object_table' => null,
            ...
            'description' => 'Monument locations with GPS coordinates',
            'category' => 'Geospatial',
        ],
        'geospatial_storage' => [
            ...
            'description' => 'Physical storage location coordinates',
            'category' => 'Geospatial',
        ],
        'geospatial_usage' => [
            'label' => 'Usage Event Locations',
            'table' => 'ahg_usage_event',
            'i18n_table' => null,
            'object_table' => null,
            'class_name' => null,
            'icon' => 'bi-cursor',
            'description' => 'Geographic locations of access/usage events',
            'category' => 'Geospatial',
        ],
    ];
