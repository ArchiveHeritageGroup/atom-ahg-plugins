# ISAD(G) Information Object Manage

ISAD(G) information object CRUD management — create, edit, delete, digital object upload, treeview navigation via Laravel Query Builder
...
cd tmp-fetch && git sparse-checkout set ahgInformationObjectManagePlugin && cd ..
mv tmp-fetch/ahgInformationObjectManagePlugin ./ahgInformationObjectManagePlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgInformationObjectManagePlugin/database/install.sql
