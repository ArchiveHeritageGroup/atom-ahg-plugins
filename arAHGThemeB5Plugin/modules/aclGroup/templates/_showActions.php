<?php if (\AtomExtensions\Services\AclService::check($group, ['create', 'update', 'delete', 'list'])) { ?>

  <ul class="actions mb-3 nav gap-2">

    <?php if (\AtomExtensions\Services\AclService::check($group, 'update')) { ?>
