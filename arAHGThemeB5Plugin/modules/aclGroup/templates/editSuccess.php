    ...
    <div class="accordion mb-3">
      <div class="accordion-item">
        <h2 class="accordion-header" id="group-edit">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#main-collapse" aria-expanded="false" aria-controls="main-collapse">
            <?php echo __('Main area'); ?>
          </button>
        </h2>
        <div id="main-collapse" class="accordion-collapse collapse" aria-labelledby="main-heading">
