            ...
            <?php if (isset($permissions[$key])) { ?>
              <div class="form-check form-check-inline">
                <input
                  ...
                  value="<?php echo \AtomExtensions\Services\AclService::GRANT; ?>">
              ...
              <div class="form-check form-check-inline">
                <input
                  ...
                  value="<?php echo \AtomExtensions\Services\AclService::DENY; ?>">
              ...
              <div class="form-check form-check-inline">
                <input
                  ...
                  value="<?php echo \AtomExtensions\Services\AclService::INHERIT; ?>">
