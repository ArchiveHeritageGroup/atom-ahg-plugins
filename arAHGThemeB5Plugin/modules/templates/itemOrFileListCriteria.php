...
<?php slot('title'); ?>
  <div class="multiline-header d-flex flex-column mb-3">
    <h1 class="mb-0" aria-describedby="heading-label">
      <?php echo __('%1 list - report criteria', ['%1' => $type]); ?>
    </h1>
...
<?php slot('content'); ?>
  ...
  <?php echo $form->renderFormTag(url_for([$resource, 'module' => 'informationobject', 'action' => 'itemOrFileList', 'type' => $type]), ['class' => 'form-inline']); ?>
    ...
    <div class="accordion mb-3">
      <div class="accordion-item">
        <h2 class="accordion-header" id="report-criteria-heading">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#report-criteria-collapse" aria-expanded="false" aria-controls="report-criteria-collapse">
            <?php echo __('Report criteria'); ?>
          </button>
        </h2>
        <div id="report-criteria-collapse" class="accordion-collapse collapse" aria-labelledby="report-criteria-heading">
