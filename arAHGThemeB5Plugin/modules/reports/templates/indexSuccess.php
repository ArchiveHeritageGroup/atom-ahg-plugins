...
$hasGallery = isPluginActive('arGalleryPlugin');
$hasDam = isPluginActive('arDAMPlugin') || isPluginActive('ahgDAMPlugin');
$hasSpectrum = isPluginActive('arSpectrumPlugin');
$hasGrap = isPluginActive('arGrapPlugin');
$hasResearch = isPluginActive('ahgResearchPlugin');
$hasDonor = isPluginActive('ahgDonorPlugin');
$hasRights = isPluginActive('arExtendedRightsPlugin');
$hasCondition = isPluginActive('arConditionPlugin');
$hasPrivacy = isPluginActive('arPrivacyPlugin');
$hasSecurity = isPluginActive('arSecurityClearancePlugin');
