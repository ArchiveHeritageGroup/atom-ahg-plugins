  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="alert alert-info mb-4">
        ...
        <?php echo __('Levels are managed in the standard Taxonomy. Here you assign which levels appear in each sector (Archive, Museum, Library, Gallery, DAM). Each sector can have different levels available.'); ?>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-12 mb-4">
          <ul class="nav nav-tabs">
            <?php foreach ($sf_data->getRaw('sectors') as $sector): ?>
              <li class="nav-item">
                <a class="nav-link <?php echo $currentSector === $sector ? 'active' : ''; ?>" 
                   href="<?php echo url_for(['module' => 'ahgSettings', 'action' => 'levels', 'sector' => $sector]); ?>">
                  <i class="fas fa-<?php echo getSectorIcon($sector); ?> me-1"></i>
                  <?php echo ucfirst($sector); ?>
                  <span class="badge bg-secondary ms-1"><?php echo count($sf_data->getRaw('sectorLevels')->where('sector', $sector)); ?></span>
                </a>
              </li>
            <?php endforeach; ?>
          </ul>
        ...
        <div class="col-lg-8">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form method="post" action="<?php echo url_for(['module' => 'ahgSettings', 'action' => 'levels', 'sector' => $currentSector]); ?>">
                ...
                <div class="row">
                  <?php foreach ($sf_data->getRaw('allLevels') as $level): ?>
