...
<div class="sidebar-content">
    ...
    <div class="card">
        ...
        <div class="list-group list-group-flush">
            <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'index']) ?>" class="list-group-item list-group-item-action">
...
<form method="post" action="<?php echo url_for(['module' => 'arIiifViewerSettings', 'action' => 'index']) ?>">
