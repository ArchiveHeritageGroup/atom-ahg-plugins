<?php include(sfConfig::get('sf_plugins_dir').'/arAHGThemeB5Plugin/modules/ahgSettings/templates/_dynamicStyles.php'); ?>

<!-- D3.js for visualizations -->
<script src="https://d3js.org/d3.v7.min.js"></script>

<!-- AHG Media Player Scripts -->
<script src="/plugins/arAHGThemeB5Plugin/js/atom-media-player.js"></script>
<script src="/plugins/arAHGThemeB5Plugin/js/media-controls.js"></script>
...
<script src="/plugins/arAHGThemeB5Plugin/js/levelSectorFilter.js"></script>
