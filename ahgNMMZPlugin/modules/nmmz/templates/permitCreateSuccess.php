...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col">
            ...
            <p class="text-muted">Apply to export antiquities or heritage objects under NMMZ Act</p>
        </div>
    </div>
    ...
    <form method="post" class="row g-4">
        ...
        <div class="col-lg-4">
            ...
            <div class="alert alert-info">
                ...
                <ul class="small mb-0">
                    <li>Export of antiquities requires NMMZ approval</li>
                    <li>Processing may take 2-4 weeks</li>
                    <li>Fees apply per NMMZ schedule</li>
