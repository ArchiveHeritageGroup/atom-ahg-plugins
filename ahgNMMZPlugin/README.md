# Zimbabwe NMMZ Compliance

Zimbabwe National Museums and Monuments Act [Chapter 25:11] compliance — monument register, antiquities, export permits, archaeological sites, heritage impact assessments
...
cd tmp-fetch && git sparse-checkout set ahgNMMZPlugin && cd ..
mv tmp-fetch/ahgNMMZPlugin ./ahgNMMZPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgNMMZPlugin/database/install.sql
