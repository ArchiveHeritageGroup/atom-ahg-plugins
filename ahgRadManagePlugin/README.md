...
RAD (Rules for Archival Description) descriptive standard edit form for information objects
...
cd tmp-fetch && git sparse-checkout set ahgRadManagePlugin && cd ..
mv tmp-fetch/ahgRadManagePlugin ./ahgRadManagePlugin && rm -rf tmp-fetch
