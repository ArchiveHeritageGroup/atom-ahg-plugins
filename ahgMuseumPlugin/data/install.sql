...
-- Object
SET @obj_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Object' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
-- Artwork
SET @art_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Artwork' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
-- Artifact
SET @artf_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Artifact' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
-- Specimen
SET @spec_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Specimen' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
-- Installation
SET @inst_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Installation' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
-- 3D Model
SET @model_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='3D Model' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
