...
<?php slot('before-content'); ?>
    ...
    <?php if ($cartId && $userId) { ?>
        <a href="<?php echo url_for(['module' => 'cart', 'action' => 'browse']); ?>" class="c-btn c-btn-submit"><?php echo __('Go to Cart'); ?></a>
    <?php } elseif ($userId) { ?>
        <a href="<?php echo cco_build_url($resource, 'informationobject', 'addCart'); ?>" class="c-btn c-btn-submit"><?php echo __('Add to Cart'); ?></a>
    <?php } ?>
