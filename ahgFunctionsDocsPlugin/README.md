# AHG Functions Docs Plugin

Auto-generated, browsable catalogue of routes, CLI tasks and services (#148, parity with Heratio ahg-functions-docs).
...
cd tmp-fetch && git sparse-checkout set ahgFunctionsDocsPlugin && cd ..
mv tmp-fetch/ahgFunctionsDocsPlugin ./ahgFunctionsDocsPlugin && rm -rf tmp-fetch
