...
Multi-regional heritage asset financial accounting with support for IPSAS, GRAP, FRS, GASB, AASB, PSAS standards
...
cd tmp-fetch && git sparse-checkout set ahgHeritageAccountingPlugin && cd ..
mv tmp-fetch/ahgHeritageAccountingPlugin ./ahgHeritageAccountingPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgHeritageAccountingPlugin/database/install.sql
