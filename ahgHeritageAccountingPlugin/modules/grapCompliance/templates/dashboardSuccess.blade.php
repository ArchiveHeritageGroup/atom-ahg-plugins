    ...
    <div class="row">
            ...
            <div class="card h-100">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="{{ url_for(['module' => 'grapCompliance', 'action' => 'batchCheck']) }}" class="btn btn-outline-primary">
                            <i class="fas fa-check-double me-2"></i>{{ __('Run Batch Compliance Check') }}
                        </a>
                        <a href="{{ url_for(['module' => 'grapCompliance', 'action' => 'nationalTreasuryReport']) }}" class="btn btn-outline-success">
                            <i class="fas fa-file-alt me-2"></i>{{ __('National Treasury Report') }}
                        </a>
                        <a href="{{ url_for(['module' => 'heritageAccounting', 'action' => 'browse', 'standard_id' => 1]) }}" class="btn btn-outline-info">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    @if($complianceSummary['total_assets'] > 0)
                        @php
                                    ...
                                    @foreach($recentAssets as $asset)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url_for(['module' => 'grapCompliance', 'action' => 'check', 'id' => $asset->id]) }}" class="btn btn-sm btn-outline-primary">
