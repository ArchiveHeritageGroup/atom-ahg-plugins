    ...
    public function up(): void
    {
        ...
        if (!$schema->hasTable('grap_heritage_asset')) {
            ...
            $schema->create('grap_heritage_asset', function (Blueprint $table) {
                ...
                $table->string('recognition_status', 81)->default('not_assessed')->comment('recognized, not_recognized, pending, not_assessed');
                ...
                // Valuation
                $table->string('measurement_basis', 69)->nullable()->comment('cost, fair_value, deemed_cost, nominal');
        ...
        if (!$schema->hasTable('grap_transaction_log')) {
            ...
            $schema->create('grap_transaction_log', function (Blueprint $table) {
                ...
                $table->string('transaction_type', 112)->comment('acquisition, revaluation, impairment, disposal, transfer, depreciation, correction');
        ...
        if (!$schema->hasTable('grap_compliance_check')) {
            ...
            $schema->create('grap_compliance_check', function (Blueprint $table) {
                ...
                $table->string('check_type', 46)->comment('full, quick, automated');
