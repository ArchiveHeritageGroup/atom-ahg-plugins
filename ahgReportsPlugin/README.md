...
Central reporting dashboard with accession, authority, repository, storage and taxonomy reports

| | |
|---|---|
| Machine name | `ahgReportsPlugin` |
| Version | 1.1.0 |
| Category | admin |
...
cd tmp-fetch && git sparse-checkout set ahgReportsPlugin && cd ..
mv tmp-fetch/ahgReportsPlugin ./ahgReportsPlugin && rm -rf tmp-fetch
