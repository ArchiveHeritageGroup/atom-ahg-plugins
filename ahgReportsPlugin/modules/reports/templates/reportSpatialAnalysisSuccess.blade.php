...
<div class="container-fluid px-4 py-3">
    ...
    <form method="post" action="{{ url_for('reports/reportSpatialAnalysis') }}">
        <div class="row">
            <!-- Main Configuration -->
            <div class="col-lg-8">
                <!-- Coordinate Source -->
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <button type="submit" name="export" value="1" formaction="{{ url_for('reports/reportSpatialAnalysis') }}?format=json" class="btn btn-outline-secondary">
