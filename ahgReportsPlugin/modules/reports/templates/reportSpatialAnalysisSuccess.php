...
<div class="container-fluid px-4 py-3">
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo url_for('reports/index') ?>">Reports</a></li>
    ...
    <form method="post" action="<?php echo url_for('reports/reportSpatialAnalysis') ?>">
        <div class="row">
            <!-- Main Configuration -->
            <div class="col-lg-8">
                <!-- Coordinate Source -->
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="level_of_description" name="level_of_description">
                                        ...
                                        <?php foreach ($availableLevels as $id => $name): ?>
                                            <option value="<?php echo esc_specialchars($name) ?>"><?php echo esc_specialchars($name) ?></option>
                                        <?php endforeach ?>
                                    </select>
...
Khoi</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="painted_terms" name="painted_terms" rows="6"><?php echo esc_specialchars($defaultPaintedTerms) ?></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="engraved_terms" name="engraved_terms" rows="6"><?php echo esc_specialchars($defaultEngravedTerms) ?></textarea>
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <button type="submit" name="export" value="1" formaction="<?php echo url_for('reports/reportSpatialAnalysis') ?>?format=json" class="btn btn-outline-secondary">
                ...
                <div class="card">
                    ...
                    <div class="card-body small">
                        ...
                        <ul class="mb-2">
                            <li><strong>Property Table:</strong> Custom fields stored in AtoM's property table</li>
    ...
    <?php if (isset($previewData) && $previewData): ?>
    <!-- Preview Results -->
    <div class="card mt-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h6 class="mb-0"><i class="bi bi-table me-2"></i>Preview Results</h6>
            <span class="badge bg-primary"><?php echo $previewData['count'] ?> records (limited to 10)</span>
        </div>
        <div class="card-body p-0">
            ...
            <div class="table-responsive">
                <table class="table table-sm table-hover mb-0">
                    <thead class="table-light">
                        <tr>
                            <?php foreach ($previewData['headers'] as $key => $label): ?>
                                <th><?php echo esc_specialchars($label) ?></th>
                            <?php endforeach ?>
                        </tr>
                    </thead>
                    <tbody>
                        <?php foreach ($previewData['rows'] as $row): ?>
                            <tr>
                                <?php foreach (array_keys($previewData['headers']) as $key): ?>
                                    <td>
                                        <?php
                                        $value = $row[$key] ?? '';
                                        if ($key === 'subjects_concatenated' && strlen($value) > 50) {
                                            echo '<span title="' . esc_specialchars($value) . '">' . esc_specialchars(substr($value, 0, 50)) . '...</span>';
