...
function create_cookie(name, value, days2expire, path) {
  ...
  document.cookie = name + '=' + value + ';' +
    	...
    	<a href="{{ url_for(['module' => 'physicalobject', 'action' => 'boxLabelCsv']) }}" class="remove-filter">Search</a>

    </div>

    <div class="filter">
   		<a href="{{ url_for(['module' => 'physicalobject', 'action' => 'boxLabelCsvExport']) }}" class="remove-filter">Strongrooms Export</a>
    </div>

    <div class="filter">
    	<a href="{{ url_for(['module' => 'bookoutobject', 'action' => 'browse']) }}" class="remove-filter">Booked Out</a>
    </div>

    <div class="filter">
    	<a href="{{ url_for(['module' => 'reports', 'action' => 'browsePublish']) }}" class="remove-filter">Publish</a>
    </div>

	<!--NARSSA / Plain Sailing remove
    <div class="filter">
   		<a href="{{ url_for(['module' => 'physicalobject', 'action' => 'pdf']) }}" class="remove-filter">pdf Creator</a>
    </div-->
