...
<style <?php echo $cspNonce ? preg_replace('/^nonce=/', 'nonce="', $cspNonce).'"' : ''; ?>>
  .label-font-size-11pt-0089 { font-size: 11pt; }
  .label-max-width-300px-c0dc { max-width: 300px; }
</style>
...
// api.qrserver.com, which sent the identifier and public URL to third parties
// and produced nothing offline (#260). Every dropdown option is pre-rendered so
// switching source is a local swap, keyed by the option's value.
$barcodeUris = [];
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="label-preview" id="labelContent" class="label-max-width-300px-c0dc">
                    <div id="labelTitle" class="fw-bold mb-2 label-font-size-11pt-0089" >
