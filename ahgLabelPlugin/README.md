...
cd tmp-fetch && git sparse-checkout set ahgLabelPlugin && cd ..
mv tmp-fetch/ahgLabelPlugin ./ahgLabelPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgLabelPlugin/database/install.sql
