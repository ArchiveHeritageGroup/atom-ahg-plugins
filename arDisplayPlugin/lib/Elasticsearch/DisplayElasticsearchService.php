...
class DisplayElasticsearchService
{
    ...
    public function __construct(?string $culture = null)
    {
        ...
        require_once sfConfig::get('sf_plugins_dir') . '/arDisplayPlugin/lib/Services/DisplayService.php';
    ...
    {
        $displayMapping = require sfConfig::get('sf_plugins_dir') . '/arDisplayPlugin/lib/Elasticsearch/displayMapping.php';
