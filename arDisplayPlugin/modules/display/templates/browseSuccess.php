      ...
      <table class="table table-hover table-sm">
        <thead class="table-light">
          <tr>
            ...
            <th style="width:160px"><?php echo __('Level'); ?></th>
            <th style="width:160px"><?php echo __('Type'); ?></th>
              ...
              <tr>
                <td class="text-center p-1">
                  <?php if ($obj->thumbnail): ?>
                    <img src="<?php echo $obj->thumbnail ?>" alt="" class="rounded" class="img-thumbnail" style="width:200px;height:200px;object-fit:cover;">
                  <?php else: ?>
                    <div class="bg-light rounded d-flex align-items-center justify-content-center" style="width:160px;height:160px;"><i class="fas <?php echo $cfg['icon'] ?> text-<?php echo $cfg['color'] ?>"></i></div>
                  <?php endif ?>
                </td>
          ...
          <div class="col">
            <div class="card h-100 shadow-sm">
              <div class="card-img-top bg-light d-flex align-items-center justify-content-center" style="height:120px;overflow:hidden;">
                <?php if ($obj->thumbnail): ?>
                  <img src="<?php echo $obj->thumbnail ?>" alt="" class="img-fluid" style="max-height:120px;object-fit:cover;">
                <?php else: ?>
                  <i class="fas <?php echo $cfg['icon'] ?> fa-3x text-<?php echo $cfg['color'] ?>"></i>
                <?php endif ?>
              </div>
        ...
        <div class="card mb-3 shadow-sm">
          <div class="row g-0">
            <div class="col-12 col-md-6 position-relative overflow-hidden" style="background:#f8f9fa;min-height:400px;">
              <?php if ($obj->thumbnail): ?>
                <img src="<?php echo $obj->thumbnail ?>" alt="" class="rounded" style="width:100%;height:100%;object-fit:contain;position:absolute;top:0;left:0;">
              <?php else: ?>
                <i class="fas <?php echo $cfg['icon'] ?> fa-5x text-<?php echo $cfg['color'] ?>"></i>
              <?php endif ?>
            </div>
        ...
        <div class="card mb-2 shadow-sm">
          <div class="row g-0">
            <div class="col-md-2 d-flex align-items-center justify-content-center p-2" style="background:#f8f9fa;">
              <?php if ($obj->thumbnail): ?>
                <img src="<?php echo $obj->thumbnail ?>" alt="" class="img-fluid rounded" style="max-height:150px;object-fit:contain;">
              <?php else: ?>
                <i class="fas <?php echo $cfg['icon'] ?> fa-4x text-<?php echo $cfg['color'] ?>"></i>
              <?php endif ?>
            </div>
            <div class="col-md-9">
