...
CREATE TABLE IF NOT EXISTS ahg_doi (
    ...
    status ENUM('draft', 'registered', 'findable', 'failed', 'deleted') NOT NULL DEFAULT 'draft',
    minted_at DATETIME,
...
CREATE TABLE IF NOT EXISTS ahg_doi_queue (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    information_object_id INT NOT NULL,
    action ENUM('mint', 'update', 'delete', 'verify') NOT NULL DEFAULT 'mint',
...
CREATE TABLE IF NOT EXISTS ahg_doi_mapping (
    ...
    source_type ENUM('field', 'property', 'note', 'constant', 'template') NOT NULL DEFAULT 'field',
...
INSERT INTO ahg_doi_mapping (datacite_field, source_type, source_value, is_required, fallback_value, sort_order) VALUES
-- Required fields
...
INSERT INTO ahg_doi_config (repository_id, datacite_repo_id, datacite_prefix, datacite_url, environment, default_publisher, default_resource_type) VALUES
