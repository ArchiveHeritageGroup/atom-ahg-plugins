...
CREATE TABLE IF NOT EXISTS ahg_form_template (
    ...
    description TEXT,
    form_type ENUM('information_object', 'accession', 'actor', 'repository', 'custom') NOT NULL DEFAULT 'information_object',
...
CREATE TABLE IF NOT EXISTS ahg_form_field (
    ...
    field_type ENUM('text', 'textarea', 'richtext', 'date', 'daterange', 'select', 'multiselect', 'autocomplete', 'checkbox', 'radio', 'file', 'hidden', 'heading', 'divider') NOT NULL DEFAULT 'text',
...
INSERT INTO ahg_form_template (name, description, form_type, is_system, config_json) VALUES
...
INSERT INTO ahg_form_field (template_id, field_name, field_type, label, section_name, sort_order, is_required, help_text) VALUES
...
INSERT INTO ahg_form_field_mapping (field_id, target_table, target_column, is_i18n)
...
-- Identity Area
INSERT INTO ahg_form_field (template_id, field_name, field_type, label, tab_name, section_name, sort_order, is_required, help_text) VALUES
