...
<div class="heritage-landing herita-margin-0-width-100-max-width-b57c" >
    ...
    <section class="heritage-hero" id="heritage-hero" class="herita-height-calc-100vh-280px-min--0385">
        ...
        <div class="heritage-hero-backgrounds">
            @if(!empty($heroImagesArray))
                @foreach($heroImagesArray as $index => $image)
        ...
        <div class="heritage-hero-content">
            ...
            <!-- Search Box -->
            <form action="{{ url_for(['module' => 'heritage', 'action' => 'search']) }}" method="get" class="heritage-search-box">
                <input type="text"
                       name="q"
    ...
    <section class="heritage-explore-by" id="heritage-explore">
        ...
        <div class="heritage-explore-buttons">
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'timeline']) }}" class="heritage-explore-btn">
                <i class="fas fa-clock"></i> Time
            </a>
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'explore', 'category' => 'place']) }}" class="heritage-explore-btn">
                <i class="fas fa-map-marker-alt"></i> Place
            </a>
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'creators']) }}" class="heritage-explore-btn">
                <i class="fas fa-users"></i> People
            </a>
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'explore', 'category' => 'theme']) }}" class="heritage-explore-btn">
                <i class="fas fa-tag"></i> Theme
            </a>
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'explore', 'category' => 'format']) }}" class="heritage-explore-btn">
                <i class="fas fa-layer-group"></i> Format
            </a>
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'trending']) }}" class="heritage-explore-btn">
                <i class="fas fa-chart-line"></i> Trending
            </a>
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'graph']) }}" class="heritage-explore-btn">
    ...
    <section class="heritage-collections">
        <div class="heritage-section-header">
            ...
            <a href="{{ url_for(['module' => 'informationobject', 'action' => 'browse']) }}" class="heritage-view-all">
        ...
        <div class="heritage-carousel heritage-carousel-autorotate" data-autorotate="5000">
            ...
            <div class="heritage-carousel-track" id="collections-track">
                @foreach($collectionsArray as $index => $collection)
                <?php
                ...
                <a href="{{ $collectionUrl }}" class="heritage-collection-card">
                    <div class="heritage-card-images single-image">
                        ...
                        <div class="main-image fallback-gradient" data-ahg-style="background: {{ $placeholderGradients[$index % 6] }}; height: 280px; display: none; align-items: center; justify-content: center;">
                            <i class="fas {{ $collectionIcon }} herita-font-size-3rem-color-rgba-25-701c" ></i>
                        </div>
                        @else
                        <div class="main-image" data-ahg-style="background: {{ $placeholderGradients[$index % 6] }}; height: 280px; display: flex; align-items: center; justify-content: center;">
                            <i class="fas {{ $collectionIcon }} herita-font-size-3rem-color-rgba-25-701c" ></i>
                        </div>
                        @endif
                    </div>
                    <div class="heritage-card-body">
                        ...
                        <span class="heritage-card-count">
                            <i class="fas {{ $collectionIcon }} me-1 herita-font-size-0-75em-1851" ></i>
    ...
    <section class="heritage-creators">
        <div class="heritage-section-header">
            ...
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'creators']) }}" class="heritage-view-all">
                View All <i class="fas fa-arrow-right"></i>
            </a>
        </div>
        ...
        <div class="heritage-creators-track" id="creators-track">
            ...
            @if($creators->count() > 0)
                ...
                ?>
                <a href="{{ url_for(['module' => 'actor', 'slug' => $creator->slug]) }}" class="heritage-creator-card">
    ...
    <section class="heritage-timeline">
        <div class="heritage-section-header">
            ...
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'timeline']) }}" class="heritage-view-all">
    ...
    <section class="heritage-recent">
        <div class="heritage-section-header">
            ...
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'search', 'sort' => 'recent']) }}" class="heritage-view-all">
                View All <i class="fas fa-arrow-right"></i>
            </a>
        </div>
        ...
        <div class="heritage-contribute-inner">
            ...
            <div class="heritage-cta-cards">
                <div class="heritage-cta-card">
                    ...
                    <a href="{{ url_for(['module' => 'heritage', 'action' => 'contributorLogin']) }}" class="heritage-cta-button">Start Transcribing</a>
                </div>
                ...
                <div class="heritage-cta-card">
                    ...
                    <a href="{{ url_for(['module' => 'heritage', 'action' => 'contributorLogin']) }}" class="heritage-cta-button">Help Identify</a>
                </div>
                ...
                <div class="heritage-cta-card">
                    ...
                    <a href="{{ url_for(['module' => 'heritage', 'action' => 'contributorLogin']) }}" class="heritage-cta-button">Share Stories</a>
                </div>
            </div>
    ...
    <footer class="heritage-footer">
        <div class="heritage-footer-inner">
            <div class="heritage-footer-links">
                <a href="{{ url_for(['module' => 'staticpage', 'slug' => 'about']) }}">About</a>
                <a href="{{ url_for(['module' => 'staticpage', 'slug' => 'contact']) }}">Contact</a>
                <a href="{{ url_for(['module' => 'staticpage', 'slug' => 'privacy']) }}">Privacy</a>
