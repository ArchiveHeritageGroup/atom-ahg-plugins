...
<?php slot('sidebar'); ?>
<?php include_partial('heritage/adminSidebar', ['active' => 'hero-slides']); ?>
<?php end_slot(); ?>
...
<div class="heritage-admin-hero-slides">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-header bg-transparent">
            <h2 class="h5 mb-0">
                <?php echo $editSlideData ? 'Edit Hero Slide' : 'Add New Hero Slide'; ?>
            </h2>
        </div>
        <div class="card-body">
            <form action="<?php echo url_for(['module' => 'heritage', 'action' => 'adminHeroSlides']); ?>"
                  method="post" enctype="multipart/form-data">
                <input type="hidden" name="slide_action" value="<?php echo $editSlideData ? 'update' : 'create'; ?>">
                <?php if ($editSlideData): ?>
                    <input type="hidden" name="slide_id" value="<?php echo $editSlideData['id']; ?>">
                <?php endif; ?>

                <div class="row">
                    <!-- Image Upload -->
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Hero Image <?php echo $editSlideData ? '(leave empty to keep current)' : '*'; ?></label>
                        ...
                        <div class="mt-2">
                            ...
                            <input type="url" class="form-control form-control-sm" name="image_url"
                                   ...
                                   value="<?php echo ($editSlideData && strpos($editSlideData['image_path'] ?? '', 'http') === 0) ? htmlspecialchars($editSlideData['image_path']) : ''; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="title" name="title"
                                   value="<?php echo htmlspecialchars($editSlideData['title'] ?? ''); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="subtitle" name="subtitle"
                                   value="<?php echo htmlspecialchars($editSlideData['subtitle'] ?? ''); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="image_alt" name="image_alt"
                                   value="<?php echo htmlspecialchars($editSlideData['image_alt'] ?? ''); ?>"
                ...
                <div class="row">
                    ...
                    <div class="col-12 mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="2"
                                  placeholder="Optional longer description"><?php echo htmlspecialchars($editSlideData['description'] ?? ''); ?></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select" id="overlay_type" name="overlay_type">
                            <option value="gradient" <?php echo ($editSlideData['overlay_type'] ?? 'gradient') === 'gradient' ? 'selected' : ''; ?>>Gradient</option>
                            <option value="solid" <?php echo ($editSlideData['overlay_type'] ?? '') === 'solid' ? 'selected' : ''; ?>>Solid Color</option>
                            <option value="none" <?php echo ($editSlideData['overlay_type'] ?? '') === 'none' ? 'selected' : ''; ?>>None</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="color" class="form-control form-control-color w-100" id="overlay_color" name="overlay_color"
                               value="<?php echo htmlspecialchars($editSlideData['overlay_color'] ?? '#000000'); ?>">
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="range" class="form-range" id="overlay_opacity" name="overlay_opacity"
                               ...
                               value="<?php echo $editSlideData['overlay_opacity'] ?? 0.5; ?>">
                        <small class="text-muted">Current: <span id="opacity_value"><?php echo ($editSlideData['overlay_opacity'] ?? 0.5) * 100; ?>%</span></small>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select" id="text_position" name="text_position">
                            <option value="left" <?php echo ($editSlideData['text_position'] ?? 'left') === 'left' ? 'selected' : ''; ?>>Left</option>
                            <option value="center" <?php echo ($editSlideData['text_position'] ?? '') === 'center' ? 'selected' : ''; ?>>Center</option>
                            <option value="right" <?php echo ($editSlideData['text_position'] ?? '') === 'right' ? 'selected' : ''; ?>>Right</option>
                            <option value="bottom-left" <?php echo ($editSlideData['text_position'] ?? '') === 'bottom-left' ? 'selected' : ''; ?>>Bottom Left</option>
                            <option value="bottom-right" <?php echo ($editSlideData['text_position'] ?? '') === 'bottom-right' ? 'selected' : ''; ?>>Bottom Right</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control" id="display_duration" name="display_duration"
                               value="<?php echo $editSlideData['display_duration'] ?? 8; ?>" min="3" max="30">
                    </div>

                    <div class="col-md-4 mb-3">
                        <label for="display_order" class="form-label">Display Order</label>
                        <input type="number" class="form-control" id="display_order" name="display_order"
                               value="<?php echo $editSlideData['display_order'] ?? 100; ?>">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="cta_text" name="cta_text"
                               value="<?php echo htmlspecialchars($editSlideData['cta_text'] ?? ''); ?>"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" id="cta_url" name="cta_url"
                               value="<?php echo htmlspecialchars($editSlideData['cta_url'] ?? ''); ?>"
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-select" id="cta_style" name="cta_style">
                            <option value="primary" <?php echo ($editSlideData['cta_style'] ?? 'primary') === 'primary' ? 'selected' : ''; ?>>Primary (Blue)</option>
                            <option value="secondary" <?php echo ($editSlideData['cta_style'] ?? '') === 'secondary' ? 'selected' : ''; ?>>Secondary (Gray)</option>
                            <option value="light" <?php echo ($editSlideData['cta_style'] ?? '') === 'light' ? 'selected' : ''; ?>>Light (White)</option>
                            <option value="outline" <?php echo ($editSlideData['cta_style'] ?? '') === 'outline' ? 'selected' : ''; ?>>Outline</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="source_collection" name="source_collection"
                               value="<?php echo htmlspecialchars($editSlideData['source_collection'] ?? ''); ?>"
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="photographer_credit" name="photographer_credit"
                               value="<?php echo htmlspecialchars($editSlideData['photographer_credit'] ?? ''); ?>"
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="ken_burns" name="ken_burns" value="1"
                                   <?php echo ($editSlideData['ken_burns'] ?? 1) ? 'checked' : ''; ?>>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_enabled" name="is_enabled" value="1"
                                   <?php echo ($editSlideData['is_enabled'] ?? 1) ? 'checked' : ''; ?>>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" id="start_date" name="start_date"
                               value="<?php echo $editSlideData['start_date'] ?? ''; ?>">
                    </div>

                    <div class="col-md-6 mb-3">
                        <label for="end_date" class="form-label">End Date (optional)</label>
                        <input type="date" class="form-control" id="end_date" name="end_date"
                               value="<?php echo $editSlideData['end_date'] ?? ''; ?>">
                    </div>
                </div>

                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-check me-1"></i><?php echo $editSlideData ? 'Update Slide' : 'Add Slide'; ?>
                    </button>
                    <?php if ($editSlideData): ?>
                        <a href="<?php echo url_for(['module' => 'heritage', 'action' => 'adminHeroSlides']); ?>" class="btn btn-outline-secondary">
                            Cancel
                        </a>
                    <?php endif; ?>
                </div>
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
            ...
            <span class="badge bg-secondary"><?php echo count($slidesArray); ?> slides</span>
        </div>
        <div class="card-body">
            <?php if (empty($slidesArray)): ?>
                        ...
                        <tbody>
                            <?php foreach ($slidesArray as $slide): ?>
                                ...
                                <tr>
                                    ...
                                    <td><small><?php echo htmlspecialchars($slide['text_position'] ?? 'left'); ?></small></td>
                                    <td><?php echo $slide['display_order']; ?></td>
                                    <td><?php echo $slide['display_duration']; ?>s</td>
                                    <td>
                                        <?php if ($slide['is_enabled']): ?>
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="<?php echo url_for(['module' => 'heritage', 'action' => 'adminHeroSlides', 'edit' => $slide['id']]); ?>"
                                            ...
                                            <form action="<?php echo url_for(['module' => 'heritage', 'action' => 'adminHeroSlides']); ?>"
                                                ...
                                                <button type="submit" class="btn btn-sm btn-outline-<?php echo $slide['is_enabled'] ? 'warning' : 'success'; ?>">
                                                    <i class="fas fa-<?php echo $slide['is_enabled'] ? 'eye-slash' : 'eye'; ?> me-1"></i><?php echo $slide['is_enabled'] ? 'Disable' : 'Enable'; ?>
                                                </button>
                                            </form>
                                            <form action="<?php echo url_for(['module' => 'heritage', 'action' => 'adminHeroSlides']); ?>"
                                                  method="post" class="d-inline"
