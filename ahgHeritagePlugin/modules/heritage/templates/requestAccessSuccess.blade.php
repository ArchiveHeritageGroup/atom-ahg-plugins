...
<div class="card border-0 shadow-sm mb-4">
    ...
    <div class="card-body">
        ...
        @if ($resource->slug)
        <a href="{{ url_for(['module' => 'informationobject', 'slug' => $resource->slug]) }}" target="_blank" class="btn btn-sm btn-outline-primary mt-2">
...
<div class="alert alert-warning">
    ...
    <a href="{{ url_for(['module' => 'user', 'action' => 'login']) }}" class="alert-link">Login here</a>
</div>
@else
...
<form method="post" action="">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="purpose_id" id="purpose_id" required>
                    ...
                    <option value="{{ $purpose->id }}">
                        {{ $purpose->name }}
                        @if ($purpose->requires_approval)(Requires Approval)@endif
                    </option>
                    @endforeach
                </select>
            </div>
    ...
    <div class="d-flex justify-content-between">
        <a href="{{ url_for(['module' => 'informationobject', 'slug' => $resource->slug]) }}" class="btn btn-outline-secondary">
