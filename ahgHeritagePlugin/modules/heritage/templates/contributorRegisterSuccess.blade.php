    ...
    <div class="col-md-6 col-lg-5">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                ...
                <form method="post" action="{{ url_for(['module' => 'heritage', 'action' => 'contributorRegister']) }}">
                    <div class="mb-3">
                ...
                <div class="text-center">
                    ...
                    <a href="{{ url_for(['module' => 'heritage', 'action' => 'contributorLogin']) }}" class="btn btn-outline-primary">
