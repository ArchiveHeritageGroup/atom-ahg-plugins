...
<div class="card border-0 shadow-sm heritage-contribute-card">
    ...
    <div class="card-body">
        ...
        <div class="d-grid gap-2">
            @if ($hasDigitalObject)
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'contribute', 'slug' => $slug, 'type' => 'transcription']) }}"
            ...
            @if ($isImage)
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'contribute', 'slug' => $slug, 'type' => 'identification']) }}"
            ...
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'contribute', 'slug' => $slug, 'type' => 'context']) }}"
            ...
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'contribute', 'slug' => $slug, 'type' => 'correction']) }}"
            ...
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'contribute', 'slug' => $slug, 'type' => 'tag']) }}"
        ...
        <div class="d-flex justify-content-between align-items-center">
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'leaderboard']) }}" class="small text-decoration-none">
                <i class="fas fa-trophy me-1"></i>View Leaderboard
            </a>
            <a href="{{ url_for(['module' => 'heritage', 'action' => 'contributorRegister']) }}" class="small text-decoration-none">
