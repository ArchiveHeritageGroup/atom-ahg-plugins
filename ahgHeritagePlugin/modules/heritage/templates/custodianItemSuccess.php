<?php
/**
 * Heritage Custodian Item Editor - Full ISAD(G) Metadata.
 */
...
<?php slot('sidebar'); ?>
<?php include_partial('heritage/adminSidebar', ['active' => 'item']); ?>
...
<div class="card border-0 shadow-sm mt-4">
    ...
    <div class="card-body">
        ...
        <p class="mb-3"><?php echo esc_specialchars($item->identifier ?? '-'); ?></p>

        <small class="text-muted d-block mb-2">Level</small>
        <p class="mb-3"><?php echo esc_specialchars($item->level_of_description ?? '-'); ?></p>

        <small class="text-muted d-block mb-2">Created</small>
        <p class="mb-0"><?php echo date('M d, Y', strtotime($item->created_at)); ?></p>
    </div>
</div>
...
<div class="card border-0 shadow-sm mt-4">
    ...
    <div class="card-body p-0">
        ...
        <div class="list-group list-group-flush">
            <?php foreach (array_slice($history, 0, 5) as $log): ?>
            <div class="list-group-item">
                ...
                <?php echo esc_specialchars($log->username ?? 'System'); ?>
            </div>
            <?php endforeach; ?>
        </div>
        <?php else: ?>
...
<form method="post" action="">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="identifier" name="identifier"
                           value="<?php echo esc_specialchars($item->identifier ?? ''); ?>">
                </div>
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="level_of_description" name="level_of_description">
                        ...
                        <?php $levels = ['Fonds', 'Sub-fonds', 'Collection', 'Series', 'Sub-series', 'File', 'Item']; ?>
                        <?php foreach ($levels as $level): ?>
                        <option value="<?php echo strtolower($level); ?>" <?php echo ($item->level_of_description ?? '') === strtolower($level) ? 'selected' : ''; ?>>
                            <?php echo $level; ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="date" name="date"
                           value="<?php echo esc_specialchars($item->date ?? ''); ?>"
                           placeholder="e.g., 1920-1945">
                </div>
                <div class="col-12">
                    <label for="title" class="form-label">Title <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="title" name="title" required
                           value="<?php echo esc_specialchars($item->title ?? ''); ?>">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="extent_and_medium" name="extent_and_medium"
                           value="<?php echo esc_specialchars($item->extent_and_medium ?? ''); ?>"
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="creator" name="creator"
                           value="<?php echo esc_specialchars($item->creator ?? ''); ?>">
                </div>
                <div class="col-12">
                    <label for="administrative_history" class="form-label">Administrative/Biographical History</label>
                    <textarea class="form-control" id="administrative_history" name="administrative_history" rows="4"><?php echo esc_specialchars($item->administrative_history ?? ''); ?></textarea>
                </div>
                <div class="col-12">
                    <label for="archival_history" class="form-label">Archival History</label>
                    <textarea class="form-control" id="archival_history" name="archival_history" rows="3"><?php echo esc_specialchars($item->archival_history ?? ''); ?></textarea>
                </div>
                <div class="col-12">
                    <label for="immediate_source" class="form-label">Immediate Source of Acquisition</label>
                    <textarea class="form-control" id="immediate_source" name="immediate_source" rows="2"><?php echo esc_specialchars($item->immediate_source ?? ''); ?></textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="scope_and_content" name="scope_and_content" rows="5"><?php echo esc_specialchars($item->scope_and_content ?? ''); ?></textarea>
                </div>
                <div class="col-12">
                    <label for="appraisal" class="form-label">Appraisal, Destruction and Scheduling</label>
                    <textarea class="form-control" id="appraisal" name="appraisal" rows="3"><?php echo esc_specialchars($item->appraisal ?? ''); ?></textarea>
                </div>
                <div class="col-12">
                    <label for="accruals" class="form-label">Accruals</label>
                    <textarea class="form-control" id="accruals" name="accruals" rows="2"><?php echo esc_specialchars($item->accruals ?? ''); ?></textarea>
                </div>
                <div class="col-12">
                    <label for="arrangement" class="form-label">System of Arrangement</label>
                    <textarea class="form-control" id="arrangement" name="arrangement" rows="3"><?php echo esc_specialchars($item->arrangement ?? ''); ?></textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="access_conditions" name="access_conditions" rows="3"><?php echo esc_specialchars($item->access_conditions ?? ''); ?></textarea>
                </div>
                <div class="col-12">
                    <label for="reproduction_conditions" class="form-label">Conditions Governing Reproduction</label>
                    <textarea class="form-control" id="reproduction_conditions" name="reproduction_conditions" rows="3"><?php echo esc_specialchars($item->reproduction_conditions ?? ''); ?></textarea>
                </div>
                <div class="col-md-6">
                    <label for="language" class="form-label">Language/Script of Material</label>
                    <input type="text" class="form-control" id="language" name="language"
                           value="<?php echo esc_specialchars($item->language ?? ''); ?>">
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="physical_characteristics" name="physical_characteristics"
                           value="<?php echo esc_specialchars($item->physical_characteristics ?? ''); ?>">
                </div>
                <div class="col-12">
                    <label for="finding_aids" class="form-label">Finding Aids</label>
                    <textarea class="form-control" id="finding_aids" name="finding_aids" rows="2"><?php echo esc_specialchars($item->finding_aids ?? ''); ?></textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="location_of_originals" name="location_of_originals" rows="2"><?php echo esc_specialchars($item->location_of_originals ?? ''); ?></textarea>
                </div>
                <div class="col-12">
                    <label for="location_of_copies" class="form-label">Existence and Location of Copies</label>
                    <textarea class="form-control" id="location_of_copies" name="location_of_copies" rows="2"><?php echo esc_specialchars($item->location_of_copies ?? ''); ?></textarea>
                </div>
                <div class="col-12">
                    <label for="related_materials" class="form-label">Related Units of Description</label>
                    <textarea class="form-control" id="related_materials" name="related_materials" rows="2"><?php echo esc_specialchars($item->related_materials ?? ''); ?></textarea>
                </div>
                <div class="col-12">
                    <label for="publication_note" class="form-label">Publication Note</label>
                    <textarea class="form-control" id="publication_note" name="publication_note" rows="2"><?php echo esc_specialchars($item->publication_note ?? ''); ?></textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="general_note" name="general_note" rows="4"><?php echo esc_specialchars($item->general_note ?? ''); ?></textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <textarea class="form-control" id="archivist_note" name="archivist_note" rows="3"><?php echo esc_specialchars($item->archivist_note ?? ''); ?></textarea>
                </div>
                <div class="col-md-6">
                    <label for="rules_or_conventions" class="form-label">Rules or Conventions</label>
                    <textarea class="form-control" id="rules_or_conventions" name="rules_or_conventions" rows="3"><?php echo esc_specialchars($item->rules_or_conventions ?? ''); ?></textarea>
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="date_of_description" name="date_of_description"
                           value="<?php echo esc_specialchars($item->date_of_description ?? ''); ?>">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between">
        <a href="<?php echo url_for(['module' => 'heritage', 'action' => 'custodianDashboard']); ?>" class="btn btn-outline-secondary">
