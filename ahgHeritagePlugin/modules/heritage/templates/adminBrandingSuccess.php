<?php
/**
 * Heritage Admin Branding Configuration.
 */
...
<?php slot('sidebar'); ?>
<?php include_partial('heritage/adminSidebar', ['active' => 'branding']); ?>
<?php end_slot(); ?>

<form action="<?php echo url_for(['module' => 'heritage', 'action' => 'adminBranding']); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="logo_path" name="logo_path"
                           value="<?php echo esc_specialchars($branding['logo_path'] ?? ''); ?>"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="favicon_path" name="favicon_path"
                           value="<?php echo esc_specialchars($branding['favicon_path'] ?? ''); ?>"
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="banner_text" name="banner_text"
                       value="<?php echo esc_specialchars($branding['banner_text'] ?? ''); ?>"
                       placeholder="Optional announcement banner">
            </div>
            <div class="mb-3">
                <label for="footer_text" class="form-label">Footer Text</label>
                <textarea class="form-control" id="footer_text" name="footer_text" rows="2"><?php echo esc_specialchars($branding['footer_text'] ?? ''); ?></textarea>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" class="form-control" id="social_twitter" name="social_twitter"
                           value="<?php echo esc_specialchars($socialLinks['twitter'] ?? ''); ?>">
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" class="form-control" id="social_instagram" name="social_instagram"
                           value="<?php echo esc_specialchars($socialLinks['instagram'] ?? ''); ?>">
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="url" class="form-control" id="social_linkedin" name="social_linkedin"
                           value="<?php echo esc_specialchars($socialLinks['linkedin'] ?? ''); ?>">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="mb-3">
                <textarea class="form-control font-monospace" id="custom_css" name="custom_css" rows="6"
                          placeholder="/* Add custom CSS styles here */"><?php echo esc_specialchars($branding['custom_css'] ?? ''); ?></textarea>
    ...
    <div class="d-flex justify-content-end gap-2">
        <a href="<?php echo url_for(['module' => 'heritage', 'action' => 'adminDashboard']); ?>" class="btn btn-outline-secondary">Cancel</a>
