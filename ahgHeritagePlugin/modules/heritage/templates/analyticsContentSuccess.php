...
<?php slot('sidebar'); ?>
<?php include_partial('heritage/adminSidebar', ['active' => 'content-analytics']); ?>
<?php end_slot(); ?>
...
<div class="row g-4 mb-4">
    <div class="col-md-3">
        <div class="card border-0 shadow-sm text-center">
            <div class="card-body">
                <h3 class="mb-0"><?php echo number_format($summary['total_items'] ?? 0); ?></h3>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm text-center">
            <div class="card-body">
                <h3 class="mb-0"><?php echo number_format($summary['total_views'] ?? 0); ?></h3>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm text-center">
            <div class="card-body">
                <h3 class="mb-0"><?php echo number_format($summary['total_downloads'] ?? 0); ?></h3>
    ...
    <div class="col-md-3">
        <div class="card border-0 shadow-sm text-center">
            <div class="card-body">
                <h3 class="mb-0 text-success"><?php echo $summary['avg_ctr'] ?? 0; ?>%</h3>
            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php foreach (array_slice($topContent, 0, 10) as $item): ?>
                            <tr>
                                <td>
                                    <a href="<?php echo url_for(['module' => 'informationobject', 'slug' => $item->slug]); ?>">
                                        <?php echo esc_specialchars(mb_strimwidth($item->title ?? $item->slug, 0, 35, '...')); ?>
                                    </a>
                                </td>
                                <td class="text-center"><?php echo number_format($item->view_count); ?></td>
                                <td class="text-center"><?php echo number_format($item->download_count ?? 0); ?></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            <?php foreach (array_slice($lowPerforming, 0, 10) as $item): ?>
                            <tr>
                                <td>
                                    <a href="<?php echo url_for(['module' => 'informationobject', 'slug' => $item->slug]); ?>">
                                        <?php echo esc_specialchars(mb_strimwidth($item->title ?? $item->slug, 0, 30, '...')); ?>
                                    </a>
                                </td>
                                <td class="text-center"><?php echo number_format($item->view_count); ?></td>
                                <td>
                                    <span class="badge bg-warning"><?php echo esc_specialchars($item->issue ?? 'Low visibility'); ?></span>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
        ...
        <span class="badge bg-warning"><?php echo count($qualityIssues); ?> items</span>
    </div>
    <div class="card-body p-0">
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a href="<?php echo url_for(['module' => 'informationobject', 'slug' => $issue->slug]); ?>">
                                <?php echo esc_specialchars(mb_strimwidth($issue->title ?? $issue->slug, 0, 40, '...')); ?>
                            </a>
                        </td>
                        <td>
                            <?php
                        ...
                        <td>
                            <small class="text-muted"><?php echo esc_specialchars($issue->details ?? '-'); ?></small>
                        </td>
                        <td>
                            <a href="<?php echo url_for(['module' => 'heritage', 'action' => 'custodianItem', 'slug' => $issue->slug]); ?>"
...
new Chart(document.getElementById('repoChart'), {
    type: 'doughnut',
    data: {
        labels: <?php echo json_encode(array_keys($repoData)); ?>,
        datasets: [{
            data: <?php echo json_encode(array_values($repoData)); ?>,
