...
class repositoryBrowseActions extends sfActions
{
    ...
    public function executeBrowse(sfWebRequest $request)
    {
        ...
        // Create service
        $service = new \AhgRepositoryBrowse\Services\RepositoryBrowseService($culture);
        ...
        // Build pager
        $this->pager = new \AhgRepositoryBrowse\SimplePager(
            $browseResult['hits'],
            $browseResult['total'],
            $browseResult['page'],
            $browseResult['limit']
