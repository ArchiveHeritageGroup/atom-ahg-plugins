...
/**
 * FusekiPlaceAdapter - service for AtoM Heratio (STUB)
 *
 * Future home of the SPARQL query against the AHG Fuseki dataset for
 * rico:Place nodes (skos:prefLabel / rico:hasOrHadName match).
 *
 ...
 *   - SELECT ?place ?label WHERE { ?place a rico:Place ; skos:prefLabel ?label . FILTER CONTAINS(...) }
 *   - emit rows with source='fuseki_place', authority_id=null,
