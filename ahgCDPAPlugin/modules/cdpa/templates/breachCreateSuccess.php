...
<div class="container-fluid">
    ...
    <div class="alert alert-danger mb-4">
        ...
        <p class="mb-0">Under CDPA, data breaches must be reported to POTRAZ within 72 hours of discovery.</p>
    </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="datetime-local" name="discovery_date" class="form-control" required value="<?php echo date('Y-m-d\TH:i'); ?>">
                        </div>
                        <div class="col-md-6">
