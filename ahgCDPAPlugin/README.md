# Zimbabwe CDPA Compliance

Zimbabwe Cyber and Data Protection Act [Chapter 12:07] compliance — DPO registration, breach management, DPIA, consent tracking, data subject requests, and POTRAZ reporting
...
cd tmp-fetch && git sparse-checkout set ahgCDPAPlugin && cd ..
mv tmp-fetch/ahgCDPAPlugin ./ahgCDPAPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgCDPAPlugin/database/install.sql
