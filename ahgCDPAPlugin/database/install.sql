...
CREATE TABLE IF NOT EXISTS cdpa_controller_license (
    ...
    tier ENUM('tier1', 'tier2', 'tier3', 'tier4') NOT NULL COMMENT 'Tier 1: 50-1000, Tier 2: 1001-10000, Tier 3: 10001-500000, Tier 4: 500000+',
...
CREATE TABLE IF NOT EXISTS cdpa_data_subject_request (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    request_type ENUM('access', 'rectification', 'erasure', 'object', 'portability', 'restriction') NOT NULL,
...
CREATE TABLE IF NOT EXISTS cdpa_processing_activity (
    ...
    legal_basis ENUM('consent', 'contract', 'legal_obligation', 'vital_interest', 'public_interest', 'legitimate_interest') NOT NULL,
    storage_location ENUM('zimbabwe', 'international', 'both') DEFAULT 'zimbabwe',
...
CREATE TABLE IF NOT EXISTS cdpa_consent (
    ...
    consent_method ENUM('written', 'electronic', 'verbal', 'opt_in') DEFAULT 'electronic',
...
CREATE TABLE IF NOT EXISTS cdpa_breach (
    ...
    breach_type ENUM('unauthorized_access', 'data_loss', 'data_theft', 'accidental_disclosure', 'system_breach', 'other') NOT NULL,
    ...
    status ENUM('investigating', 'contained', 'resolved', 'ongoing') DEFAULT 'investigating',
    reported_by INT,
...
INSERT INTO cdpa_config (setting_key, setting_value, setting_type, description) VALUES
