        ...
        <div class="card shadow-sm border-danger">
            ...
            <div class="card-footer bg-light">
                <div class="d-flex justify-content-between">
                    <a href="<?php echo url_for(['module' => 'ahgFeedback', 'action' => 'browse']) ?>" class="btn btn-outline-secondary">
                        <i class="fas fa-arrow-left me-1"></i> <?php echo __('Cancel') ?>
                    </a>
                    <a href="<?php echo url_for([$resource, 'module' => 'ahgFeedback', 'action' => 'delete', 'confirm' => 1]) ?>" class="btn btn-danger">
