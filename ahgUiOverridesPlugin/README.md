...
| | |
|---|---|
| Machine name | `ahgUiOverridesPlugin` |
| Version | 1.0.0 |
| Category | ahg |
...
cd tmp-fetch && git sparse-checkout set ahgUiOverridesPlugin && cd ..
mv tmp-fetch/ahgUiOverridesPlugin ./ahgUiOverridesPlugin && rm -rf tmp-fetch
