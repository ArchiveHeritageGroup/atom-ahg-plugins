    ...
    <div class="accordion mb-3">
      <div class="accordion-item">
        <h2 class="accordion-header" id="inheritance-heading">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#inheritance-collapse" aria-expanded="false" aria-controls="inheritance-collapse">
            <?php echo __('Inheritance options'); ?>
          </button>
        </h2>
        <div id="inheritance-collapse" class="accordion-collapse collapse" aria-labelledby="inheritance-heading">
