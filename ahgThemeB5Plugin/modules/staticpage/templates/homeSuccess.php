...
<?php slot('title'); ?>
  <h1><?php echo $resource->getTitle(['cultureFallback' => true]); ?></h1>
<?php end_slot(); ?>
    ...
    <section class="card mb-3">
      ...
      <div class="list-group list-group-flush">
        <?php foreach ($browseMenu->getChildren() as $item) { ?>
          <a class="list-group-item list-group-item-action" href="<?php echo url_for($item->getPath(['getUrl' => true, 'resolveAlias' => true])); ?>">
