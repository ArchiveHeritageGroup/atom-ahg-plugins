...
<form method="post" action="<?php echo url_for(['module' => 'ahgMediaSettings', 'action' => 'save']) ?>">
...
<div class="actions mb-4">
  ...
  <a href="<?php echo url_for(['module' => 'ahgMediaSettings', 'action' => 'queue']) ?>" class="btn btn-outline-secondary">
