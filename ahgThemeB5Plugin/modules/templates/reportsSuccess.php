    ...
    <div class="accordion mb-3">
      <div class="accordion-item">
        <h2 class="accordion-header" id="reports-heading">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#reports-collapse" aria-expanded="false" aria-controls="reports-collapse">
            <?php echo __('Reports'); ?>
          </button>
        </h2>
        <div id="reports-collapse" class="accordion-collapse collapse" aria-labelledby="reports-heading">
