...
<div class="d-flex flex-wrap gap-1 mb-3 align-items-center">
  ...
  <?php if (in_array('ahgFavoritesPlugin', sfProjectConfiguration::getActive()->getPlugins()) && $userId): ?>
    ...
    <?php else: ?>
      <a href="<?php echo url_for(['module' => 'favorites', 'action' => 'add', 'slug' => $resource->slug]); ?>" class="btn btn-xs btn-outline-danger ahg-favorite-btn" title="<?php echo __('Add to Favorites'); ?>" data-bs-toggle="tooltip"><i class="fas fa-heart"></i></a>
    <?php endif; ?>
  <?php endif; ?>
...
<?php if (function_exists('checkPluginEnabled') && checkPluginEnabled('ahgMuseumPlugin')): ?>
