              ...
              <div class="col-12">
                ...
                <?php if (!empty($donor)): ?>
                  ...
                  <div class="form-control bg-light">
                    <i class="fas fa-user me-2"></i><?php echo esc_entities($donor->authorizedFormOfName ?? $donor->name ?? '') ?>
                ...
                <?php else: ?>
                  <div class="position-relative">
                    <div class="input-group">
                      ...
                      <input type="text" id="donor-search" class="form-control" placeholder="<?php echo __('Search donors...') ?>" autocomplete="off">
                      <input type="hidden" name="agreement[donor_id]" id="donor-id" value="<?php echo $agreement->donor_id ?? '' ?>">
                    </div>
                    <div id="donor-results" class="list-group position-absolute w-100 shadow" style="z-index:1000; display:none; max-height:200px; overflow-y:auto;"></div>
                  </div>
                <?php endif ?>
              </div>
              <div class="col-md-6">
