...
<div class="container py-4" style="max-width: 600px;">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <form method="post" action="<?php echo url_for(['module' => 'landingPageBuilder', 'action' => 'create']) ?>">
        <div class="mb-3">
          <label class="form-label" for="name">Page Name <span class="text-danger">*</span></label>
          <input type="text" name="name" id="name" class="form-control" required
                 value="<?php echo esc_entities($sf_request->getParameter('name', '')) ?>"
        ...
        <div class="mb-3">
          ...
          <div class="input-group">
            ...
            <input type="text" name="slug" id="slug" class="form-control" required
                   value="<?php echo esc_entities($sf_request->getParameter('slug', '')) ?>"
        ...
        <div class="mb-3">
          ...
          <textarea name="description" id="description" class="form-control" rows="3"
                    placeholder="Brief description of this page's purpose"><?php echo esc_entities($sf_request->getParameter('description', '')) ?></textarea>
        </div>
        ...
        <div class="mb-4">
          <div class="form-check">
            <input type="checkbox" name="is_active" id="is_active" class="form-check-input" value="1" checked
                   <?php echo $sf_request->getParameter('is_active', '1') ? 'checked' : '' ?>>
