...
<?php
    ...
    $headingsCondition = \AtomExtensions\Services\AclService::check($resource, 'update');
...
<?php slot('after-content'); ?>
  <?php if (\AtomExtensions\Services\AclService::check($resource, 'update') || \AtomExtensions\Services\AclService::check($resource, 'delete') || \AtomExtensions\Services\AclService::check($resource, 'create')) { ?>
