<?php if (\AtomExtensions\Services\AclService::check($resource, ['create', 'update', 'delete', 'list'])) { ?>
  <ul class="actions mb-3 nav gap-2">
    ...
    <?php if ($sf_user->user != $resource && 0 == count($resource->notes) && \AtomExtensions\Services\AclService::check($resource, 'delete')) { ?>
    ...
    <?php if (\AtomExtensions\Services\AclService::check($resource, 'list')) { ?>
