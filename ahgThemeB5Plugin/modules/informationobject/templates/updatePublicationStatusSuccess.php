    ...
    <div class="accordion mb-3">
      <div class="accordion-item">
        <h2 class="accordion-header" id="pub-status-heading">
          <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#pub-status-collapse" aria-expanded="false" aria-controls="pub-status-collapse">
            <?php echo __('Update publication status'); ?>
          </button>
        </h2>
        <div id="pub-status-collapse" class="accordion-collapse collapse" aria-labelledby="pub-status-heading">
