 ...
 *
 * Usage: <?php include_partial('informationobject/isbnLookup', ['resource' => $resource]) ?>
 */
...
<div class="card mb-3 isbn-lookup-card">
    <div class="card-header bg-light">
        <h5 class="card-title mb-0">
            <i class="fas fa-barcode me-2"></i><?php echo __('ISBN Lookup'); ?>
        </h5>
    </div>
    <div class="card-body">
        <p class="text-muted small mb-3">
            <?php echo __('Enter an ISBN to automatically populate metadata from WorldCat, Open Library, or Google Books.'); ?>
        </p>
        
        <div class="row g-3 align-items-end">
            <div class="col-md-8">
                <label for="isbnLookupInput" class="form-label">
                    <?php echo __('ISBN-10 or ISBN-13'); ?>
                </label>
                <input type="text" 
                       id="isbnLookupInput" 
                       class="form-control" 
                       placeholder="<?php echo __('e.g., 978-0-13-468599-1'); ?>"
                       data-isbn-lookup
                       autocomplete="off">
                <div class="form-text">
                    <?php echo __('Hyphens and spaces are optional'); ?>
                </div>
            </div>
            <div class="col-md-4">
                <button type="button" 
