      ...
      <?php if (count($events)) { ?>
        <div class="accordion-item">
          <h2 class="accordion-header" id="existing-heading">
            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#existing-collapse" aria-expanded="false" aria-controls="existing-collapse">
              <?php echo __('Update an existing date range'); ?>
            </button>
          </h2>
          <div id="existing-collapse" class="accordion-collapse collapse" aria-labelledby="existing-heading">
