        ...
        <div class="accordion mb-3">
          <div class="accordion-item">
            <h2 class="accordion-header" id="upload-heading">
              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#upload-collapse" aria-expanded="false" aria-controls="upload-collapse">
                <?php echo __('Import multiple digital objects'); ?>
              </button>
            </h2>
            <div id="upload-collapse" class="accordion-collapse collapse" aria-labelledby="upload-heading">
