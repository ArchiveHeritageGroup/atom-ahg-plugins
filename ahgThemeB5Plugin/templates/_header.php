...
<?php if ($sf_user->isAdministrator() && '' === (\AtomExtensions\Services\SettingService::getValue('siteBaseUrl') ?? '')) { ?>
...
<header id="top-bar" class="navbar navbar-expand-lg navbar-dark bg-dark" role="navigation" aria-label="<?php echo __('Main navigation'); ?>">
  <div class="container-fluid">
    ...
    <button class="navbar-toggler atom-btn-secondary my-2 me-1 px-1" type="button" data-bs-toggle="collapse" data-bs-target="#navbar-content" aria-controls="navbar-content" aria-expanded="false">
      <i class="fas fa-2x fa-fw fa-bars" data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo __('Toggle navigation'); ?>" aria-hidden="true"></i>
	  ...
	  <?php if (in_array('ahgRicExplorerPlugin', sfProjectConfiguration::getActive()->getPlugins())): ?>
          ...
          <li class="nav-item dropdown d-flex flex-column">
            <a
              ...
              aria-expanded="false">
              <i
                class="fas fa-2x fa-fw fa-sitemap px-0 px-lg-2 py-2"
                data-bs-toggle="tooltip"
                data-bs-placement="bottom"
                data-bs-custom-class="d-none d-lg-block"
                title="<?php echo __('RiC Tools'); ?>"
                aria-hidden="true">
              </i>
              <span class="d-lg-none mx-1" aria-hidden="true">
                <?php echo __('RiC Tools'); ?>
              </span>
