...
<html lang="<?php echo $sf_user->getCulture(); ?>" dir="<?php echo sfCultureInfo::getInstance($sf_user->getCulture())->direction; ?>">
  <head>
    ...
    <script defer src="/plugins/ahgThemeB5Plugin/web/dist/js/vendor.bundle.7fd4785c4754082db86b.js"></script><script defer src="/plugins/ahgThemeB5Plugin/web/dist/js/ahgThemeB5Plugin.bundle.5143f3ea019729b8aaa0.js"></script><link href="/plugins/ahgThemeB5Plugin/web/dist/css/ahgThemeB5Plugin.bundle.7e0f865c257625fdb5ba.css" rel="stylesheet">
