<?php
// THIS IS THE SOURCE. Do not edit templates/_layout_start.php - it is generated.
//
// AtoM's webpack.config.js creates an HtmlWebpackPlugin for every plugin that has
// webpack.entry.js and templates/_layout_start_webpack.php, writing the result to
// templates/_layout_start.php. So _layout_start.php is a build artefact, and any
// edit to it is erased by the next `npm run build`.
//
// Everything below - the CSRF meta tag and auto-attach script, the bundle discovery
// and the Bootstrap Icons stylesheet - was previously written into the generated file
// and therefore vanished on any fresh install that ran the build. On 2026-08-18 a
// clean install lost all three silently, including CSRF protection, with nothing in
// any log to say so.
//
// Bundles are found by glob rather than by webpack's injected tags on purpose: the
// filenames carry content hashes, and globbing keeps this template correct without
// re-generating it every time a hash changes.
?>
<!DOCTYPE html>
