<?php
/**
 * PSIS / AtoM-AHG - the central signed C2PA claim structure.
 *
 * Symfony 1.4 / PHP 8.3 port of Heratio's AhgC2pa\Manifest\Claim. Byte-identical
 * serialisation so claims signed on PSIS and Heratio cross-verify.
 *
...
final class Claim
{
     ...
     * @param array<string,mixed> $extra extra top-level claim fields (e.g. instanceID)
     */
    ...
    /**
     * The claim as it will be serialised for signing.
     *
    ...
    /**
     * SHA-256 hex of the canonical claim bytes.
     */
