<?php
/**
 * PSIS / AtoM-AHG - minimal deterministic CBOR encoder for C2PA manifests.
 *
 * Verbatim port of Heratio's AhgC2pa\Manifest\CborEncoder. Pure PHP, no ext,
 * no third-party dep. Used to produce the binary (JUMBF) form of a manifest.
 *
...
/**
 * Tiny deterministic CBOR encoder (CTAP2 canonical profile).
 *
 * Supports the subset of CBOR that C2PA manifests actually use:
