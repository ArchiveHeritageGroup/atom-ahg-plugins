...
<?php slot('content'); ?>
  ...
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <span class="badge bg-secondary"><?php echo count($attachArr); ?> <?php echo __('file(s)'); ?></span>
    </div>
                ...
                <tr id="attachment-row-<?php echo htmlspecialchars($att->id); ?>">
                  <td>
                    <?php if (!empty($att->file_path)): ?>
                      <a href="<?php echo htmlspecialchars($att->file_path); ?>" target="_blank" title="<?php echo __('Download'); ?>">
