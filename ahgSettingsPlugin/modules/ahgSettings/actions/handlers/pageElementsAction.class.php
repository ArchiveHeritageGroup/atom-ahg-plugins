...
class SettingsPageElementsAction extends AhgController
{
    ...
    public function execute($request)
    {
        ...
        $googleMapsApiKeySetting = SettingService::getByName('google_maps_api_key');
        ...
        $toggleDigitalObjectMapSetting = SettingService::getByName('toggleDigitalObjectMap');
        ...
        foreach ($this::$NAMES as $name) {
            ...
            if (null !== $settings[$name] = SettingService::getByName($name)) {
        ...
        if ($request->isMethod('post')) {
            ...
            $this->redirect(['module' => 'ahgSettings', 'action' => 'pageElements']);
        }
    }
}
