...
class SettingsOaiAction extends sfAction
{
    ...
    protected function populateOaiRepositoryForm()
    {
        ...
        $oaiAuthenticationEnabled = SettingService::getByName('oai_authentication_enabled');
        $oaiRepositoryCode = SettingService::getByName('oai_repository_code');
        $oaiAdminEmails = SettingService::getByName('oai_admin_emails');
        $oaiRepositoryIdentifier = QubitOai::getRepositoryIdentifier();
        $sampleOaiIdentifier = QubitOai::getOaiSampleIdentifier();
        $resumptionTokenLimit = SettingService::getByName('resumption_token_limit');
        $oaiAdditionalSetsEnabled = SettingService::getByName('oai_additional_sets_enabled');
