    ...
    protected function getAllCronJobs(): array
    {
        return [
            ...
            [
                ...
                'description' => 'Builds the heritage knowledge graph from contributor data, heritage sites, and related records. Used by the heritage discovery platform for contextual browsing.',
                'options' => [
                    '--full' => 'Full rebuild (vs incremental)',
                ],
                'schedule' => 'Weekly or after heritage data changes',
                'example' => '0 3 * * 0 cd {root} && php symfony heritage:build-graph >> /var/log/atom/heritage-graph.log 2>&1',
                'duration' => 'Medium to Long',
                'category' => 'ahg',
            ],
            [
