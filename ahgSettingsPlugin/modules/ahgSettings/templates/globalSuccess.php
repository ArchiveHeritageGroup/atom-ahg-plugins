...
<?php slot("content"); ?>
  ...
  <?php echo $globalForm->renderFormTag(
      url_for(["module" => "ahgSettings", "action" => "global"])
  ); ?>
    ...
    <div class="accordion mb-3">
        ...
        <div id="search-collapse" class="accordion-collapse collapse" aria-labelledby="search-heading">
          <div class="accordion-body">
            ...
            <?php echo render_field(
                $globalForm->default_archival_description_browse_view
            ); ?>

            <?php echo render_field(
                $globalForm->default_repository_browse_view
            ); ?>
      ...
      <div class="accordion-item">
        ...
        <div id="multirepo-collapse" class="accordion-collapse collapse" aria-labelledby="multirepo-heading">
          <div class="accordion-body">
            ...
            <?php echo render_field(
                $globalForm->enable_institutional_scoping
            ); ?>
          </div>
        </div>
      </div>
      <div class="accordion-item">
        ...
        <div id="permalinks-collapse" class="accordion-collapse collapse" aria-labelledby="permalinks-heading">
          <div class="accordion-body">
            <?php echo render_field(
                $globalForm->slug_basis_informationobject
            ); ?>
      ...
      <div class="accordion-item">
        ...
        <div id="system-collapse" class="accordion-collapse collapse" aria-labelledby="system-heading">
          <div class="accordion-body">
            ...
            <?php echo render_field(
                $globalForm->generate_reports_as_pub_user
            ); ?>
    ...
    <section class="actions mb-3">
      <input class="btn atom-btn-outline-success" type="submit" value="<?php echo __(
          "Save"
      ); ?>">
    </section>
