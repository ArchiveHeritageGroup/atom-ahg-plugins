    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-sm table-hover align-middle">
                ...
                <tbody>
                    @foreach ($metadataSources as $sourceKey => $sourceInfo)
                    <tr>
                        <td>
                            <i class="{{ $sourceInfo['icon'] }} me-2 text-muted"></i>
                            {{ $sourceInfo['label'] }}
                        </td>
                        <td>
                            <select class="form-select form-select-sm field-mapping"
                                    name="settings[meta_mapping_{{ $sourceKey }}_isad]"
                                    data-source="{{ $sourceKey }}" data-standard="isad">
                                @foreach ($isadFields as $value => $label)
                                <option value="{{ $value }}"
                                    {{ ($fieldMappings[$sourceKey]['isad'] ?? '') === $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <td>
                            <select class="form-select form-select-sm field-mapping"
                                    name="settings[meta_mapping_{{ $sourceKey }}_spectrum]"
                                    data-source="{{ $sourceKey }}" data-standard="spectrum">
                                @foreach ($spectrumFields as $value => $label)
                                <option value="{{ $value }}"
                                    {{ ($fieldMappings[$sourceKey]['spectrum'] ?? '') === $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <td>
                            <select class="form-select form-select-sm field-mapping"
                                    name="settings[meta_mapping_{{ $sourceKey }}_dam]"
                                    data-source="{{ $sourceKey }}" data-standard="dam">
                                @foreach ($damFields as $value => $label)
                                <option value="{{ $value }}"
                                    {{ ($fieldMappings[$sourceKey]['dam'] ?? '') === $value ? 'selected' : '' }}>
                                    {{ $label }}
                                </option>
                                @endforeach
                            </select>
        ...
        <input type="hidden" name="settings[meta_field_mappings]" id="meta_field_mappings"
               value="{{ htmlspecialchars(json_encode($fieldMappings)) }}">
    </div>
</div>
            ...
            <div class="col-md-6">
                <div class="form-check mb-2">
                    <input type="checkbox" class="form-check-input" id="meta_extract_gps"
                           ...
                           {{ ($settings['meta_extract_gps'] ?? 'true') === 'true' ? 'checked' : '' }}>
                ...
                <div class="form-check mb-2">
                    <input type="checkbox" class="form-check-input" id="meta_extract_technical"
                           ...
                           {{ ($settings['meta_extract_technical'] ?? 'true') === 'true' ? 'checked' : '' }}>
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="meta_extract_xmp"
                           ...
                           {{ ($settings['meta_extract_xmp'] ?? 'true') === 'true' ? 'checked' : '' }}>
            ...
            <div class="col-md-6">
                <div class="form-check mb-2">
                    <input type="checkbox" class="form-check-input" id="meta_extract_iptc"
                           ...
                           {{ ($settings['meta_extract_iptc'] ?? 'true') === 'true' ? 'checked' : '' }}>
                ...
                <div class="form-check mb-2">
                    <input type="checkbox" class="form-check-input" id="meta_overwrite_existing"
                           ...
                           {{ ($settings['meta_overwrite_existing'] ?? 'false') === 'true' ? 'checked' : '' }}>
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="meta_create_access_points"
                           ...
                           {{ ($settings['meta_create_access_points'] ?? 'true') === 'true' ? 'checked' : '' }}>
            ...
            <div class="col-md-6">
                <div class="form-check mb-2">
                    <input type="checkbox" class="form-check-input" id="meta_dam_batch_mode"
                           ...
                           {{ ($settings['meta_dam_batch_mode'] ?? 'true') === 'true' ? 'checked' : '' }}>
                ...
                <div class="form-check mb-2">
                    <input type="checkbox" class="form-check-input" id="meta_dam_preserve_filename"
                           ...
                           {{ ($settings['meta_dam_preserve_filename'] ?? 'true') === 'true' ? 'checked' : '' }}>
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="meta_dam_extract_color"
                           ...
                           {{ ($settings['meta_dam_extract_color'] ?? 'false') === 'true' ? 'checked' : '' }}>
            ...
            <div class="col-md-6">
                <div class="form-check mb-2">
                    <input type="checkbox" class="form-check-input" id="meta_dam_extract_faces"
                           ...
                           {{ ($settings['meta_dam_extract_faces'] ?? 'false') === 'true' ? 'checked' : '' }}>
                ...
                <div class="form-check mb-2">
                    <input type="checkbox" class="form-check-input" id="meta_dam_auto_tag"
                           ...
                           {{ ($settings['meta_dam_auto_tag'] ?? 'false') === 'true' ? 'checked' : '' }}>
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="meta_dam_generate_thumbnail"
                           ...
                           {{ ($settings['meta_dam_generate_thumbnail'] ?? 'true') === 'true' ? 'checked' : '' }}>
                ...
                <div class="col-md-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="number" class="form-control" name="settings[meta_dam_thumb_small]"
                               value="{{ $settings['meta_dam_thumb_small'] ?? '150' }}" placeholder="150">
                ...
                <div class="col-md-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="number" class="form-control" name="settings[meta_dam_thumb_medium]"
                               value="{{ $settings['meta_dam_thumb_medium'] ?? '300' }}" placeholder="300">
                        <span class="input-group-text">px</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="number" class="form-control" name="settings[meta_dam_thumb_large]"
                               value="{{ $settings['meta_dam_thumb_large'] ?? '600' }}" placeholder="600">
                        <span class="input-group-text">px</span>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="input-group input-group-sm">
                        ...
                        <input type="number" class="form-control" name="settings[meta_dam_thumb_preview]"
                               value="{{ $settings['meta_dam_thumb_preview'] ?? '1200' }}" placeholder="1200">
                        <span class="input-group-text">px</span>
                    </div>
                </div>
            </div>
