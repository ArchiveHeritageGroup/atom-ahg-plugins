        ...
        <div class="col-md-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ url_for(['module' => 'digitalobject', 'action' => 'browse']) }}" class="btn btn-outline-success">
        ...
        <div class="col-md-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <a href="{{ url_for(['module' => 'threeDReports', 'action' => 'settings']) }}" class="btn btn-outline-warning">
