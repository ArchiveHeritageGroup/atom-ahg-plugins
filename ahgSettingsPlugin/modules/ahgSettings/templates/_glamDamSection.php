<?php
/**
 * GLAM/DAM Section for AHG Settings Dashboard
...
<div class="ahg-settings-section mb-5" id="glam-dam">
    ...
    <?php include_partial('ahgSettings/glamDamTiffPdfMerge'); ?>
        ...
        <div class="col-md-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo url_for(['module' => 'digitalobject', 'action' => 'browse']); ?>" class="btn btn-outline-success btn-sm">
        ...
        <div class="col-md-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo url_for(['module' => 'jobs', 'action' => 'browse']); ?>" class="btn btn-outline-info btn-sm">
        ...
        <div class="col-md-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <a href="<?php echo url_for(['module' => 'threeDReports', 'action' => 'index']); ?>" class="btn btn-outline-warning btn-sm">
