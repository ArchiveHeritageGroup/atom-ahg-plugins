      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="qdrant_url"
                   value="{{ $settings['qdrant_url'] ?? 'http://localhost:6333' }}">
            <div class="form-text">Qdrant REST endpoint</div>
          </div>
          <div class="col-md-6">
            <label class="form-label fw-bold">Collection Name</label>
            <input type="text" class="form-control" name="qdrant_collection"
                   value="{{ $settings['qdrant_collection'] ?? '' }}"
                   placeholder="Auto-detected from database name">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6">
            ...
            <input type="number" class="form-control" name="qdrant_min_score"
                   value="{{ $settings['qdrant_min_score'] ?? '0.25' }}"
        ...
        <div class="alert alert-light border mt-3">
          ...
          <a href="{{ url_for(['module' => 'ahgSettings', 'action' => 'cronJobs']) }}">Cron Jobs</a>
