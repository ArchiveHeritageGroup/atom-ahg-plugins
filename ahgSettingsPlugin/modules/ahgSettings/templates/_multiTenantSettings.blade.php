  ...
  <div class="card-body">
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="mb-3">
          <div class="form-check form-switch">
            <input type="checkbox" class="form-check-input" id="tenant_enabled" name="settings[tenant_enabled]" value="true" {{ ($settings['tenant_enabled'] ?? '') === 'true' ? 'checked' : '' }}>
      ...
      <div class="col-md-6">
        <div class="mb-3">
          <div class="form-check form-switch">
            <input type="checkbox" class="form-check-input" id="tenant_enforce_filter" name="settings[tenant_enforce_filter]" value="true" {{ ($settings['tenant_enforce_filter'] ?? '') === 'true' ? 'checked' : '' }}>
      ...
      <div class="col-md-6">
        <div class="mb-3">
          <div class="form-check form-switch">
            <input type="checkbox" class="form-check-input" id="tenant_show_switcher" name="settings[tenant_show_switcher]" value="true" {{ ($settings['tenant_show_switcher'] ?? 'true') === 'true' ? 'checked' : '' }}>
      ...
      <div class="col-md-6">
        <div class="mb-3">
          <div class="form-check form-switch">
            <input type="checkbox" class="form-check-input" id="tenant_allow_branding" name="settings[tenant_allow_branding]" value="true" {{ ($settings['tenant_allow_branding'] ?? 'true') === 'true' ? 'checked' : '' }}>
...
<div class="card mb-4">
  ...
  <div class="card-body">
    <a href="{{ url_for('tenant_admin') }}" class="btn btn-primary me-2">
