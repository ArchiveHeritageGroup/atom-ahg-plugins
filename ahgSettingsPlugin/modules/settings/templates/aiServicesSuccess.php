...
$rawSettings = $sf_data->getRaw('settings');

// Decode JSON arrays for checkboxes - use different variable names to avoid overriding controller arrays
...
<form method="post" action="<?php echo url_for(['module' => 'settings', 'action' => 'aiServices']) ?>">
            ...
            <div class="col-sm-9">
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="entity_PERSON" id="entity_person" value="1"
                        <?php echo in_array('PERSON', $selectedEntityTypes) ? 'checked' : '' ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="entity_ORG" id="entity_org" value="1"
                        <?php echo in_array('ORG', $selectedEntityTypes) ? 'checked' : '' ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="entity_GPE" id="entity_gpe" value="1"
                        <?php echo in_array('GPE', $selectedEntityTypes) ? 'checked' : '' ?>>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="entity_DATE" id="entity_date" value="1"
                        <?php echo in_array('DATE', $selectedEntityTypes) ? 'checked' : '' ?>>
            ...
            <div class="col-sm-9">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" name="spellcheck_field_<?php echo $field ?>"
                        ...
                        <?php echo in_array($field, $selectedSpellcheckFields) ? 'checked' : '' ?>>
            ...
            <div class="col-sm-3">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="translation_enabled" id="translation_enabled" value="1"
                        <?php echo ($settings['translation_enabled'] ?? '1') === '1' ? 'checked' : '' ?>>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" name="mt_endpoint"
                    value="<?php echo htmlspecialchars($settings['mt_endpoint'] ?? 'http://127.0.0.1:5100/translate') ?>">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <select class="form-select" name="translation_source_lang">
                    <?php foreach ($translationLanguages as $code => $langData): ?>
                    <option value="<?php echo $code ?>" <?php echo ($settings['translation_source_lang'] ?? 'en') === $code ? 'selected' : '' ?>>
            ...
            <div class="col-sm-4">
                <select class="form-select" name="translation_target_lang" id="translation_target_lang">
                    ...
                    <option value="<?php echo $code ?>" data-culture="<?php echo $langData['culture'] ?>"
                        <?php echo ($settings['translation_target_lang'] ?? 'af') === $code ? 'selected' : '' ?>>
                        <?php echo $langData['name'] ?> (<?php echo $langData['culture'] ?>)
                    </option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="col-sm-3">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="translation_save_culture" id="translation_save_culture" value="1"
                        <?php echo ($settings['translation_save_culture'] ?? '1') === '1' ? 'checked' : '' ?>>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-4">
                <select class="form-select" name="translation_sector" id="translation_sector" onchange="updateFieldsForSector()">
                    ...
                    <option value="library" <?php echo ($settings['translation_sector'] ?? 'archives') === 'library' ? 'selected' : '' ?>>
                    ...
                    <option value="dam" <?php echo ($settings['translation_sector'] ?? 'archives') === 'dam' ? 'selected' : '' ?>>
            ...
            <div class="col-sm-9">
                ...
                <div id="sector-fields-archives" class="sector-fields">
                    <table class="table table-sm table-hover">
                        ...
                        <tbody>
                            <?php foreach (['title' => 'Title', 'scope_and_content' => 'Scope and Content', 'archival_history' => 'Archival History', 'acquisition' => 'Source of Acquisition', 'arrangement' => 'Arrangement', 'access_conditions' => 'Access Conditions', 'reproduction_conditions' => 'Reproduction Conditions', 'finding_aids' => 'Finding Aids', 'related_units_of_description' => 'Related Units', 'appraisal' => 'Appraisal', 'accruals' => 'Accruals', 'physical_characteristics' => 'Physical Characteristics', 'location_of_originals' => 'Location of Originals', 'location_of_copies' => 'Location of Copies'] as $field => $label): ?>
                            <tr>
                                <td>
                                    <input class="form-check-input translate-field" type="checkbox" name="translate_field_<?php echo $field ?>" id="translate_<?php echo $field ?>" value="1"
                                        <?php echo in_array($field, $selectedTranslationFields) ? 'checked' : '' ?>>
                                </td>
                                <td><label class="form-check-label mb-0" for="translate_<?php echo $field ?>"><?php echo $label ?></label></td>
                                <td>
                                    <select class="form-select form-select-sm" name="translate_target_<?php echo $field ?>">
                                        <?php foreach ($targetFields as $targetField => $targetLabel): ?>
                                        <option value="<?php echo $targetField ?>" <?php echo ($fieldMappings[$field] ?? $field) === $targetField ? 'selected' : '' ?>>
                                            <?php echo $targetLabel ?>
                                        </option>
                                        <?php endforeach; ?>
                                    </select>
                                </td>
                ...
                <div id="sector-fields-library" class="sector-fields" style="display:none;">
                    <table class="table table-sm table-hover">
                        ...
                        <tbody>
                            <?php foreach (['title' => 'Title', 'alternate_title' => 'Alternate Title', 'edition' => 'Edition', 'extent_and_medium' => 'Extent and Medium', 'scope_and_content' => 'Abstract/Summary', 'access_conditions' => 'Access Conditions', 'reproduction_conditions' => 'Reproduction Conditions', 'physical_characteristics' => 'Physical Description', 'sources' => 'Sources'] as $field => $label): ?>
                            <tr>
                                <td><input class="form-check-input translate-field" type="checkbox" name="translate_field_<?php echo $field ?>" value="1"
                                    <?php echo in_array($field, $selectedTranslationFields) ? 'checked' : '' ?>></td>
                                <td><?php echo $label ?></td>
                                <td>
                                    <select class="form-select form-select-sm" name="translate_target_<?php echo $field ?>">
                                        <?php foreach ($targetFields as $targetField => $targetLabel): ?>
                                        <option value="<?php echo $targetField ?>" <?php echo ($fieldMappings[$field] ?? $field) === $targetField ? 'selected' : '' ?>><?php echo $targetLabel ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </td>
                            </tr>
                ...
                <div id="sector-fields-gallery" class="sector-fields" style="display:none;">
                    <table class="table table-sm table-hover">
                        ...
                        <tbody>
                            <?php foreach (['title' => 'Artwork Title', 'alternate_title' => 'Alternative Titles', 'scope_and_content' => 'Description/Statement', 'archival_history' => 'Provenance', 'acquisition' => 'Acquisition', 'physical_characteristics' => 'Medium and Dimensions', 'access_conditions' => 'Exhibition Conditions', 'reproduction_conditions' => 'Copyright/Reproduction', 'location_of_originals' => 'Current Location'] as $field => $label): ?>
                            <tr>
                                <td><input class="form-check-input translate-field" type="checkbox" name="translate_field_<?php echo $field ?>" value="1"
                                    <?php echo in_array($field, $selectedTranslationFields) ? 'checked' : '' ?>></td>
                                <td><?php echo $label ?></td>
                ...
                <div id="sector-fields-dam" class="sector-fields" style="display:none;">
                    <table class="table table-sm table-hover">
                        ...
                        <tbody>
                            <?php foreach (['title' => 'Asset Title', 'alternate_title' => 'Alt Text', 'scope_and_content' => 'Description', 'access_conditions' => 'Usage Rights', 'reproduction_conditions' => 'License Terms', 'sources' => 'Source/Credits', 'finding_aids' => 'Keywords/Tags'] as $field => $label): ?>
                            <tr>
                                <td><input class="form-check-input translate-field" type="checkbox" name="translate_field_<?php echo $field ?>" value="1"
                                    <?php echo in_array($field, $selectedTranslationFields) ? 'checked' : '' ?>></td>
                                <td><?php echo $label ?></td>
            ...
            <div class="col-sm-9">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="translation_mode" id="mode_review" value="review"
                        <?php echo ($settings['translation_mode'] ?? 'review') === 'review' ? 'checked' : '' ?>>
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="translation_mode" id="mode_auto" value="auto"
                        <?php echo ($settings['translation_mode'] ?? 'review') === 'auto' ? 'checked' : '' ?>>
            ...
            <div class="col-sm-3">
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" name="translation_overwrite" id="translation_overwrite" value="1"
                        <?php echo ($settings['translation_overwrite'] ?? '0') === '1' ? 'checked' : '' ?>>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-3">
                <input type="number" class="form-control" name="mt_timeout" min="10" max="120"
                    value="<?php echo htmlspecialchars($settings['mt_timeout'] ?? '30') ?>">
            </div>
        </div>
