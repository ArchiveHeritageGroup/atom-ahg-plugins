...
<div class="ahg-settings-page">
    ...
    <div class="mb-3">
        <a href="<?php echo url_for(['module' => 'settings', 'action' => 'index']) ?>" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <div class="list-group list-group-flush">
                    <?php foreach ($sections as $sectionKey => $sectionInfo): ?>
                        <a href="<?php echo url_for(['module' => 'settings', 'action' => 'section', 'section' => $sectionKey]); ?>" 
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <a href="<?php echo url_for(['module' => 'settings', 'action' => 'export']); ?>" class="btn btn-outline-secondary btn-sm btn-block mb-2">
                        <i class="fas fa-download"></i> <?php echo __('Export Settings'); ?>
                    </a>
                    <a href="<?php echo url_for(['module' => 'settings', 'action' => 'import']); ?>" class="btn btn-outline-secondary btn-sm btn-block mb-2">
                        <i class="fas fa-upload"></i> <?php echo __('Import Settings'); ?>
                    </a>
                    <a href="<?php echo url_for(['module' => 'settings', 'action' => 'reset', 'section' => $currentSection]); ?>" 
        ...
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo url_for(['module' => 'settings', 'action' => 'section', 'section' => $currentSection]); ?>" id="settings-form">
...
<?php $fusekiAdmin = preg_replace('#/[^/]+$#', '/', $settings['fuseki_endpoint'] ?? sfConfig::get('app_ric_fuseki_endpoint', 'http://localhost:3030/ric')); ?>
                                ...
                                document.getElementById('test-fuseki-btn')?.addEventListener('click', function() {
                                    ...
                                    fetch('<?php echo url_for(['module' => 'settings', 'action' => 'fusekiTest']); ?>', {
                                        method: 'POST',
