# AHG Favorites Plugin

Full-featured favorites/bookmarks management with folders, notes, bulk operations, and AJAX toggle

| | |
|---|---|
| Machine name | `ahgFavoritesPlugin` |
| Version | 2.0.1 |
| Category | ahg |
...
cd tmp-fetch && git sparse-checkout set ahgFavoritesPlugin && cd ..
mv tmp-fetch/ahgFavoritesPlugin ./ahgFavoritesPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgFavoritesPlugin/database/install.sql
