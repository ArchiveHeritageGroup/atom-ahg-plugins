...
Vendor and supplier management with transactions, services, and contact tracking

| | |
|---|---|
| Machine name | `ahgVendorPlugin` |
| Version | 1.0.11 |
| Category | ahg |
...
- `ahg_vendor_transaction_attachments`
- `ahg_vendor_metrics`
- `ahg_contract_type`
- `ahg_contract`
- `ahg_contract_document`
- `ahg_contract_reminder`
- `ahg_contract_history`
...
cd tmp-fetch && git sparse-checkout set ahgVendorPlugin && cd ..
mv tmp-fetch/ahgVendorPlugin ./ahgVendorPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgVendorPlugin/database/install.sql
