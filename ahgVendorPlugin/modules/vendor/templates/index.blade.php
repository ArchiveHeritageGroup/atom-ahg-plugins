...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="@url('ahg_vend_list')" class="btn btn-outline-secondary">
                <i class="fas fa-building me-1"></i>All Vendors
            </a>
            <a href="@url('ahg_vend_transactions')" class="btn btn-outline-secondary">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="@url('ahg_vend_transaction_view', ['id' => $trans->id])" class="btn btn-sm btn-outline-primary">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="@url('ahg_vend_transaction_add')" class="btn btn-sm btn-primary">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="@url('ahg_vend_view', ['slug' => $trans->vendor_slug])">
                                            {{ e($trans->vendor_name) }}
                                        </a>
                                    </td>
                                    <td>{{ e($trans->service_name) }}</td>
                                    <td><span class="badge bg-secondary">{{ $trans->item_count }}</span></td>
                                    <td>@include('_statusBadge', ['status' => $trans->status])</td>
                                    <td>
                ...
                <div class="card-footer">
                    <a href="@url('ahg_vend_transactions')">View all transactions &rarr;</a>
                </div>
            </div>
        </div>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="@url('ahg_vend_add')" class="btn btn-outline-primary">
                            <i class="fas fa-building me-2"></i>Add New Vendor
                        </a>
                        <a href="@url('ahg_vend_transaction_add')" class="btn btn-outline-success">
                            <i class="fas fa-plus me-2"></i>Create Transaction
                        </a>
                        <a href="@url('ahg_vend_transactions', ['overdue' => 1])" class="btn btn-outline-danger">
