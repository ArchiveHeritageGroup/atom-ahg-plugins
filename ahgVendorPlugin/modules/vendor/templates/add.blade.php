...
<div class="container-fluid px-4">
    ...
    <form method="post" action="@url('ahg_vend_add')">
        <div class="row">
            <div class="col-md-8">
                {{-- Basic Information --}}
                <div class="card mb-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="country" class="form-control" value="{{ e($form['country'] ?? 'South Africa') }}">
                        </div>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a href="@url('ahg_vend_list')" class="btn btn-secondary">Cancel</a>
            </div>
        </div>
    </form>
</div>
