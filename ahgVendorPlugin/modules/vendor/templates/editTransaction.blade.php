...
<div class="container-fluid px-4">
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="@url('ahg_vend_transaction_view', ['id' => $transaction->id])">{{ e($transaction->transaction_number) }}</a></li>
    ...
    <form method="post" action="@url('ahg_vend_transaction_edit', ['id' => $transaction->id])" class="needs-validation" novalidate>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="@url('ahg_vend_transaction_view', ['id' => $transaction->id])" class="btn btn-secondary">
