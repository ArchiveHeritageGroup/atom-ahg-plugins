...
@section('content')
@php
$statsArr = is_object($stats) ? (array) $stats : $stats;
@endphp
...
<div class="container-fluid px-4">
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="@url('ahg_vend_list')">Vendors</a></li>
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="@url('ahg_vend_edit', ['slug' => $vendor->slug])" class="btn btn-primary">
                <i class="fas fa-edit me-1"></i>Edit
            </a>
            <a href="@url('ahg_vend_transaction_add', ['vendor' => $vendor->slug])" class="btn btn-success">
        ...
        <div class="col-md-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <span class="badge bg-primary">{{ e(is_object($service) ? $service->name : $service['name']) }}</span>
                        @endforeach
                    </div>
                    @else
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="@url('ahg_vend_contact_delete', ['slug' => $vendor->slug, 'contact_id' => $contact->id])" class="btn btn-outline-danger" title="Delete" onclick="return confirm('Delete this contact?');">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="@url('ahg_vend_transactions', ['vendor_id' => $vendor->id])" class="btn btn-sm btn-outline-primary">
                        View All
                    </a>
                </div>
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="@url('ahg_vend_transaction_view', ['id' => $trans->id])">
                                            {{ e($trans->transaction_number) }}
                                        </a>
                                    </td>
                                    <td>{{ e($trans->service_name ?? '-') }}</td>
                                    <td>{{ date('d M Y', strtotime($trans->request_date)) }}</td>
                                    <td>
                                        @php
                                        $statusBadges = [
                                            'pending' => 'warning',
                            ...
                            <td>
                                @if (!empty($vendor->insurance_expiry_date))
                                    ...
                                    <span class="{{ $expired ? 'text-danger' : '' }}">
                                        {{ date('d M Y', strtotime($vendor->insurance_expiry_date)) }}
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <small class="text-muted">
                        Created: {{ date('d M Y H:i', strtotime($vendor->created_at)) }}<br>
                        Updated: {{ date('d M Y H:i', strtotime($vendor->updated_at)) }}
                    </small>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="addContactModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="@url('ahg_vend_contact_add', ['slug' => $vendor->slug])">
