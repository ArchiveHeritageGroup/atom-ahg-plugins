...
<div class="container-fluid px-4">
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="@url('ahg_vend_view', ['slug' => $vendor->slug])">{{ e($vendor->name) }}</a></li>
    ...
    <form method="post" action="@url('ahg_vend_edit', ['slug' => $vendor->slug])" class="needs-validation" novalidate>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="country" class="form-control" value="{{ e($vendor->country ?? 'South Africa') }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="@url('ahg_vend_view', ['slug' => $vendor->slug])" class="btn btn-secondary">
