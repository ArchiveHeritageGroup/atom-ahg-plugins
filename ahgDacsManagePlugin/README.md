...
DACS (Describing Archives: A Content Standard) edit form for information objects
...
cd tmp-fetch && git sparse-checkout set ahgDacsManagePlugin && cd ..
mv tmp-fetch/ahgDacsManagePlugin ./ahgDacsManagePlugin && rm -rf tmp-fetch
