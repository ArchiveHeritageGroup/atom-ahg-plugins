...
-- Flattens SharePoint ingest events with drive + tenant context.
--
-- Mirrored in heratio/packages/ahg-sharepoint/database/views/.
-- Append manually to atom-framework/database/views/reporting_views.sql when
-- the plugin is enabled in production.
