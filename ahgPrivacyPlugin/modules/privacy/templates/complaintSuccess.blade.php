    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ url_for(['module' => 'privacy', 'action' => 'complaint']) }}">
                        <div class="mb-3">
                        ...
                        <div class="d-grid gap-2 d-md-flex">
                            ...
                            <a href="{{ url_for(['module' => 'privacy', 'action' => 'index']) }}" class="btn btn-outline-secondary btn-lg">
                                {{ __('Cancel') }}
                            </a>
                        </div>
                    </form>
            ...
            <div class="card bg-light mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="small mb-0"><strong>{{ __('Note:') }}</strong> {{ __('If you simply want to access, correct, or delete your personal information, please use our') }} 
                        <a href="{{ url_for(['module' => 'privacy', 'action' => 'dsarRequest']) }}">{{ __('Data Subject Request') }}</a> {{ __('form instead.') }}
                    </p>
                </div>
            </div>
