    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo url_for(['module' => 'privacy', 'action' => 'complaint']); ?>">
                        <div class="mb-3">
                        ...
                        <div class="d-grid gap-2 d-md-flex">
                            ...
                            <a href="<?php echo url_for(['module' => 'privacy', 'action' => 'index']); ?>" class="btn btn-outline-secondary btn-lg">
                                <?php echo __('Cancel'); ?>
                            </a>
                        </div>
                    </form>
            ...
            <div class="card bg-light mb-4">
                ...
                <div class="card-body">
                    ...
                    <p class="small mb-0"><strong><?php echo __('Note:'); ?></strong> <?php echo __('If you simply want to access, correct, or delete your personal information, please use our'); ?> 
                        <a href="<?php echo url_for(['module' => 'privacy', 'action' => 'dsarRequest']); ?>"><?php echo __('Data Subject Request'); ?></a> <?php echo __('form instead.'); ?>
                    </p>
                </div>
            </div>
