            ...
            <div class="card mb-4 border-primary">
                ...
                <div class="card-body">
                    <div class="d-grid gap-3">
                        <a href="<?php echo url_for(['module' => 'privacy', 'action' => 'dsarRequest']); ?>" class="btn btn-primary btn-lg">
                            <i class="fas fa-file-alt me-2"></i><?php echo __('Submit Data Request'); ?>
                        </a>
                        <a href="<?php echo url_for(['module' => 'privacy', 'action' => 'complaint']); ?>" class="btn btn-warning btn-lg">
                            <i class="fas fa-exclamation-circle me-2"></i><?php echo __('Lodge Complaint'); ?>
                        </a>
                        <a href="<?php echo url_for(['module' => 'privacy', 'action' => 'dsarStatus']); ?>" class="btn btn-outline-secondary btn-lg">
