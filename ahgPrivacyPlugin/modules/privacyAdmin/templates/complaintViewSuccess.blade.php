...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'complaintList']) }}" class="btn btn-outline-secondary btn-sm me-3">
...
@endphp
        <span class="badge bg-{{ $statusClasses[$complaint->status] ?? 'secondary' }} fs-6">
            ...
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'complaintEdit', 'id' => $complaint->id]) }}" class="btn btn-primary ms-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'complaintUpdate', 'id' => $complaint->id]) }}">
                        <div class="mb-3">
