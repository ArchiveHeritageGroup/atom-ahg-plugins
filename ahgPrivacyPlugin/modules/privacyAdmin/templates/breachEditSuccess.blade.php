...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'breachView', 'id' => $breach->id]) }}" class="btn btn-secondary">
                <i class="fas fa-arrow-left me-1"></i>{{ __('Back to View') }}
            </a>
        </div>
    </div>

    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'breachEdit', 'id' => $breach->id]) }}">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'breachView', 'id' => $breach->id]) }}" class="btn btn-outline-secondary">
                                {{ __('Cancel') }}
                            </a>
                        </div>
                    </div>
