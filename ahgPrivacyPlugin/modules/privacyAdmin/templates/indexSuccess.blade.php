...
@endphp
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'index']) }}">{{ __('All Jurisdictions') }}</a></li>
            ...
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'report']) }}" class="btn btn-outline-secondary">
                <i class="fas fa-chart-bar me-1"></i><span class="d-none d-sm-inline">{{ __('Reports') }}</span>
            </a>
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'notifications']) }}" class="btn btn-outline-secondary position-relative">
                <i class="fas fa-bell"></i>
                @php $notifCount = $notificationCount ?? 0; if ($notifCount > 0): @endphp
                <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger">{{ $notifCount }}</span>
                @endif
            </a>
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'config']) }}" class="btn btn-outline-secondary">
    ...
    <div class="alert alert-primary d-flex align-items-center mb-4">
        ...
        <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'jurisdictions']) }}" class="btn btn-primary btn-sm">
    ...
    <div class="alert alert-warning d-flex align-items-center mb-4">
        ...
        <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'jurisdictions']) }}" class="btn btn-warning btn-sm">
            ...
            <div class="card bg-gradient privac-background-linear-gradient-1-8c20" >
                <div class="card-body text-white text-center py-4">
                    ...
                    <div class="progress mt-3 mx-auto privac-max-width-400px-height-10px-d842" >
                        <div class="progress-bar bg-light" data-ahg-style="width: {{ $stats['compliance_score'] ?? 0 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card h-100 border-primary">
                ...
                <div class="card-footer bg-transparent">
                    <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'dsarList', 'jurisdiction' => $currentJurisdiction]) }}" class="text-primary">
        ...
        <div class="col-md-3">
            <div class="card h-100 border-danger">
                ...
                <div class="card-footer bg-transparent">
                    <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'breachList', 'jurisdiction' => $currentJurisdiction]) }}" class="text-danger">
                        {{ __('View all') }} <i class="fas fa-arrow-right ms-1"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card h-100 border-success">
                ...
                <div class="card-footer bg-transparent">
                    <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaList', 'jurisdiction' => $currentJurisdiction]) }}" class="text-success">
                        {{ __('View all') }} <i class="fas fa-arrow-right ms-1"></i>
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card h-100 border-info">
                ...
                <div class="card-footer bg-transparent">
                    <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'consentList']) }}" class="text-info">
                        {{ __('View all') }} <i class="fas fa-arrow-right ms-1"></i>
                    </a>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'dsarAdd']) }}" class="btn btn-outline-primary btn-lg w-100">
                                <i class="fas fa-plus-circle d-block mb-2 fa-2x"></i>
                                {{ __('New DSAR') }}
                            </a>
                        </div>
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'breachAdd']) }}" class="btn btn-outline-danger btn-lg w-100">
                                <i class="fas fa-exclamation-triangle d-block mb-2 fa-2x"></i>
                                {{ __('Report Breach') }}
                            </a>
                        </div>
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaAdd']) }}" class="btn btn-outline-success btn-lg w-100">
                        ...
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'paiaList']) }}" class="btn btn-outline-warning btn-lg w-100">
                        ...
                        @endif
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'officerList']) }}" class="btn btn-outline-secondary btn-lg w-100">
                                <i class="fas fa-user-tie d-block mb-2 fa-2x"></i>
                                {{ __('Officers') }}
                            </a>
                        </div>
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'complaintList']) }}" class="btn btn-outline-warning btn-lg w-100">
                                <i class="fas fa-exclamation-circle d-block mb-2 fa-2x"></i>
                                {{ __('Complaints') }}
                            </a>
                        </div>
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'jurisdictions']) }}" class="btn btn-outline-info btn-lg w-100">
                                <i class="fas fa-globe d-block mb-2 fa-2x"></i>
                                {{ __('Jurisdictions') }}
                            </a>
                        </div>
                        <div class="col-md-2 col-6 text-center mb-3">
                            <a href="{{ url_for(['module' => 'privacy', 'action' => 'index']) }}" class="btn btn-outline-dark btn-lg w-100" target="_blank">
