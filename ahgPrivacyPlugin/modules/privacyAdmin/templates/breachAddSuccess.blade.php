...
<div class="container-fluid py-4">
    ...
    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'breachAdd']) }}">
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'breachList']) }}" class="btn btn-outline-secondary">
                                {{ __('Cancel') }}
                            </a>
                        </div>
                    </div>
