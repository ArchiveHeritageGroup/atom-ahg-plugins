...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center mb-4">
        <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'jurisdictionList']) }}" class="btn btn-outline-secondary me-3">
...
@endphp</textarea>
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'jurisdictionList']) }}" class="btn btn-outline-secondary">
                        {{ __('Cancel') }}
                    </a>
                </div>
            </div>
