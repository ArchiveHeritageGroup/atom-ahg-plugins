...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center mb-4">
        <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'officerList']) }}" class="btn btn-outline-secondary btn-sm me-3">
            <i class="fas fa-arrow-left"></i>
        </a>
        <h1 class="h2 mb-0"><i class="fas fa-user-tie me-2"></i>{{ __('Edit Privacy Officer') }}</h1>
    </div>

    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'officerEdit', 'id' => $officer->id]) }}">
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'officerList']) }}" class="btn btn-outline-secondary">
                                {{ __('Cancel') }}
                            </a>
                        </div>
                    </div>
