...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-grow-1">
            ...
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'jurisdictionList']) }}" class="btn btn-outline-info">
    ...
    <ul class="nav nav-tabs mb-4">
        ...
        <li class="nav-item">
            <a class="nav-link {{ $currentJurisdiction === $code ? 'active' : '' }}" 
               href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'config', 'jurisdiction' => $code]) }}">
                {{ $info['name'] }}
            </a>
        </li>
        @endforeach
    ...
    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'config', 'jurisdiction' => $currentJurisdiction]) }}">
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'officerAdd']) }}" class="btn btn-sm btn-outline-primary">
