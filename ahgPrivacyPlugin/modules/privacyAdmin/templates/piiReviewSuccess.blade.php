...
@endphp
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <form action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'piiEntityAction']) }}" method="post" class="d-inline">
                                    ...
                                    <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'visualRedactionEditor', 'id' => $entity->object_id]) }}"
