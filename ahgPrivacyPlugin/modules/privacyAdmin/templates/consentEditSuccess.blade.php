...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'consentView', 'id' => $consent->id]) }}" class="btn btn-secondary"><i class="fas fa-arrow-left me-1"></i>{{ __('Back') }}</a>
    </div>
    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'consentEdit', 'id' => $consent->id]) }}">
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'consentView', 'id' => $consent->id]) }}" class="btn btn-outline-secondary">{{ __('Cancel') }}</a>
                        </div>
                    </div>
                </div>
            </div>
