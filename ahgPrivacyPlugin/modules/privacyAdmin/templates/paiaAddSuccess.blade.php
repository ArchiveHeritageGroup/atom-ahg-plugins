...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center mb-4">
        <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'paiaList']) }}" class="btn btn-outline-secondary btn-sm me-3">
            <i class="fas fa-arrow-left"></i>
        </a>
        <h1 class="h2 mb-0"><i class="fas fa-file-contract me-2"></i>{{ __('New PAIA Request') }}</h1>
    </div>

    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'paiaAdd']) }}">
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
        ...
        <div class="d-flex justify-content-between">
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'paiaList']) }}" class="btn btn-secondary">
