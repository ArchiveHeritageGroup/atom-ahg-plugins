...
<div class="container-fluid py-4">
    <div class="d-flex align-items-center mb-4">
        ...
        <h1 class="h2 mb-0"><i class="fas fa-clipboard-list me-2"></i><?php echo __('Add Processing Activity'); ?></h1>
    </div>

    <form method="post" action="<?php echo url_for(['module' => 'privacyAdmin', 'action' => 'ropaAdd']); ?>">
        <div class="row">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="name" class="form-control" required placeholder="<?php echo __('e.g., Customer Database Processing'); ?>">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select name="lawful_basis" class="form-select" required>
                                    ...
                                    <option value="<?php echo $key; ?>"><?php echo $info['label']; ?> (<?php echo $info['code']; ?>)</option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="retention_period" class="form-control" placeholder="<?php echo __('e.g., 5 years after contract ends'); ?>">
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="assigned_officer_id" class="form-select">
                                ...
                                <option value="<?php echo $officer->id; ?>"><?php echo esc_specialchars($officer->name); ?> (<?php echo $officer->jurisdiction; ?>)</option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="mb-3">
