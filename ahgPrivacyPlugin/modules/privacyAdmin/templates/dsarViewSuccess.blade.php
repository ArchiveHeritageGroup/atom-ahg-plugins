...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'dsarList']) }}" class="btn btn-outline-secondary btn-sm me-3">
...
@endphp
            ...
            @endif
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'dsarScope', 'id' => $dsar->id]) }}" class="btn btn-outline-primary ms-2">
                <i class="fas fa-user-shield me-1"></i>{{ __('Redaction scope') }}
            </a>
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'dsarEdit', 'id' => $dsar->id]) }}" class="btn btn-primary ms-2">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'dsarUpdate', 'id' => $dsar->id]) }}">
                        <div class="mb-3">
