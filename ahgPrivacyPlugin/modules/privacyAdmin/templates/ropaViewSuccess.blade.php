...
@php $service = new \ahgPrivacyPlugin\Service\PrivacyService(); @endphp
@php $isOfficer = $service->isPrivacyOfficer($sf_user->getUserId()) || $sf_user->isAdministrator(); @endphp
@php $approvalHistory = $service->getApprovalHistory($activity->id, 'ropa'); @endphp
@php $officers = $service->getPrivacyOfficers(); @endphp
...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaList']) }}" class="btn btn-outline-secondary btn-sm me-3">
        ...
        <div>
            ...
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaEdit', 'id' => $activity->id]) }}" class="btn btn-primary ms-2">
            ...
            <div class="card mb-4 border-primary">
                ...
                <div class="card-body">
                    @if($activity->status === 'draft')
                        ...
                        <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaSubmit', 'id' => $activity->id]) }}">
                            @if(count($officers) > 1)
                            <div class="mb-3">
                    ...
                    @elseif($activity->status === 'pending_review')
                        ...
                        @if($isOfficer)
                        <!-- Approve -->
                        <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaApprove', 'id' => $activity->id]) }}" class="mb-3">
                            <div class="mb-2">
                        ...
                        <!-- Reject -->
                        <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaReject', 'id' => $activity->id]) }}">
                            <div class="mb-2">
