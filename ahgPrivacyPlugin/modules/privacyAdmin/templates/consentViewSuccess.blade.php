...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'consentList']) }}" class="btn btn-outline-secondary btn-sm me-3">
        ...
        <div>
            ...
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'consentEdit', 'id' => $consent->id]) }}" class="btn btn-primary ms-3"><i class="fas fa-edit me-1"></i>{{ __('Edit') }}</a>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'consentWithdraw', 'id' => $consent->id]) }}" onsubmit="return confirm('Are you sure?');">
                        <div class="mb-3">
