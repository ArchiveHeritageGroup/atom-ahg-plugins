...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'piiScan']) }}" class="btn btn-outline-secondary">
...
$slug = \Illuminate\Database\Capsule\Manager::table('slug')->where('object_id', $object->id)->value('slug');
            if ($slug):
@endphp
            <a href="{{ url_for(['module' => 'informationobject', 'action' => 'index', 'slug' => $slug]) }}" class="btn btn-outline-primary" target="_blank">
        ...
        <div class="col-md-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'piiScanObject', 'id' => $object->id]) }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'piiReview']) }}" class="btn btn-outline-warning w-100 mb-2">
                        <i class="fas fa-tasks me-1"></i>Review Queue
                    </a>
                    <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'visualRedactionEditor', 'id' => $object->id]) }}" class="btn btn-outline-danger w-100 mb-2">
                        <i class="fas fa-eraser me-1"></i>Visual Redaction Editor
                    </a>
                    <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'piiScan']) }}" class="btn btn-outline-secondary w-100">
