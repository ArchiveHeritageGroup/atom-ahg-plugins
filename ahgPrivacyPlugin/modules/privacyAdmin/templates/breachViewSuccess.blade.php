...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'breachList']) }}" class="btn btn-outline-secondary btn-sm me-3">
        ...
        <div>
            ...
            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'breachEdit', 'id' => $breach->id]) }}" class="btn btn-primary ms-3">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'breachUpdate', 'id' => $breach->id]) }}">
