    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ url_for(['module' => 'privacyAdmin', 'action' => 'piiScanRun']) }}" method="post">
                        <div class="mb-3">
...
@endphp
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaList']) }}" class="btn btn-outline-secondary w-100">
                    ...
                    @else
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ url_for(['module' => 'informationobject', 'action' => 'index', 'id' => $obj->object_id]) }}" target="_blank">
                                            {{ $obj->title ?? 'Untitled' }}
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'piiScanObject', 'id' => $obj->object_id]) }}" class="btn btn-sm btn-outline-primary">
