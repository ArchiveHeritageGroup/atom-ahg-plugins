    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body text-center">
                    <h2 class="display-5"><?php echo number_format($stats['total_scanned']); ?></h2>
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-dark">
                <div class="card-body text-center">
                    <h2 class="display-5"><?php echo number_format($stats['with_pii']); ?></h2>
        ...
        <div class="col-md-3">
            <div class="card bg-danger text-white">
                <div class="card-body text-center">
                    <h2 class="display-5"><?php echo number_format($stats['high_risk_entities']); ?></h2>
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body text-center">
                    <h2 class="display-5"><?php echo number_format($stats['coverage_percent'], 1); ?>%</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo url_for(['module' => 'privacyAdmin', 'action' => 'piiScanRun']); ?>" method="post">
                        <div class="mb-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a href="<?php echo url_for(['module' => 'privacyAdmin', 'action' => 'piiReview']); ?>" class="btn btn-outline-warning w-100 mb-2">
                        <i class="fas fa-tasks me-1"></i>Review Pending (<?php echo $stats['pending_review']; ?>)
                    </a>
                    <a href="<?php echo url_for(['module' => 'privacyAdmin', 'action' => 'ropaList']); ?>" class="btn btn-outline-secondary w-100">
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body p-0">
                    <?php if (empty($highRiskObjects) || count($highRiskObjects) === 0): ?>
                    ...
                    <?php else: ?>
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="<?php echo url_for(['module' => 'informationobject', 'action' => 'index', 'id' => $obj->object_id]); ?>" target="_blank">
                                            <?php echo esc_entities($obj->title ?? 'Untitled'); ?>
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <span class="badge bg-danger"><?php echo $obj->entity_count; ?></span>
                                    </td>
                                    <td>
                                        <small class="text-muted"><?php echo date('Y-m-d H:i', strtotime($obj->extracted_at)); ?></small>
                                    </td>
                                    <td>
                                        <a href="<?php echo url_for(['module' => 'privacyAdmin', 'action' => 'piiScanObject', 'id' => $obj->object_id]); ?>" class="btn btn-sm btn-outline-primary">
