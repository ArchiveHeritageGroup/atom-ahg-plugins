...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaAdd']) }}" class="btn btn-success">
...
@endphp
                    <tr>
                        <td>
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaView', 'id' => $activity->id]) }}">
                        ...
                        <td>
                            <a href="{{ url_for(['module' => 'privacyAdmin', 'action' => 'ropaEdit', 'id' => $activity->id]) }}" class="btn btn-sm btn-outline-secondary">
