...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <?php endif; ?>
            <a href="<?php echo url_for(['module' => 'privacyAdmin', 'action' => 'dsarScope', 'id' => $dsar->id]); ?>" class="btn btn-outline-primary ms-2">
                <i class="fas fa-user-shield me-1"></i><?php echo __('Redaction scope'); ?>
            </a>
            <a href="<?php echo url_for(['module' => 'privacyAdmin', 'action' => 'dsarEdit', 'id' => $dsar->id]); ?>" class="btn btn-primary ms-2">
