...
class PrivacyMigrations
{
    ...
    private static function createProcessingActivityTable(): string
    {
        ...
        $sql = "CREATE TABLE `{$tableName}` (
            ...
            `status` VARCHAR(53) COMMENT 'draft, pending_review, approved, archived' NOT NULL DEFAULT 'draft',
    ...
    private static function createDsarRequestTable(): string
    {
        ...
        $sql = "CREATE TABLE `{$tableName}` (
            ...
            `status` VARCHAR(79) COMMENT 'pending, in_progress, awaiting_info, completed, rejected, withdrawn' NOT NULL DEFAULT 'pending',
    ...
    private static function createBreachIncidentTable(): string
    {
        ...
        $sql = "CREATE TABLE `{$tableName}` (
            ...
            `status` VARCHAR(50) COMMENT 'open, investigating, contained, closed' NOT NULL DEFAULT 'open',
