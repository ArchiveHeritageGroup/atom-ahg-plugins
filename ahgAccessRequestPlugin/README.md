...
| | |
|---|---|
| Machine name | `ahgAccessRequestPlugin` |
| Version | 1.1.6 |
| Category | rights |
...
cd tmp-fetch && git sparse-checkout set ahgAccessRequestPlugin && cd ..
mv tmp-fetch/ahgAccessRequestPlugin ./ahgAccessRequestPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgAccessRequestPlugin/database/install.sql
