...
CREATE TABLE IF NOT EXISTS `rights_derivative_rule` (
  ...
  `rule_type` VARCHAR(75) COMMENT 'watermark, redaction, resize, format_conversion, metadata_strip' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `watermark_position` VARCHAR(72) COMMENT 'center, top_left, top_right, bottom_left, bottom_right, tile' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'bottom_right',
...
CREATE TABLE IF NOT EXISTS `rights_embargo` (
  ...
  `embargo_type` VARCHAR(54) COMMENT 'full, metadata_only, digital_only, partial' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'full',
  `reason` VARCHAR(105) COMMENT 'donor_restriction, copyright, privacy, legal, commercial, research, cultural, security, other' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `status` VARCHAR(54) COMMENT 'active, pending, lifted, expired, extended' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'active',
...
CREATE TABLE IF NOT EXISTS `rights_embargo_log` (
  ...
  `action` VARCHAR(81) COMMENT 'created, extended, lifted, reviewed, notification_sent, auto_released' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rights_grant` (
  ...
  `act` VARCHAR(119) COMMENT 'render, disseminate, replicate, migrate, modify, delete, print, use, publish, excerpt, annotate, move, sell' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `restriction` VARCHAR(40) COMMENT 'allow, disallow, conditional' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'allow',
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `rights_orphan_search_step` (
  ...
  `source_type` VARCHAR(103) COMMENT 'database, registry, publisher, author_society, archive, library, internet, newspaper, other' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rights_orphan_work` (
  `id` int NOT NULL AUTO_INCREMENT,
  `object_id` int NOT NULL COMMENT 'FK to information_object.id',
  `status` VARCHAR(66) COMMENT 'in_progress, completed, rights_holder_found, abandoned' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'in_progress',
  `work_type` VARCHAR(127) COMMENT 'literary, dramatic, musical, artistic, film, sound_recording, broadcast, typographical, database, photograph, other' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `rights_record` (
  `id` int NOT NULL AUTO_INCREMENT,
  `object_id` int NOT NULL COMMENT 'FK to information_object.id',
  `basis` VARCHAR(61) COMMENT 'copyright, license, statute, donor, policy, other' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'copyright',
  `rights_statement_id` int DEFAULT NULL,
  `cc_license_id` int DEFAULT NULL,
  `copyright_status` VARCHAR(47) COMMENT 'copyrighted, public_domain, unknown' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'unknown',
...
CREATE TABLE IF NOT EXISTS `rights_territory` (
  `id` int NOT NULL AUTO_INCREMENT,
  `rights_record_id` int NOT NULL,
  `territory_type` VARCHAR(28) COMMENT 'include, exclude' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'include',
...
CREATE TABLE IF NOT EXISTS `rights_tk_label` (
  `id` int NOT NULL AUTO_INCREMENT,
  `code` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `category` VARCHAR(31) COMMENT 'tk, bc, attribution' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'tk',
