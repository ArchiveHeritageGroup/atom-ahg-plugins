    ...
    public function up(): void
    {
        ...
        $pdo->exec("
            CREATE TABLE IF NOT EXISTS research_researcher (
                ...
                status VARCHAR(50) COMMENT 'pending, approved, rejected, suspended' DEFAULT 'pending',
                approved_by INT,
        ...
        $pdo->exec("
            CREATE TABLE IF NOT EXISTS research_material_request (
                ...
                status VARCHAR(60) COMMENT 'pending, approved, rejected, delivered, returned' DEFAULT 'pending',
                processed_by INT,
        ...
        $pdo->exec("
            CREATE TABLE IF NOT EXISTS research_annotation (
                ...
                researcher_id INT NOT NULL,
                object_id INT NOT NULL,
                annotation_type VARCHAR(42) COMMENT 'note, highlight, bookmark, tag' DEFAULT 'note',
                content TEXT,
                page_number INT,
                position JSON,
