...
<style <?php echo $cspNonce ? preg_replace('/^nonce=/', 'nonce="', $cspNonce).'"' : ''; ?>>
  .resear-background-typecolors-node-t-fb04 { background:' + (typeColors[node.type] || '#76b7b2') + '; }
  .resear-width-100-height-600px-backg-79b9 { width:100%; height:600px; background:#fafafa; }
  .resear-width-180px-a2ad { width:180px; }
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div class="d-flex gap-2">
        ...
        <select id="filterStatus" class="form-select form-select-sm resear-width-auto-d3b6" >
            <option value="">All Statuses</option>
            <option value="proposed">Proposed</option>
            <option value="verified">Verified</option>
            <option value="disputed">Disputed</option>
        </select>
        <input type="text" id="nodeSearch" class="form-control form-control-sm resear-width-180px-a2ad"  placeholder="Search nodes...">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showNodeDetail(node) {
        ...
        html += '<p class="mb-1"><span class="badge resear-background-typecolors-node-t-fb04" >' + escHtml(node.type || 'unknown') + '</span></p>';
