...
<style <?php echo $cspNonce ? preg_replace('/^nonce=/', 'nonce="', $cspNonce).'"' : ''; ?>>
  .resear-width-200px-5c2d { width: 200px; }
  .resear-width-auto-dc25 { width: auto; }
</style>
<?php slot('sidebar') ?>
    ...
    <div class="row align-items-center">
      <div class="col-md-6">
        <form method="get" class="d-flex gap-2">
          <select name="status" class="form-select form-select-sm resear-width-auto-dc25"  onchange="this.form.submit()">
          ...
          <input type="text" name="q" class="form-control form-control-sm" placeholder="<?php echo __('Search...'); ?>" value="<?php echo htmlspecialchars($_GET['q'] ?? ''); ?>" class="resear-width-200px-5c2d">
