...
<style <?php echo $cspNonce ? preg_replace('/^nonce=/', 'nonce="', $cspNonce).'"' : ''; ?>>
  .resear-max-height-300px-overflow-y--3db9 { max-height: 300px; overflow-y: auto; }
  .resear-max-height-120px-f900 { max-height:120px; }
</style>
<?php slot('sidebar') ?>
    ...
    <div class="card h-100">
      ...
      <div class="text-center bg-light p-2">
        ...
        <a href="<?php echo url_for(['module' => $thumbModule, 'slug' => $thumbSlug]); ?>" title="<?php echo htmlspecialchars($annotation->object_title ?? ''); ?>">
          <img src="<?php echo htmlspecialchars($annotation->thumbnail_path); ?>" alt="<?php echo htmlspecialchars($annotation->object_title ?? ''); ?>" class="img-fluid rounded resear-max-height-120px-f900" >
        </a>
      </div>
      <?php endif; ?>
      <div class="card-body">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3">
          ...
          <?php if (!empty($annotations)): ?>
          <div class="resear-max-height-300px-overflow-y--3db9">
