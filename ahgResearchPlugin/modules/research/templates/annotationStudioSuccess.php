...
<div class="row" id="annotation-image-panel">
    <div class="col-lg-9">
        <div class="card">
            ...
            <div class="card-header p-2">
                <div class="d-flex flex-wrap gap-2 align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-1 ms-2">
                        ...
                        <input type="color" id="annColor" value="#FF0000" class="border rounded" data-ahg-style="width:32px;height:26px;padding:1px;cursor:pointer;">
                    </div>
            ...
            <!-- Canvas Area -->
            <div class="card-body p-0" id="canvasWrapper" data-ahg-style="background:#1a1a2e;overflow:auto;min-height:500px;display:flex;justify-content:center;align-items:center;padding:20px !important;">
    ...
    <div class="col-lg-3">
        ...
        <div class="card">
            ...
            <div class="card-body py-0 px-0" data-ahg-style="max-height:400px;overflow-y:auto;">
                ...
                <?php else: ?>
                    ...
                    <div class="border-bottom p-2 annotation-list-item <?php echo $hasFragment ? 'has-region' : ''; ?>"
                         ...
                         data-ahg-style="cursor:pointer;font-size:0.85em;">
                        <div class="d-flex justify-content-between align-items-start">
                            <span class="badge bg-info" data-ahg-style="font-size:0.7em;"><?php echo htmlspecialchars($ann->motivation ?? 'commenting'); ?></span>
                            <div class="d-flex gap-1">
                                <button class="btn btn-link btn-sm p-0 text-warning edit-ann-btn" data-id="<?php echo (int) $ann->id; ?>" data-body="<?php echo htmlspecialchars($bodyText); ?>" data-motivation="<?php echo htmlspecialchars($ann->motivation ?? 'commenting'); ?>" title="Edit"><i class="fas fa-edit" data-ahg-style="font-size:0.75em;"></i></button>
                                <button class="btn btn-link btn-sm p-0 text-danger delete-ann-btn" data-id="<?php echo (int) $ann->id; ?>" title="Delete"><i class="fas fa-trash" data-ahg-style="font-size:0.75em;"></i></button>
                            </div>
                        </div>
        ...
        <div class="card mt-3" id="aiResultsCard" class="d-none">
...
<div id="annotation-3d-panel" class="row" data-ahg-style="<?php echo $hasImage ? 'display:none;' : ''; ?>">
        ...
        <div class="card">
            <div class="card-header p-2">
                <div class="d-flex flex-wrap gap-2 align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-1 ms-2">
                        <label class="form-label mb-0 small">Color:</label>
                        <input type="color" id="ann3dColor" value="#1a73e8" class="border rounded" data-ahg-style="width:32px;height:26px;padding:1px;cursor:pointer;">
                    </div>
            ...
            <div class="card-body p-0" data-ahg-style="position:relative;">
                <model-viewer
    ...
    <div class="col-lg-3">
        ...
        <div class="card">
            ...
            <div class="card-body py-0 px-0" data-ahg-style="max-height:400px;overflow-y:auto;" id="annotations3dList">
                <?php
                ...
                <div class="border-bottom p-2 annotation-3d-list-item"
                    ...
                    <div class="d-flex justify-content-between align-items-start">
                        <span>
                            <span class="badge bg-info" data-ahg-style="font-size:0.7em;"><?php echo htmlspecialchars($ann->motivation ?? 'commenting'); ?></span>
                            <i class="fas fa-cube text-primary ms-1" data-ahg-style="font-size:0.7em;" title="3D annotation"></i>
                        </span>
                        <div class="d-flex gap-1">
                            <button class="btn btn-link btn-sm p-0 text-warning edit-ann-btn" data-id="<?php echo (int) $ann->id; ?>" data-body="<?php echo htmlspecialchars($bodyText3d); ?>" data-motivation="<?php echo htmlspecialchars($ann->motivation ?? 'commenting'); ?>" title="Edit"><i class="fas fa-edit" data-ahg-style="font-size:0.75em;"></i></button>
                            <button class="btn btn-link btn-sm p-0 text-danger delete-ann-btn" data-id="<?php echo (int) $ann->id; ?>" title="Delete"><i class="fas fa-trash" data-ahg-style="font-size:0.75em;"></i></button>
                        </div>
                    </div>
                ...
                if (damages.length) {
                    ...
                    damages.forEach(function(d) {
                        ...
                        html += '<div class="d-flex justify-content-between py-1 border-bottom">'
                            + '<span><span data-ahg-style="display:inline-block;width:10px;height:10px;border-radius:50%;background:' + color + ';margin-right:4px;"></span>' + (d.damage_type||'').replace(/_/g,' ') + '</span>'
