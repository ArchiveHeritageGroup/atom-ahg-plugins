      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          <div class="input-group">
            ...
            <button type="submit" formaction="<?php echo url_for(['module' => 'settings', 'action' => 'testEmail']); ?>" class="btn btn-outline-primary">
              <i class="fas fa-paper-plane me-1"></i><?php echo __('Send Test'); ?>
            </button>
          </div>
          <small class="text-muted"><?php echo __('Save settings first, then send a test email'); ?></small>
        </div>
      </div>
