...
The AtoM Heratio Research Portal is an enterprise-grade research support platform built into the AtoM archival management system. It provides a complete environment for researchers to discover, analyze, annotate, and publish findings from archival collections.
...
Navigate to **`/research`** on your AtoM Heratio instance (e.g., `https://psis.theahg.co.za/research`).
...
2. A Collections Procedures movement record is auto-generated (movement reason: `research_checkout`)
...
2. A Collections Procedures movement record is auto-generated (movement reason: `research_return`)
...
| Collections Procedures Movement | Truck icon (cyan) | Physical movement records |
...
### Collections Procedures Movement Integration
...
- Compliant with Collections Procedures Object Location and Movement Control procedures
