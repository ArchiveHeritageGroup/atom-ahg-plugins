...
Every plugin declares what it needs in its `extension.json`, and the installer now
...
Install in this order. Anything in a later tier depends on something in an earlier one.

**Tier 1 - no dependencies**

| Plugin | Tables | Notes |
|---|---|---|
| `ahgRuntimePlugin` | 3 | Generated by `bin/build-runtime-plugin`, not cloned. Everything else needs it. |
| `ahgCorePlugin` | 5 | Bootstraps the framework. Every other plugin depends on it. |

**Tier 2 - depend on ahgCorePlugin only**

| Plugin | Tables |
|---|---|
| `ahgContactPlugin` | 1 |
| `ahgSecurityClearancePlugin` | 21 |
| `ahgDisplayPlugin` | 14 |
| `ahgSettingsPlugin` | 5 |
| `ahgUiOverridesPlugin` | 0 |
| `ahgAuditTrailPlugin` | 6 |
| `ahgBackupPlugin` | 3 |
| `ahgProvenancePlugin` | 9 |
| `ahgConditionPlugin` | 16 |
| `ahgCartPlugin` | 8 |
| `ahgRequestToPublishPlugin` | 4 |
| `ahgUserRegistrationPlugin` | 1 |
| `ahgMetadataExtractionPlugin` | 2 |
| `ahgSiteRecordPlugin` | 3 |

**Tier 3 - depend on a tier 2 plugin**

| Plugin | Tables | Requires |
|---|---|---|
| `ahgAccessRequestPlugin` | 7 | ahgCorePlugin, **ahgSecurityClearancePlugin** |
| `ahgThemeB5Plugin` | 0 | ahgCorePlugin, **ahgContactPlugin**, **ahgUiOverridesPlugin**, **ahgMetadataExtractionPlugin** |
...
install` for those, which is success, not a failure.

`ahgThemeB5Plugin` depending on `ahgMetadataExtractionPlugin` is worth knowing before you
plan a minimal install: the theme pulls in metadata extraction, which needs ExifTool at
