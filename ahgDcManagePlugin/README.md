...
Dublin Core descriptive standard edit form for information objects
...
cd tmp-fetch && git sparse-checkout set ahgDcManagePlugin && cd ..
mv tmp-fetch/ahgDcManagePlugin ./ahgDcManagePlugin && rm -rf tmp-fetch
