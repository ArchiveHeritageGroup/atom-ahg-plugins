    ...
    protected function addField($name)
    {
        switch ($name) {
            ...
            case 'separator_character':
                ...
                $default = (null !== $this->{$name} = SettingService::getByName($name)) ? $this->{$name}->getValue(['sourceCulture' => true]) : '';
            ...
            case 'prevent_duplicate_actor_identifiers':
                ...
                $default = (null !== $this->{$name} = SettingService::getByName($name)) ? $this->{$name}->getValue(['sourceCulture' => true]) : $defaults[$name];
