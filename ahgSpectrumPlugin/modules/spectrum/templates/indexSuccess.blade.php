...
@section('sidebar')
  ...
  <div class="card mb-3">
    ...
    <ul class="list-group list-group-flush">
      <li class="list-group-item">
        <a href="{{ url_for(['module' => 'spectrum', 'action' => 'label', 'slug' => $resource->slug]) }}">
          <i class="fas fa-barcode me-2"></i>{{ __('Print Labels') }}
        </a>
      </li>
      <li class="list-group-item">
        <a href="{{ url_for(['module' => 'spectrum', 'action' => 'conditionPhotos', 'slug' => $resource->slug]) }}">
  ...
  <!-- Back Link -->
  <a href="{{ url_for(['module' => 'informationobject', 'action' => 'index', 'slug' => $resource->slug]) }}" class="btn btn-outline-secondary w-100">
...
@section('title')
  <div class="d-flex align-items-center mb-3">
    ...
    <div>
      <h1 class="mb-0">{{ __('Collections Procedures Data') }}</h1>
...
<nav aria-label="breadcrumb" class="mb-4">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">{{ __('Collections Procedures Data') }}</li>
  </ol>
</nav>
...
<div class="card mb-4">
  <div class="card-header bg-success text-white">
    <h5 class="mb-0"><i class="fas fa-tasks me-2"></i>{{ __('Collections Procedures Procedures') }}</h5>
  </div>
  <div class="card-body">
    <p class="text-muted mb-4">{{ __('Manage collections management procedures according to Collections Procedures standard.') }}</p>
      ...
      <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="card h-100 border-{{ $color }}">
          <div class="card-body text-center p-3">
            ...
            <a href="{{ url_for(['module' => 'spectrum', 'action' => 'workflow', 'slug' => $resource->slug, 'procedure_type' => $key]) }}"
