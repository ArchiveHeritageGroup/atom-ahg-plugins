...
<div class="row">
    <div class="col-md-3">
        <div class="card mb-4">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item {{ $isActive ? 'active' : '' }}">
                    <a href="{{ url_for(['module' => 'spectrum', 'action' => 'workflow', 'slug' => $resource->slug, 'procedure_type' => $procId]) }}"
        ...
        <a href="{{ url_for(['module' => 'informationobject', 'action' => 'index', 'slug' => $resource->slug]) }}" class="btn btn-secondary w-100">
