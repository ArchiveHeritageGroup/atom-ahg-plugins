...
@if($identifier)
<div class="alert alert-info">Exporting data for: <strong>{{ $identifier }}</strong></div>
@endif
        ...
        <form method="get" action="" class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <select name="type" class="form-select">
                    <option value="movement">Movements ({{ count($movements) }})</option>
                    <option value="condition">Condition Checks ({{ count($conditions) }})</option>
                    <option value="valuation">Valuations ({{ count($valuations) }})</option>
                    <option value="loan">Loans ({{ count($loansIn) + count($loansOut) }})</option>
