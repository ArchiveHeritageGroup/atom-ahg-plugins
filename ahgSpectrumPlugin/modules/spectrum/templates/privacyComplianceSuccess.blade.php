...
<div class="row">
    <div class="col-md-12">
        <div class="btn-group mb-4">
            <a href="/admin/privacy/ropa" class="btn btn-outline-primary">{{ __('ROPA') }}</a>
            <a href="/admin/privacy/dsar" class="btn btn-outline-warning">{{ __('DSARs') }}</a>
            <a href="/admin/privacy/breaches" class="btn btn-outline-danger">{{ __('Breaches') }}</a>
        </div>
    </div>
</div>
