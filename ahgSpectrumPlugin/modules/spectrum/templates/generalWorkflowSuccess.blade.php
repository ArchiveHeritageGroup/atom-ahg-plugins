...
<div class="row">
    <div class="col-md-3">
        ...
        <div class="card mb-4">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item {{ $isActive ? 'active' : '' }}">
                    <a href="{{ url_for(['module' => 'spectrum', 'action' => 'generalWorkflow', 'procedure_type' => $procId]) }}"
        ...
        <a href="{{ url_for(['module' => 'spectrum', 'action' => 'general']) }}" class="btn btn-secondary w-100">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <form method="post" action="{{ url_for(['module' => 'spectrum', 'action' => 'generalWorkflowTransition']) }}" class="row g-3">
