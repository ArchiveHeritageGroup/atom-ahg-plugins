...
<div class="mb-3">
    <a href="/admin/privacy/manage" class="btn btn-secondary"><i class="fas fa-arrow-left me-1"></i>{{ __('Back') }}</a>
                ...
                <li class="list-group-item">
                    <div class="d-flex justify-content-between align-items-start">
                        ...
                        <div class="btn-group btn-group-sm">
                            @if($t->file_path)
                                <a href="/admin/privacy/templates/download?id={{ $t->id }}" class="btn btn-outline-success" title="Download">
