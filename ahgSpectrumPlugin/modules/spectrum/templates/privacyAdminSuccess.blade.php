...
<div class="row">
    ...
    <div class="col-md-6 col-lg-3 mb-4">
        <div class="card h-100">
            ...
            <div class="card-footer">
                <a href="/admin/privacy/ropa" class="btn btn-primary w-100">{{ __('Manage') }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-3 mb-4">
        <div class="card h-100">
            ...
            <div class="card-footer">
                <a href="/admin/privacy/dsar" class="btn btn-warning w-100">{{ __('Manage') }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-3 mb-4">
        <div class="card h-100">
            ...
            <div class="card-footer">
                <a href="/admin/privacy/breaches" class="btn btn-danger w-100">{{ __('Register') }}</a>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6 col-lg-3 mb-4">
        <div class="card h-100">
            ...
            <div class="card-footer">
                <a href="/admin/privacy/templates" class="btn btn-info w-100">{{ __('Library') }}</a>
            </div>
        </div>
    </div>
</div>
