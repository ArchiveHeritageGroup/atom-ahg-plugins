...
CREATE TABLE IF NOT EXISTS `spectrum_approval` (
  ...
  `status` VARCHAR(39) COMMENT 'pending, approved, rejected' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS `spectrum_loan_agreements` (
  ...
  `loan_type` VARCHAR(20) COMMENT 'in, out' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Type of loan',
