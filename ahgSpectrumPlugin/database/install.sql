...
CREATE TABLE IF NOT EXISTS `spectrum_condition_template_field` (
  ...
  `field_type` VARCHAR(86) COMMENT 'text, textarea, select, multiselect, checkbox, radio, rating, date, number' NOT NULL,
...
-- Dump completed on 2025-12-30 18:01:49
...
/*!40000 ALTER TABLE `spectrum_workflow_config` DISABLE KEYS */;
...
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (6,'object_entry','Object Entry Workflow','{\"steps\": [{\"key\": \"receive_object\", \"name\": \"Receive Object\", \"order\": 1}, {\"key\": \"document_receipt\", \"name\": \"Document Receipt\", \"order\": 2}, {\"key\": \"initial_assessment\", \"name\": \"Initial Assessment\", \"order\": 3}, {\"key\": \"process_entry\", \"name\": \"Process Entry\", \"order\": 4}, {\"key\": \"complete\", \"name\": \"Complete\", \"order\": 5}], \"states\": [\"pending\", \"received\", \"documented\", \"assessed\", \"processed\", \"completed\"], \"transitions\": {\"assess\": {\"to\": \"assessed\", \"from\": [\"documented\"]}, \"process\": {\"to\": \"processed\", \"from\": [\"assessed\"]}, \"receive\": {\"to\": \"received\", \"from\": [\"pending\"]}, \"complete\": {\"to\": \"completed\", \"from\": [\"processed\"]}, \"document\": {\"to\": \"documented\", \"from\": [\"received\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"completed\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:19:56','2025-12-09 13:19:56');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (7,'location_movement','Location & Movement Workflow','{\"steps\": [{\"key\": \"request_move\", \"name\": \"Request Move\", \"order\": 1}, {\"key\": \"approve\", \"name\": \"Approve\", \"order\": 2}, {\"key\": \"in_transit\", \"name\": \"In Transit\", \"order\": 3}, {\"key\": \"arrival\", \"name\": \"Arrival\", \"order\": 4}, {\"key\": \"verify_location\", \"name\": \"Verify Location\", \"order\": 5}], \"states\": [\"pending\", \"requested\", \"approved\", \"in_transit\", \"arrived\", \"verified\"], \"transitions\": {\"move\": {\"to\": \"in_transit\", \"from\": [\"approved\"]}, \"arrive\": {\"to\": \"arrived\", \"from\": [\"in_transit\"]}, \"verify\": {\"to\": \"verified\", \"from\": [\"arrived\"]}, \"approve\": {\"to\": \"approved\", \"from\": [\"requested\"]}, \"request\": {\"to\": \"requested\", \"from\": [\"pending\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"verified\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:19:56','2025-12-09 13:19:56');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (8,'inventory_control','Inventory Control Workflow','{\"steps\": [{\"key\": \"schedule_check\", \"name\": \"Schedule Check\", \"order\": 1}, {\"key\": \"start_inventory\", \"name\": \"Start Inventory\", \"order\": 2}, {\"key\": \"count_items\", \"name\": \"Count Items\", \"order\": 3}, {\"key\": \"reconcile\", \"name\": \"Reconcile\", \"order\": 4}, {\"key\": \"complete\", \"name\": \"Complete\", \"order\": 5}], \"states\": [\"pending\", \"scheduled\", \"in_progress\", \"counted\", \"reconciled\", \"completed\"], \"transitions\": {\"count\": {\"to\": \"counted\", \"from\": [\"in_progress\"]}, \"start\": {\"to\": \"in_progress\", \"from\": [\"scheduled\"]}, \"complete\": {\"to\": \"completed\", \"from\": [\"reconciled\"]}, \"schedule\": {\"to\": \"scheduled\", \"from\": [\"pending\"]}, \"reconcile\": {\"to\": \"reconciled\", \"from\": [\"counted\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"completed\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:19:56','2025-12-09 13:19:56');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (9,'conservation','Conservation Workflow','{\"steps\": [{\"key\": \"assessment\", \"name\": \"Assessment\", \"order\": 1}, {\"key\": \"treatment_proposal\", \"name\": \"Treatment Proposal\", \"order\": 2}, {\"key\": \"approval\", \"name\": \"Approval\", \"order\": 3}, {\"key\": \"treatment\", \"name\": \"Treatment\", \"order\": 4}, {\"key\": \"complete\", \"name\": \"Complete\", \"order\": 5}], \"states\": [\"pending\", \"assessed\", \"proposed\", \"approved\", \"in_treatment\", \"completed\"], \"transitions\": {\"treat\": {\"to\": \"in_treatment\", \"from\": [\"approved\"]}, \"assess\": {\"to\": \"assessed\", \"from\": [\"pending\"]}, \"approve\": {\"to\": \"approved\", \"from\": [\"proposed\"]}, \"propose\": {\"to\": \"proposed\", \"from\": [\"assessed\"]}, \"complete\": {\"to\": \"completed\", \"from\": [\"in_treatment\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"completed\"]}}, \"initial_state\": \"pending\", \"outcomes\": [{\"on_state\": \"completed\", \"handler\": \"conservation_record\", \"requires_evidence\": false}]}',1,1,NULL,'2025-12-09 13:19:56','2025-12-09 13:19:56');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (10,'valuation','Valuation Workflow','{\"steps\": [{\"key\": \"request_valuation\", \"name\": \"Request Valuation\", \"order\": 1}, {\"key\": \"appraisal\", \"name\": \"Appraisal\", \"order\": 2}, {\"key\": \"review\", \"name\": \"Review\", \"order\": 3}, {\"key\": \"approve\", \"name\": \"Approve\", \"order\": 4}], \"states\": [\"pending\", \"requested\", \"appraised\", \"reviewed\", \"approved\"], \"transitions\": {\"review\": {\"to\": \"reviewed\", \"from\": [\"appraised\"]}, \"approve\": {\"to\": \"approved\", \"from\": [\"reviewed\"]}, \"request\": {\"to\": \"requested\", \"from\": [\"pending\"]}, \"appraise\": {\"to\": \"appraised\", \"from\": [\"requested\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"approved\"]}}, \"initial_state\": \"pending\", \"outcomes\": [{\"on_state\": \"approved\", \"handler\": \"heritage_revaluation\", \"requires_evidence\": true}]}',1,1,NULL,'2025-12-09 13:19:56','2025-12-09 13:19:56');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (11,'insurance','Insurance Workflow','{\"steps\": [{\"key\": \"valuation\", \"name\": \"Valuation\", \"order\": 1}, {\"key\": \"get_quote\", \"name\": \"Get Quote\", \"order\": 2}, {\"key\": \"approve\", \"name\": \"Approve\", \"order\": 3}, {\"key\": \"coverage_active\", \"name\": \"Coverage Active\", \"order\": 4}], \"states\": [\"pending\", \"valued\", \"quoted\", \"approved\", \"covered\"], \"transitions\": {\"cover\": {\"to\": \"covered\", \"from\": [\"approved\"]}, \"quote\": {\"to\": \"quoted\", \"from\": [\"valued\"]}, \"value\": {\"to\": \"valued\", \"from\": [\"pending\"]}, \"approve\": {\"to\": \"approved\", \"from\": [\"quoted\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"covered\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:19:56','2025-12-09 13:19:56');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (12,'loss_damage','Loss & Damage Workflow','{\"steps\": [{\"key\": \"report_incident\", \"name\": \"Report Incident\", \"order\": 1}, {\"key\": \"investigation\", \"name\": \"Investigation\", \"order\": 2}, {\"key\": \"damage_assessment\", \"name\": \"Damage Assessment\", \"order\": 3}, {\"key\": \"resolution\", \"name\": \"Resolution\", \"order\": 4}], \"states\": [\"pending\", \"reported\", \"investigated\", \"assessed\", \"resolved\"], \"transitions\": {\"assess\": {\"to\": \"assessed\", \"from\": [\"investigated\"]}, \"report\": {\"to\": \"reported\", \"from\": [\"pending\"]}, \"resolve\": {\"to\": \"resolved\", \"from\": [\"assessed\"]}, \"investigate\": {\"to\": \"investigated\", \"from\": [\"reported\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"resolved\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:19:56','2025-12-09 13:19:56');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (13,'deaccession','Deaccession Workflow','{\"steps\": [{\"key\": \"proposal\", \"name\": \"Proposal\", \"order\": 1}, {\"key\": \"review\", \"name\": \"Review\", \"order\": 2}, {\"key\": \"board_approval\", \"name\": \"Board Approval\", \"order\": 3}, {\"key\": \"process\", \"name\": \"Process\", \"order\": 4}, {\"key\": \"complete\", \"name\": \"Complete\", \"order\": 5}], \"states\": [\"pending\", \"proposed\", \"reviewed\", \"approved\", \"processed\", \"completed\"], \"transitions\": {\"review\": {\"to\": \"reviewed\", \"from\": [\"proposed\"]}, \"approve\": {\"to\": \"approved\", \"from\": [\"reviewed\"]}, \"process\": {\"to\": \"processed\", \"from\": [\"approved\"]}, \"propose\": {\"to\": \"proposed\", \"from\": [\"pending\"]}, \"complete\": {\"to\": \"completed\", \"from\": [\"processed\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"completed\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:19:56','2025-12-09 13:19:56');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (14,'disposal','Disposal Workflow','{\"steps\": [{\"key\": \"approval\", \"name\": \"Approval\", \"order\": 1}, {\"key\": \"select_method\", \"name\": \"Select Method\", \"order\": 2}, {\"key\": \"disposal\", \"name\": \"Disposal\", \"order\": 3}, {\"key\": \"documentation\", \"name\": \"Documentation\", \"order\": 4}], \"states\": [\"pending\", \"approved\", \"method_selected\", \"disposed\", \"documented\"], \"transitions\": {\"approve\": {\"to\": \"approved\", \"from\": [\"pending\"]}, \"dispose\": {\"to\": \"disposed\", \"from\": [\"method_selected\"]}, \"document\": {\"to\": \"documented\", \"from\": [\"disposed\"]}, \"select_method\": {\"to\": \"method_selected\", \"from\": [\"approved\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"documented\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:19:56','2025-12-09 13:19:56');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (15,'object_exit','Object Exit Workflow','{\"steps\": [{\"key\": \"exit_request\", \"name\": \"Exit Request\", \"order\": 1}, {\"key\": \"approval\", \"name\": \"Approval\", \"order\": 2}, {\"key\": \"preparation\", \"name\": \"Preparation\", \"order\": 3}, {\"key\": \"dispatch\", \"name\": \"Dispatch\", \"order\": 4}, {\"key\": \"confirm_exit\", \"name\": \"Confirm Exit\", \"order\": 5}], \"states\": [\"pending\", \"requested\", \"approved\", \"prepared\", \"dispatched\", \"confirmed\"], \"transitions\": {\"approve\": {\"to\": \"approved\", \"from\": [\"requested\"]}, \"confirm\": {\"to\": \"confirmed\", \"from\": [\"dispatched\"]}, \"prepare\": {\"to\": \"prepared\", \"from\": [\"approved\"]}, \"request\": {\"to\": \"requested\", \"from\": [\"pending\"]}, \"dispatch\": {\"to\": \"dispatched\", \"from\": [\"prepared\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"confirmed\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:19:56','2025-12-09 13:19:56');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (16,'loans_in','Loans In Workflow','{\"steps\": [{\"key\": \"request\", \"name\": \"Request\", \"order\": 1}, {\"key\": \"facility_report\", \"name\": \"Facility Report\", \"order\": 2}, {\"key\": \"insurance\", \"name\": \"Insurance\", \"order\": 3}, {\"key\": \"condition_in\", \"name\": \"Condition In\", \"order\": 4}, {\"key\": \"installation\", \"name\": \"Installation\", \"order\": 5}, {\"key\": \"condition_out\", \"name\": \"Condition Out\", \"order\": 6}, {\"key\": \"return\", \"name\": \"Return\", \"order\": 7}], \"states\": [\"pending\", \"requested\", \"facility_report\", \"insurance\", \"condition_in\", \"installed\", \"condition_out\", \"returned\"], \"transitions\": {\"return\": {\"to\": \"returned\", \"from\": [\"condition_out\"]}, \"install\": {\"to\": \"installed\", \"from\": [\"condition_in\"]}, \"request\": {\"to\": \"requested\", \"from\": [\"pending\"]}, \"facility_report\": {\"to\": \"facility_report\", \"from\": [\"requested\"]}, \"arrange_insurance\": {\"to\": \"insurance\", \"from\": [\"facility_report\"]}, \"condition_check_in\": {\"to\": \"condition_in\", \"from\": [\"insurance\"]}, \"condition_check_out\": {\"to\": \"condition_out\", \"from\": [\"installed\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"returned\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:22:23','2025-12-09 13:22:23');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (17,'loans_out','Loans Out Workflow','{\"steps\": [{\"key\": \"request_received\", \"name\": \"Request Received\", \"order\": 1}, {\"key\": \"review\", \"name\": \"Review\", \"order\": 2}, {\"key\": \"facility_assessment\", \"name\": \"Facility Assessment\", \"order\": 3}, {\"key\": \"insurance\", \"name\": \"Insurance\", \"order\": 4}, {\"key\": \"condition_report\", \"name\": \"Condition Report\", \"order\": 5}, {\"key\": \"packing\", \"name\": \"Packing\", \"order\": 6}, {\"key\": \"dispatch\", \"name\": \"Dispatch\", \"order\": 7}, {\"key\": \"return\", \"name\": \"Return\", \"order\": 8}, {\"key\": \"final_condition\", \"name\": \"Final Condition\", \"order\": 9}], \"states\": [\"pending\", \"requested\", \"reviewed\", \"facility_assessed\", \"insurance\", \"condition_report\", \"packed\", \"dispatched\", \"returned\", \"condition_checked\"], \"transitions\": {\"pack\": {\"to\": \"packed\", \"from\": [\"condition_report\"]}, \"review\": {\"to\": \"reviewed\", \"from\": [\"requested\"]}, \"dispatch\": {\"to\": \"dispatched\", \"from\": [\"packed\"]}, \"receive_return\": {\"to\": \"returned\", \"from\": [\"dispatched\"]}, \"assess_facility\": {\"to\": \"facility_assessed\", \"from\": [\"reviewed\"]}, \"final_condition\": {\"to\": \"condition_checked\", \"from\": [\"returned\"]}, \"receive_request\": {\"to\": \"requested\", \"from\": [\"pending\"]}, \"condition_report\": {\"to\": \"condition_report\", \"from\": [\"insurance\"]}, \"arrange_insurance\": {\"to\": \"insurance\", \"from\": [\"facility_assessed\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"condition_checked\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:22:23','2025-12-09 13:22:23');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (18,'condition_checking','Condition Checking Workflow','{\"steps\": [{\"key\": \"schedule\", \"name\": \"Schedule\", \"order\": 1}, {\"key\": \"examine\", \"name\": \"Examine\", \"order\": 2}, {\"key\": \"document\", \"name\": \"Document\", \"order\": 3}, {\"key\": \"report\", \"name\": \"Report\", \"order\": 4}, {\"key\": \"review\", \"name\": \"Review\", \"order\": 5}], \"states\": [\"pending\", \"scheduled\", \"examining\", \"documenting\", \"reporting\", \"reviewed\"], \"transitions\": {\"report\": {\"to\": \"reporting\", \"from\": [\"documenting\"]}, \"review\": {\"to\": \"reviewed\", \"from\": [\"reporting\"]}, \"examine\": {\"to\": \"examining\", \"from\": [\"scheduled\"]}, \"document\": {\"to\": \"documenting\", \"from\": [\"examining\"]}, \"schedule\": {\"to\": \"scheduled\", \"from\": [\"pending\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"reviewed\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:22:23','2025-12-09 13:22:23');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (19,'risk_management','Risk Management Workflow','{\"steps\": [{\"key\": \"identify_risks\", \"name\": \"Identify Risks\", \"order\": 1}, {\"key\": \"assess\", \"name\": \"Assess\", \"order\": 2}, {\"key\": \"mitigate\", \"name\": \"Mitigate\", \"order\": 3}, {\"key\": \"monitor\", \"name\": \"Monitor\", \"order\": 4}], \"states\": [\"pending\", \"identified\", \"assessed\", \"mitigated\", \"monitored\"], \"transitions\": {\"assess\": {\"to\": \"assessed\", \"from\": [\"identified\"]}, \"monitor\": {\"to\": \"monitored\", \"from\": [\"mitigated\"]}, \"identify\": {\"to\": \"identified\", \"from\": [\"pending\"]}, \"mitigate\": {\"to\": \"mitigated\", \"from\": [\"assessed\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"monitored\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:48:46','2025-12-09 13:48:46');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (20,'audit','Audit Workflow','{\"steps\": [{\"key\": \"schedule\", \"name\": \"Schedule\", \"order\": 1}, {\"key\": \"in_progress\", \"name\": \"In Progress\", \"order\": 2}, {\"key\": \"findings\", \"name\": \"Findings\", \"order\": 3}, {\"key\": \"report\", \"name\": \"Report\", \"order\": 4}, {\"key\": \"close\", \"name\": \"Close\", \"order\": 5}], \"states\": [\"pending\", \"scheduled\", \"in_progress\", \"findings\", \"reported\", \"closed\"], \"transitions\": {\"close\": {\"to\": \"closed\", \"from\": [\"reported\"]}, \"start\": {\"to\": \"in_progress\", \"from\": [\"scheduled\"]}, \"report\": {\"to\": \"reported\", \"from\": [\"findings\"]}, \"findings\": {\"to\": \"findings\", \"from\": [\"in_progress\"]}, \"schedule\": {\"to\": \"scheduled\", \"from\": [\"pending\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"closed\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:48:46','2025-12-09 13:48:46');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (21,'rights_management','Rights Management Workflow','{\"steps\": [{\"key\": \"research\", \"name\": \"Research\", \"order\": 1}, {\"key\": \"document\", \"name\": \"Document\", \"order\": 2}, {\"key\": \"clear_rights\", \"name\": \"Clear Rights\", \"order\": 3}, {\"key\": \"monitor\", \"name\": \"Monitor\", \"order\": 4}], \"states\": [\"pending\", \"researched\", \"documented\", \"cleared\", \"monitored\"], \"transitions\": {\"clear\": {\"to\": \"cleared\", \"from\": [\"documented\"]}, \"monitor\": {\"to\": \"monitored\", \"from\": [\"cleared\"]}, \"document\": {\"to\": \"documented\", \"from\": [\"researched\"]}, \"research\": {\"to\": \"researched\", \"from\": [\"pending\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"monitored\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:48:46','2025-12-09 13:48:46');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (22,'reproduction','Reproduction Workflow','{\"steps\": [{\"key\": \"request\", \"name\": \"Request\", \"order\": 1}, {\"key\": \"rights_check\", \"name\": \"Rights Check\", \"order\": 2}, {\"key\": \"approval\", \"name\": \"Approval\", \"order\": 3}, {\"key\": \"production\", \"name\": \"Production\", \"order\": 4}, {\"key\": \"delivery\", \"name\": \"Delivery\", \"order\": 5}], \"states\": [\"pending\", \"requested\", \"rights_checked\", \"approved\", \"produced\", \"delivered\"], \"transitions\": {\"approve\": {\"to\": \"approved\", \"from\": [\"rights_checked\"]}, \"deliver\": {\"to\": \"delivered\", \"from\": [\"produced\"]}, \"produce\": {\"to\": \"produced\", \"from\": [\"approved\"]}, \"request\": {\"to\": \"requested\", \"from\": [\"pending\"]}, \"check_rights\": {\"to\": \"rights_checked\", \"from\": [\"requested\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"delivered\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:48:46','2025-12-09 13:48:46');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (23,'documentation_planning','Documentation Planning Workflow','{\"steps\": [{\"key\": \"plan\", \"name\": \"Plan\", \"order\": 1}, {\"key\": \"prioritize\", \"name\": \"Prioritize\", \"order\": 2}, {\"key\": \"in_progress\", \"name\": \"In Progress\", \"order\": 3}, {\"key\": \"complete\", \"name\": \"Complete\", \"order\": 4}, {\"key\": \"review\", \"name\": \"Review\", \"order\": 5}], \"states\": [\"pending\", \"planned\", \"prioritized\", \"in_progress\", \"completed\", \"reviewed\"], \"transitions\": {\"plan\": {\"to\": \"planned\", \"from\": [\"pending\"]}, \"start\": {\"to\": \"in_progress\", \"from\": [\"prioritized\"]}, \"review\": {\"to\": \"reviewed\", \"from\": [\"completed\"]}, \"complete\": {\"to\": \"completed\", \"from\": [\"in_progress\"]}, \"prioritize\": {\"to\": \"prioritized\", \"from\": [\"planned\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"reviewed\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:48:46','2025-12-09 13:48:46');
INSERT IGNORE INTO `spectrum_workflow_config` VALUES (24,'retrospective_documentation','Retrospective Documentation Workflow','{\"steps\": [{\"key\": \"identify_gaps\", \"name\": \"Identify Gaps\", \"order\": 1}, {\"key\": \"research\", \"name\": \"Research\", \"order\": 2}, {\"key\": \"document\", \"name\": \"Document\", \"order\": 3}, {\"key\": \"verify\", \"name\": \"Verify\", \"order\": 4}, {\"key\": \"complete\", \"name\": \"Complete\", \"order\": 5}], \"states\": [\"pending\", \"identified\", \"researched\", \"documented\", \"verified\", \"completed\"], \"transitions\": {\"verify\": {\"to\": \"verified\", \"from\": [\"documented\"]}, \"complete\": {\"to\": \"completed\", \"from\": [\"verified\"]}, \"document\": {\"to\": \"documented\", \"from\": [\"researched\"]}, \"identify\": {\"to\": \"identified\", \"from\": [\"pending\"]}, \"research\": {\"to\": \"researched\", \"from\": [\"identified\"]}, \"restart\": {\"to\": \"pending\", \"from\": [\"completed\"]}}, \"initial_state\": \"pending\"}',1,1,NULL,'2025-12-09 13:48:46','2025-12-09 13:48:46');
/*!40000 ALTER TABLE `spectrum_workflow_config` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- ---------------------------------------------------------------------------
-- Merged in from database/migration_workflow_step_state.sql on 2026-08-18.
--
