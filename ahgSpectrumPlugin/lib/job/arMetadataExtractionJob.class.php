...
class arMetadataExtractionJob extends arBaseJob
{
    // Term IDs
    ...
    protected function extractBulk($parameters)
    {
        ...
        foreach ($objects as $obj) {
            try {
                ...
                $extractor = new arUniversalMetadataExtractor($filePath, $obj->mime_type);
                $metadata = $extractor->extractAll();
    ...
    protected function processFaces($digitalObjectId, $filePath)
    {
        ...
        $faceService = new arFaceDetectionService($backend, $config);
