          ...
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="hidden" name="creators" id="creatorsValue" value="<?php echo htmlspecialchars($item->creators ?? '') ?>">
              ...
              <div class="col-md-6">
                ...
                <input type="hidden" name="subjects" id="subjectsValue" value="<?php echo htmlspecialchars($item->subjects ?? '') ?>">
              ...
              <div class="col-md-6">
                ...
                <input type="hidden" name="places" id="placesValue" value="<?php echo htmlspecialchars($item->places ?? '') ?>">
              ...
              <div class="col-md-6">
                ...
                <input type="hidden" name="genres" id="genresValue" value="<?php echo htmlspecialchars($item->genres ?? '') ?>">
...
(function() {
  ...
  // ─── TAG AUTOCOMPLETE ───────────────────────────────────────
  var acUrl = '<?php echo url_for(['module' => 'researcher', 'action' => 'apiAutocomplete']) ?>';
