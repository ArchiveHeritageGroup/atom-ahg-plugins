...
cd tmp-fetch && git sparse-checkout set ahgSAHRAPlugin && cd ..
mv tmp-fetch/ahgSAHRAPlugin ./ahgSAHRAPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgSAHRAPlugin/database/install.sql
