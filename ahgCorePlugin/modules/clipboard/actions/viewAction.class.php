...
/**
 * AHG stub for clipboard/view action.
 * Replaces apps/qubit/modules/clipboard/actions/viewAction.class.php.
 *
 * Elasticsearch-backed clipboard view with sorting and pagination.
 */
