        ...
        <table class="table table-hover table-sm mb-0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="<?php echo url_for(['module' => 'ahgAuditTrailPlugin', 'action' => 'view', 'uuid' => $log->uuid]) ?>"><?php echo htmlspecialchars(mb_substr($log->entity_title ?? '-', 0, 40)) ?></a></td>
            </tr>
            <?php endforeach; ?>
...
<div class="mt-4">
  ...
  <a href="<?php echo url_for(['module' => 'ahgAuditTrailPlugin', 'action' => 'statistics']) ?>" class="btn btn-outline-primary"><?php echo __('View Statistics') ?></a>
</div>
<?php end_slot() ?>