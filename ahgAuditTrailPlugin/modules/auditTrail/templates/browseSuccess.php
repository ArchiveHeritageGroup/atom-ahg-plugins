...
<section id="facets">
  <div class="sidebar-lowering">
    ...
    <form method="get" action="<?php echo url_for(['module' => 'auditTrail', 'action' => 'browse']) ?>">
      <div class="mb-3">
      ...
      <div class="d-grid gap-2">
        ...
        <a href="<?php echo url_for(['module' => 'auditTrail', 'action' => 'browse']) ?>" class="btn btn-outline-secondary btn-sm"><?php echo __('Clear') ?></a>
      </div>
    </form>
    <hr class="my-4">
...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <div class="btn-group btn-group-sm">
    <a href="<?php echo url_for(['module' => 'auditTrail', 'action' => 'export', 'format' => 'csv']) ?>" class="btn btn-outline-secondary"><?php echo __('Export CSV') ?></a>
    <a href="<?php echo url_for(['module' => 'auditTrail', 'action' => 'export', 'format' => 'json']) ?>" class="btn btn-outline-secondary"><?php echo __('Export JSON') ?></a>
  </div>
</div>
        ...
        <tr class="<?php echo $log->status !== 'success' ? 'table-warning' : '' ?>">
          ...
          <td class="text-end">
            <div class="btn-group btn-group-sm">
              ...
              <?php endif; ?>
              <a href="<?php echo url_for(['module' => 'auditTrail', 'action' => 'view', 'uuid' => $log->uuid]) ?>" class="btn btn-outline-primary" title="<?php echo __('View Details') ?>">
...
<nav><ul class="pagination pagination-sm justify-content-center">
  <?php if ($pagerRaw['current_page'] > 1): ?>
    <li class="page-item">
      <a class="page-link" href="<?php echo url_for(['module' => 'auditTrail', 'action' => 'browse', 'page' => $pagerRaw['current_page'] - 1]) ?>">&laquo;</a>
    </li>
  <?php endif; ?>
  ...
  <?php for ($i = max(1, $pagerRaw['current_page'] - 3); $i <= min($pagerRaw['last_page'], $pagerRaw['current_page'] + 3); $i++): ?>
    <li class="page-item <?php echo $i === $pagerRaw['current_page'] ? 'active' : '' ?>">
      <a class="page-link" href="<?php echo url_for(['module' => 'auditTrail', 'action' => 'browse', 'page' => $i]) ?>"><?php echo $i ?></a>
    </li>
  <?php endfor; ?>

  <?php if ($pagerRaw['current_page'] < $pagerRaw['last_page']): ?>
    <li class="page-item">
      <a class="page-link" href="<?php echo url_for(['module' => 'auditTrail', 'action' => 'browse', 'page' => $pagerRaw['current_page'] + 1]) ?>">&raquo;</a>
    </li>
  <?php endif; ?>
</ul></nav>
<?php endif; ?>
