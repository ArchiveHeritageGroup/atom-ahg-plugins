-- ahgNARSSAPlugin — South African National Archives transfer tracking
...
CREATE TABLE IF NOT EXISTS narssa_transfer (
    ...
    narssa_receipt_reference VARCHAR(255) NULL COMMENT 'Reference number issued by NARSSA on acceptance',
    notes                    TEXT NULL,
