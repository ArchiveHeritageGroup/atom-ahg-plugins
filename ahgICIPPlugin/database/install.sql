...
INSERT INTO icip_cultural_notice_type (code, name, description, default_text, severity, requires_acknowledgement, display_order) VALUES
...
INSERT INTO icip_tk_label_type (code, category, name, description, local_contexts_url, display_order) VALUES
...
CREATE TABLE IF NOT EXISTS icip_tk_label (
    ...
    applied_by ENUM('community', 'institution') NOT NULL DEFAULT 'institution',
...
CREATE TABLE IF NOT EXISTS icip_consultation (
    ...
    consultation_method ENUM('in_person', 'phone', 'video', 'email', 'letter', 'other') NOT NULL,
    ...
    status ENUM('scheduled', 'completed', 'cancelled', 'follow_up_required') NOT NULL DEFAULT 'completed',
    created_by INT,
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    INDEX idx_object (information_object_id),
...
INSERT INTO icip_config (config_key, config_value, description) VALUES
