...
<div class="container-xxl">
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url_for('@icip_notices') }}">Cultural Notices</a></li>
                                ...
                                @foreach ($noticeTypes as $type)
                                    <tr class="{{ !$type->is_active ? 'table-secondary' : '' }}">
                                        ...
                                        <td>
                                            ...
                                            @endphp
                                            <span class="badge {{ $severityClass }}">{{ ucfirst($type->severity) }}</span>
                                        </td>
                                        <td>
