                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="alternate_names" class="form-control" value="{{ $community && $community->alternate_names ? implode(', ', json_decode($community->alternate_names, true) ?? []) : '' }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="state_territory" class="form-select" required>
                                ...
                                @foreach ($states as $code => $name)
                                    <option value="{{ $code }}" {{ ($community->state_territory ?? '') === $code ? 'selected' : '' }}>
                                        {{ $name }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-check form-switch">
                            <input type="checkbox" name="is_active" value="1" class="form-check-input" id="isActive" {{ ($community->is_active ?? 1) ? 'checked' : '' }}>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url_for('@icip_communities') }}" class="btn btn-outline-secondary w-100">
                            Cancel
                        </a>
                    </div>
                </div>
                ...
                @if ($id)
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="{{ url_for('@icip_community_view?id=' . $id) }}" class="btn btn-outline-primary btn-sm w-100">
