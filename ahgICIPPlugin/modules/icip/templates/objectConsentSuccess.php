                                ...
                                <tbody>
                                    <?php foreach ($consents as $consent): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo url_for('@icip_consent_edit?id=' . $consent->id) ?>" class="btn btn-sm btn-outline-primary">
                                ...
                                <?php foreach ($scopeOptions as $value => $label): ?>
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input type="checkbox" name="consent_scope[]" value="<?php echo $value ?>" class="form-check-input" id="scope_<?php echo $value ?>">
