<div class="container-xxl">
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo url_for('@icip_notices') ?>">Cultural Notices</a></li>
    ...
    <div class="row">
        <div class="col-lg-8">
                                ...
                                <?php foreach ($noticeTypes as $type): ?>
                                    <tr class="<?php echo !$type->is_active ? 'table-secondary' : '' ?>">
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <span class="badge <?php echo $severityClass ?>"><?php echo ucfirst($type->severity) ?></span>
                                        </td>
                                        <td>
                                            <?php if ($type->requires_acknowledgement): ?>
                                                <span class="badge bg-secondary" title="Requires Acknowledgement">ACK</span>
                                            <?php endif ?>
                                            <?php if ($type->blocks_access): ?>
                                                <span class="badge bg-dark" title="Blocks Access">BLOCK</span>
                                            <?php endif ?>
                                            <?php if ($type->display_public): ?>
                                                <span class="badge bg-light text-dark" title="Shown to Public">PUB</span>
                                            <?php endif ?>
                                        </td>
                                        <td>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Add Notice Type</h5>
                </div>
                <div class="card-body">
                    <form method="post">
