    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
        <div>
            <h1>
                ...
                Consultation with {{ $consultation->community_name }}
            </h1>
        ...
        <a href="{{ url_for('@icip_consultation_edit?id=' . $id) }}" class="btn btn-primary">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row">
                        @if ($consultation->community_representatives)
                            <div class="col-md-6 mb-3">
                                <h6>Community Representatives</h6>
                                <p class="mb-0">{!! nl2br(e($consultation->community_representatives)) !!}</p>
                            </div>
                        @endif

                        @if ($consultation->institution_representatives)
                            <div class="col-md-6 mb-3">
                                <h6>Institution Representatives</h6>
                                <p class="mb-0">{!! nl2br(e($consultation->institution_representatives)) !!}</p>
                            </div>
                        @endif
                        ...
                        @if ($consultation->attendees)
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0">{!! nl2br(e($consultation->attendees)) !!}</p>
                            </div>
                        @endif
                    </div>

                    @if (!$consultation->community_representatives && !$consultation->institution_representatives && !$consultation->attendees)
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        @if ($consultation->follow_up_date)
                            ...
                            <p class="mb-2">
                                ...
                                <span class="{{ $isOverdue ? 'text-danger fw-bold' : '' }}">
                                    {{ date('j F Y', strtotime($consultation->follow_up_date)) }}
                                    @if ($isOverdue)
                        ...
                        @if ($consultation->follow_up_notes)
                            <h6>Notes</h6>
                            {!! nl2br(e($consultation->follow_up_notes)) !!}
                        @endif
                    </div>
                </div>
            @endif
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <dl class="mb-0">
                        <dt>Community</dt>
                        <dd>
                            <a href="{{ url_for('@icip_community_view?id=' . $consultation->community_id) }}">
                                {{ $consultation->community_name }}
                            </a>
                        </dd>

                        <dt>Type</dt>
                        <dd>{{ ucwords(str_replace('_', ' ', $consultation->consultation_type)) }}</dd>
                        ...
                        @if ($consultation->is_confidential)
            ...
            @if ($consultation->object_title)
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <a href="{{ url_for('@icip_object?slug=' . $consultation->slug) }}">
                            <i class="bi bi-archive me-2"></i>
                            {{ $consultation->object_title }}
                        </a>
                    </div>
                </div>
            @endif
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <a href="{{ url_for('@icip_consultation_add') }}?community_id={{ $consultation->community_id }}" class="btn btn-outline-primary w-100 mb-2">
                        <i class="bi bi-plus-circle me-1"></i> Log Follow-up
                    </a>
                    <a href="{{ url_for('@icip_community_view?id=' . $consultation->community_id) }}" class="btn btn-outline-secondary w-100">
            ...
            <div class="card">
                <div class="card-body small text-muted">
                    <p class="mb-1">
                        ...
                        {{ $consultation->created_at ? date('j M Y H:i', strtotime($consultation->created_at)) : '-' }}
                    </p>
                    <p class="mb-0">
                        <strong>Last Updated:</strong>
                        {{ $consultation->updated_at ? date('j M Y H:i', strtotime($consultation->updated_at)) : '-' }}
                    </p>
                </div>
            </div>
        </div>
