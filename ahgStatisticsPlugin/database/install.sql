...
CREATE TABLE IF NOT EXISTS `ahg_usage_event` (
    ...
    `event_type` ENUM('view', 'download', 'search', 'login', 'api') NOT NULL DEFAULT 'view',
...
CREATE TABLE IF NOT EXISTS `ahg_bot_list` (
    ...
    `category` ENUM('search_engine', 'social', 'monitoring', 'crawler', 'spam', 'other') NOT NULL DEFAULT 'crawler',
