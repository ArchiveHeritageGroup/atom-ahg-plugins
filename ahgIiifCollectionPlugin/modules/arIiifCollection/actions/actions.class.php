 ...
 */
class arIiifCollectionActions extends sfActions
{
    ...
    public function executeCreate(sfWebRequest $request)
    {
        ...
        if (!$request->isMethod('post')) {
            $this->redirect(['module' => 'arIiifCollection', 'action' => 'new']);
        }
        ...
        $this->redirect(['module' => 'arIiifCollection', 'action' => 'view', 'id' => $id]);
    }
    ...
    public function executeUpdate(sfWebRequest $request)
    {
        ...
        if (!$request->isMethod('post')) {
            $this->redirect(['module' => 'arIiifCollection', 'action' => 'index']);
        }
    ...
    public function executeDelete(sfWebRequest $request)
    {
        ...
        if ($parentId) {
            $this->redirect(['module' => 'arIiifCollection', 'action' => 'view', 'id' => $parentId]);
        }
        $this->redirect(['module' => 'arIiifCollection', 'action' => 'index']);
    }
    ...
    public function executeRemoveItem(sfWebRequest $request)
    {
        ...
        $this->redirect(['module' => 'arIiifCollection', 'action' => 'view', 'id' => $collectionId]);
    }
