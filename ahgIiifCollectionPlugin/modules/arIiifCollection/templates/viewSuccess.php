...
<div class="sidebar-content">
    <div class="card mb-3">
        ...
        <div class="card-body">
            <a href="<?php echo '/index.php/arIiifCollection/manifest?slug=' . $collection->slug ?>" class="btn btn-info w-100 mb-2" target="_blank">
                <i class="fas fa-code me-2"></i><?php echo __('View IIIF JSON') ?>
            </a>
            <?php if ($sf_user->isAuthenticated()): ?>
            <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'addItems', 'id' => $collection->id]) ?>" class="btn btn-success w-100 mb-2">
                <i class="fas fa-plus me-2"></i><?php echo __('Add Items') ?>
            </a>
            <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'edit', 'id' => $collection->id]) ?>" class="btn btn-warning w-100 mb-2">
                <i class="fas fa-edit me-2"></i><?php echo __('Edit Collection') ?>
            </a>
            <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'new', 'parent_id' => $collection->id]) ?>" class="btn btn-outline-success w-100 mb-2">
                <i class="fas fa-folder-plus me-2"></i><?php echo __('Create Subcollection') ?>
            </a>
            <hr>
            <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'delete', 'id' => $collection->id]) ?>" class="btn btn-danger w-100" onclick="return confirm('<?php echo __('Are you sure you want to delete this collection?') ?>')">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <dl class="mb-0">
                ...
                <dd><small><code><?php echo url_for(['module' => 'arIiifCollection', 'action' => 'manifest', 'slug' => $collection->slug], true) ?></code></small></dd>
            </dl>
        </div>
    </div>
</div>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb mb-2">
        <li class="breadcrumb-item"><a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'index']) ?>"><?php echo __('Collections') ?></a></li>
        <?php foreach ($breadcrumbs as $bc): ?>
            <?php if ($bc->id === $collection->id): ?>
            <li class="breadcrumb-item active"><?php echo esc_entities($bc->display_name) ?></li>
            <?php else: ?>
            <li class="breadcrumb-item"><a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'view', 'id' => $bc->id]) ?>"><?php echo esc_entities($bc->display_name) ?></a></li>
            <?php endif ?>
        <?php endforeach ?>
    </ol>
</nav>
            ...
            <div class="row row-cols-1 row-cols-md-3 g-3">
                ...
                <div class="col">
                    <div class="card h-100">
                        <div class="card-body">
                            <h6 class="card-title">
                                <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'view', 'id' => $sub->id]) ?>">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="alert alert-info mb-0">
                ...
                <?php if ($sf_user->isAuthenticated()): ?>
                <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'addItems', 'id' => $collection->id]) ?>"><?php echo __('Add items') ?></a>
                <?php endif ?>
            </div>
            <?php else: ?>
                    ...
                    <tbody class="sortable-items">
                        ...
                        <tr data-item-id="<?php echo $item->id ?>" class="<?php echo $rowClass ?>">
                            ...
                            <td>
                                ...
                                <?php endif ?>
                                <?php if ($sf_user->isAuthenticated()): ?>
                                <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'removeItem', 'item_id' => $item->id, 'collection_id' => $collection->id]) ?>"
    ...
    if (tbody) {
        new Sortable(tbody, {
            ...
            onEnd: function(evt) {
                ...
                fetch('<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'reorder']) ?>', {
                    method: 'POST',
