...
<div class="iiif-collection-form">
    <form method="post" action="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'create']) ?>">
        <div class="card mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'index']) ?>" class="btn btn-outline-secondary">
