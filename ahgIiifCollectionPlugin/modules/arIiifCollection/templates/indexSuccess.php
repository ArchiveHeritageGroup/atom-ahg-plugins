...
<div class="sidebar-content">
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'new', 'parent_id' => $parentId]) ?>" class="btn btn-success w-100">
...
<div class="iiif-collections">
    ...
    <div class="alert alert-info">
        ...
        <?php if ($sf_user->isAuthenticated()): ?>
        <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'new']) ?>"><?php echo __('Create your first collection') ?></a>
        <?php endif ?>
    </div>
    <?php else: ?>
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
        ...
        <div class="col">
            <div class="card h-100 collection-card">
                ...
                <div class="card-body">
                    <h5 class="card-title">
                        <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'view', 'id' => $collection->id]) ?>">
                ...
                <div class="card-footer bg-transparent d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group btn-group-sm">
                        <a href="<?php echo '/index.php/arIiifCollection/manifest?slug=' . $collection->slug ?>" class="btn btn-outline-info" title="<?php echo __('IIIF Manifest') ?>" target="_blank">
                            <i class="fas fa-code"></i>
                        </a>
                        <?php if ($sf_user->isAuthenticated()): ?>
                        <a href="<?php echo url_for(['module' => 'arIiifCollection', 'action' => 'edit', 'id' => $collection->id]) ?>" class="btn btn-outline-primary" title="<?php echo __('Edit') ?>">
