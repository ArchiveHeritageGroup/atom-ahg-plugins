...
<div class="sidebar-content">
    <div class="card">
        ...
        <div class="card-body">
            <a href="<?php echo url_for(['module' => 'ahgIiifCollection', 'action' => 'view', 'id' => $collection->id]) ?>" class="btn btn-outline-primary w-100 mb-2">
                <i class="fas fa-eye me-2"></i><?php echo __('View Collection') ?>
            </a>
            <a href="<?php echo url_for(['module' => 'ahgIiifCollection', 'action' => 'addItems', 'id' => $collection->id]) ?>" class="btn btn-outline-success w-100">
...
<div class="iiif-collection-form">
    <form method="post" action="<?php echo url_for(['module' => 'ahgIiifCollection', 'action' => 'update', 'id' => $collection->id]) ?>">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="<?php echo url_for(['module' => 'ahgIiifCollection', 'action' => 'view', 'id' => $collection->id]) ?>" class="btn btn-outline-secondary">
