...
CREATE TABLE IF NOT EXISTS `donor_agreement` (
  ...
  `status` VARCHAR(93) COMMENT 'draft, pending_review, pending_signature, active, expired, terminated, superseded' COLLATE utf8mb4_unicode_ci DEFAULT 'draft',
...
CREATE TABLE IF NOT EXISTS `donor_agreement_reminder` (
  ...
  `reminder_type` VARCHAR(152) COMMENT 'expiry_warning, review_due, renewal_required, restriction_ending, payment_due, donor_contact, anniversary, audit, preservation_check, custom' COLLATE utf8mb4_unicode_ci NOT NULL,
  `subject` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `reminder_date` date NOT NULL,
  `advance_days` int DEFAULT '30',
  `is_recurring` tinyint(1) DEFAULT '0',
  `recurrence_pattern` VARCHAR(53) COMMENT 'daily, weekly, monthly, quarterly, yearly' COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `recurrence_end_date` date DEFAULT NULL,
  `priority` VARCHAR(37) COMMENT 'low, normal, high, urgent' COLLATE utf8mb4_unicode_ci DEFAULT 'normal',
  `notify_email` tinyint(1) DEFAULT '1',
  `notify_system` tinyint(1) DEFAULT '1',
  `notification_recipients` text COLLATE utf8mb4_unicode_ci,
  `status` VARCHAR(49) COMMENT 'active, snoozed, completed, cancelled' COLLATE utf8mb4_unicode_ci DEFAULT 'active',
...
CREATE TABLE IF NOT EXISTS `donor_agreement_right` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `donor_agreement_id` int NOT NULL,
  `right_type` VARCHAR(163) COMMENT 'replicate, migrate, modify, use, disseminate, delete, display, publish, digitize, reproduce, loan, exhibit, broadcast, commercial_use, derivative_works' COLLATE utf8mb4_unicode_ci NOT NULL,
  `permission` VARCHAR(56) COMMENT 'granted, restricted, prohibited, conditional' COLLATE utf8mb4_unicode_ci NOT NULL,
  `conditions` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `donor_agreement_restriction` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `donor_agreement_id` int NOT NULL,
  `restriction_type` VARCHAR(237) COMMENT 'closure, partial_closure, redaction, permission_only, researcher_only, onsite_only, no_copying, no_publication, anonymization, time_embargo, review_required, security_clearance, popia_restricted, legal_hold, cultural_protocol' COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `popia_category` VARCHAR(69) COMMENT 'special_personal, personal, children, criminal, biometric' COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `donor_agreement_record` (
  ...
  `relationship_type` VARCHAR(48) COMMENT 'covers, partially_covers, references' COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'covers',
  `notes` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `donor_agreement_history` (
  `id` int NOT NULL AUTO_INCREMENT,
  `agreement_id` int NOT NULL,
  `action` VARCHAR(168) COMMENT 'created, updated, status_changed, approved, renewed, terminated, document_added, document_removed, record_linked, record_unlinked, reminder_sent, note_added' COLLATE utf8mb4_unicode_ci NOT NULL,
