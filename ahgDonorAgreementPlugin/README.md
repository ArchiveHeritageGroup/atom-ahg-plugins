...
Donor Agreement Management with contract uploads, reminders, and rights tracking

| | |
|---|---|
| Machine name | `ahgDonorAgreementPlugin` |
| Version | 1.3.7 |
| Category | rights |
...
cd tmp-fetch && git sparse-checkout set ahgDonorAgreementPlugin && cd ..
mv tmp-fetch/ahgDonorAgreementPlugin ./ahgDonorAgreementPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgDonorAgreementPlugin/database/install.sql
