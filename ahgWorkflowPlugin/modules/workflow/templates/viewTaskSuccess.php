...
<div class="container-fluid px-4 py-3" id="main-content">
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Task #<?php echo $task->id ?></li>
        </ol>
    </nav>
        ...
        <div class="col-lg-8">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    ?> fs-6" role="status" aria-label="<?php echo __('Status: %1%', ['%1%' => ucfirst($task->status)]) ?>"><?php echo ucfirst($task->status) ?></span>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
                        <div class="col-md-6">
                    ...
                    <?php if ($task->instructions): ?>
                        <div class="alert alert-info" role="alert">
                            <h6 class="alert-heading"><i class="fas fa-info-circle me-1" aria-hidden="true"></i>Instructions</h6>
                    ...
                    <?php if ($task->checklist): ?>
                        ...
                        <div class="card bg-light mb-3">
                            <div class="card-header">
                                <h6 class="mb-0"><i class="fas fa-tasks me-1" aria-hidden="true"></i>Review Checklist</h6>
                            </div>
                            <div class="card-body">
                    ...
                    <div class="card-footer">
                        <form method="post" class="d-inline" id="taskForm">
                            ...
                            <a href="<?php echo url_for(['module' => 'workflow', 'action' => 'releaseTask', 'id' => $task->id]) ?>" class="btn btn-outline-secondary btn-lg ms-2">
                                <i class="fas fa-undo me-1" aria-hidden="true"></i>Release
                            </a>
                        </form>
                    </div>
