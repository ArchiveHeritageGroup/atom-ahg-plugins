...
<div class="container-fluid px-4 py-3" id="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0"><i class="fas fa-layer-group me-2" aria-hidden="true"></i>Task Pool</h1>
    ...
    <?php if (empty($tasks)): ?>
        <div class="text-center text-muted py-5">
            <i class="fas fa-check-double fa-4x mb-3 opacity-50" aria-hidden="true"></i>
                        ...
                        <div class="card-footer bg-transparent">
                            <div class="d-grid gap-2">
                                <a href="<?php echo url_for(['module' => 'workflow', 'action' => 'claimTask', 'id' => $task->id]) ?>" class="btn btn-primary">
                                    <i class="fas fa-hand-paper me-1" aria-hidden="true"></i>Claim Task
                                </a>
