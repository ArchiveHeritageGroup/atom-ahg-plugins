...
Place a flat 2D archival image into augmented reality (WebXR hit-test). #147, parity with Heratio ahg-image-ar.
...
cd tmp-fetch && git sparse-checkout set ahgImageArPlugin && cd ..
mv tmp-fetch/ahgImageArPlugin ./ahgImageArPlugin && rm -rf tmp-fetch
