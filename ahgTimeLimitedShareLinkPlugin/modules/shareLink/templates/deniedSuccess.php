<?php
/** @var \AhgShareLink\Services\AccessResult $result */
/** @var ?string $reason */
?>
<!doctype html>
<html lang="en">
...
<div class="sl-card">
    ...
    <p><?php echo esc_entities($reason ?? 'This share link is no longer valid.') ?></p>
    <div class="sl-status">HTTP 410 · <?php echo esc_entities($result->action) ?></div>
</div>
</body>
</html>
