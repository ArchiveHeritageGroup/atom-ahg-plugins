...
MODS (Metadata Object Description Schema) descriptive standard edit form for information objects
...
cd tmp-fetch && git sparse-checkout set ahgModsManagePlugin && cd ..
mv tmp-fetch/ahgModsManagePlugin ./ahgModsManagePlugin && rm -rf tmp-fetch
