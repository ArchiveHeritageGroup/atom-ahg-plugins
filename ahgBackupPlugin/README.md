...
cd tmp-fetch && git sparse-checkout set ahgBackupPlugin && cd ..
mv tmp-fetch/ahgBackupPlugin ./ahgBackupPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgBackupPlugin/database/install.sql
