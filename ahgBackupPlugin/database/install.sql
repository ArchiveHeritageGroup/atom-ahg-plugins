...
CREATE TABLE IF NOT EXISTS `backup_history` (
  ...
  `backup_type` VARCHAR(46) COMMENT 'full, database, files, incremental' DEFAULT 'full',
  `status` VARCHAR(51) COMMENT 'pending, in_progress, completed, failed' DEFAULT 'pending',
...
CREATE TABLE IF NOT EXISTS `backup_schedule` (
  ...
  `frequency` VARCHAR(42) COMMENT 'hourly, daily, weekly, monthly' DEFAULT 'daily',
