        ...
        <div class="card h-100 shadow-sm">
          ...
          <div class="card-body">
            <h6 class="card-title text-truncate">
              <a href="<?php echo url_for(['module' => 'ahgGalleryPlugin', 'action' => 'index', 'slug' => $item->slug]); ?>" class="text-decoration-none">
    ...
    <nav class="mt-4">
      <ul class="pagination justify-content-center">
        <?php if ($currentPage > 1): ?>
          <li class="page-item">
            <a class="page-link" href="<?php echo url_for(['module' => 'ahgGalleryPlugin', 'action' => 'browse', 'page' => $currentPage - 1]); ?>">
        ...
        <?php for ($i = max(1, $currentPage - 2); $i <= min($totalPages, $currentPage + 2); $i++): ?>
          <li class="page-item <?php echo $i == $currentPage ? 'active' : ''; ?>">
            <a class="page-link" href="<?php echo url_for(['module' => 'ahgGalleryPlugin', 'action' => 'browse', 'page' => $i]); ?>">
              <?php echo $i; ?>
            </a>
          </li>
        <?php endfor; ?>
