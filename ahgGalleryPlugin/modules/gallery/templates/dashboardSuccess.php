  ...
  <div class="row">
    <div class="col-md-4">
      <div class="card mb-4">
        ...
        <div class="card-body">
          <a href="<?php echo url_for(['module' => 'gallery', 'action' => 'add']); ?>" class="btn btn-primary w-100 mb-2">
            ...
            <table class="table table-hover mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo url_for(['module' => 'gallery', 'action' => 'edit', 'slug' => $item->slug]); ?>" class="btn btn-sm btn-outline-primary">
