      ...
      new TomSelect(input, {
        ...
        render: {
          option: function(item, escape) {
            ...
            if (item.scopeNote) { html += '<div class="text-muted small" style="max-width:350px;white-space:normal;">' + escape(item.scopeNote.substring(0, 80)) + (item.scopeNote.length > 80 ? '...' : '') + '</div>'; }
            html += '</div>';
            return html;
          },
