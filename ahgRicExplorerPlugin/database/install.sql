...
CREATE TABLE IF NOT EXISTS `ric_orphan_tracking` (
  ...
  `detection_method` VARCHAR(49) COMMENT 'integrity_check, sync_failure, manual' COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` VARCHAR(59) COMMENT 'detected, reviewed, cleaned, retained, restored' COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'detected',
...
CREATE TABLE IF NOT EXISTS `ric_sync_log` (
  ...
  `operation` VARCHAR(74) COMMENT 'create, update, delete, move, resync, cleanup, integrity_check' COLLATE utf8mb4_unicode_ci NOT NULL,
  `entity_type` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `entity_id` int DEFAULT NULL,
  `ric_uri` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` VARCHAR(46) COMMENT 'success, failure, partial, skipped' COLLATE utf8mb4_unicode_ci NOT NULL,
  `triples_affected` int DEFAULT NULL,
  `details` json DEFAULT NULL,
  `error_message` text COLLATE utf8mb4_unicode_ci,
  `execution_time_ms` int DEFAULT NULL,
  `triggered_by` VARCHAR(40) COMMENT 'user, system, cron, api, cli' COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'system',
...
CREATE TABLE IF NOT EXISTS `ric_sync_queue` (
  ...
  `operation` VARCHAR(40) COMMENT 'create, update, delete, move' COLLATE utf8mb4_unicode_ci NOT NULL,
  `priority` tinyint NOT NULL DEFAULT '5',
  `status` VARCHAR(60) COMMENT 'queued, processing, completed, failed, cancelled' COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'queued',
...
CREATE TABLE IF NOT EXISTS `ric_sync_status` (
  ...
  `ric_uri` varchar(500) COLLATE utf8mb4_unicode_ci NOT NULL,
  `ric_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sync_status` VARCHAR(54) COMMENT 'synced, pending, failed, deleted, orphaned' COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
-- ============================================================
-- SHACL validation (parity) (registered for fresh installs)
-- ============================================================
-- =============================================================================
...
-- ---------------------------------------------------------------------------
-- Merged in from database/shacl_install.sql on 2026-08-18.
--
