# AtoM Heratio — Custom Fields Framework
...
### Import / Export
Field definitions can be exported as JSON and imported into another AtoM Heratio instance, enabling easy migration and standardization across deployments.
