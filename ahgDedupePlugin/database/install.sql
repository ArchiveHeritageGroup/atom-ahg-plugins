...
CREATE TABLE IF NOT EXISTS ahg_duplicate_rule (
    ...
    rule_type ENUM('title_similarity', 'identifier_exact', 'identifier_fuzzy', 'date_creator', 'checksum', 'combined', 'custom') NOT NULL,
...
INSERT INTO ahg_duplicate_rule (name, rule_type, threshold, config_json, is_enabled, is_blocking, priority) VALUES
