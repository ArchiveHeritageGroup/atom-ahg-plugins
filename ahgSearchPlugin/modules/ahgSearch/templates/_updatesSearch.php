  ...
  <div class="accordion-item">
    ...
    <div id="collapse-adv-search" class="accordion-collapse collapse<?php echo $show ? ' show' : ''; ?>" aria-labelledby="heading-adv-search">
      <div class="accordion-body">
        <?php echo $form->renderFormTag(url_for(['module' => 'ahgSearch', 'action' => 'descriptionUpdates']), ['name' => 'advanced-search-form', 'method' => 'get']); ?>
          ...
          <div class="criteria row mb-2">
            ...
            <?php if (sfConfig::get('app_audit_log_enabled', false)) { ?>
              <div class="col-md-6">
                ...
                <?php if (isset($user)) { ?>
                  <div class="form-text">
                    <?php echo __('Currently displaying:'); ?> <?php echo $user->getUsername(); ?>
                  </div>
                <?php } ?>
              </div>
            <?php } ?>
