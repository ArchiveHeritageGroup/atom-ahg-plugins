...
<?php slot('content'); ?>
  <?php echo get_partial('ahgSearch/updatesSearch', [
      'form' => $form,
      'show' => $showForm,
  ...
  <div class="table-responsive mb-3">
    ...
    <?php } elseif (isset($pager) && $pager->getNbResults()) { ?>
      ...
      <table class="table table-bordered mb-0">
        ...
        <tbody>
          <?php foreach ($pager->getResults() as $result) { ?>
            <?php $doc = isset($result['_source']) ? $result['_source'] : (is_object($result) && method_exists($result, 'getData') ? $result->getData() : $result); ?>
            <tr>
              <td>
