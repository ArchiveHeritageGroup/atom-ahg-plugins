# Zimbabwe NAZ Compliance

Zimbabwe National Archives Act [Chapter 25:06] compliance — 25-year closure rule, researcher permits, records schedules, transfers, and protected records management
...
cd tmp-fetch && git sparse-checkout set ahgNAZPlugin && cd ..
mv tmp-fetch/ahgNAZPlugin ./ahgNAZPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgNAZPlugin/database/install.sql
