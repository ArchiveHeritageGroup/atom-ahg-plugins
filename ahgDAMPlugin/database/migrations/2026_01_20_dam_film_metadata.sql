...
CREATE TABLE IF NOT EXISTS dam_format_holdings (
    ...
    format_type VARCHAR(188) COMMENT '35mm, 16mm, 8mm, Super8, VHS, Betacam, U-matic, DV, DVD, Blu-ray, LaserDisc, Digital_File, DCP, ProRes, Nitrate, Safety, Polyester, Audio_Reel, Audio_Cassette, Vinyl, CD, Other' NOT NULL,
...
CREATE TABLE IF NOT EXISTS dam_external_links (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    object_id INT NOT NULL COMMENT 'information_object.id',
    link_type VARCHAR(166) COMMENT 'ESAT, IMDb, SAFILM, NFVSA, Wikipedia, Wikidata, VIAF, YouTube, Vimeo, Archive_org, BFI, AFI, Letterboxd, MUBI, Filmography, Review, Academic, Press, Other' NOT NULL,
