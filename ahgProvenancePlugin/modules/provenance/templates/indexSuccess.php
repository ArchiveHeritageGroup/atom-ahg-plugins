...
<div class="container-fluid py-3">
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <div>
      <h4 class="mb-1"><i class="fas fa-clock-rotate-left me-2"></i>Provenance Management</h4>
      ...
      <div class="card bg-primary text-white h-100">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <i class="fas fa-layer-group fs-1 opacity-50"></i>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card bg-info text-white h-100">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <i class="fas fa-shield-halved fs-1 opacity-50"></i>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-header">
          <h6 class="mb-0"><i class="fas fa-chart-pie me-2"></i>By Acquisition Type</h6>
        </div>
        <div class="card-body">
    ...
    <div class="col-md-6">
      <div class="card mb-4">
        <div class="card-header">
          <h6 class="mb-0"><i class="fas fa-gauge me-2"></i>By Certainty Level</h6>
        </div>
        <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="d-grid">
            <a href="<?php echo url_for(['module' => 'informationobject', 'action' => 'browse']) ?>" class="btn btn-outline-primary">
              <i class="fas fa-magnifying-glass me-2"></i>Browse Records to Add Provenance
            </a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="d-grid">
            <a href="#" class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#incompleteModal">
              <i class="fas fa-circle-exclamation me-2"></i>View Incomplete (<?php echo $stats['incomplete'] ?>)
            </a>
          </div>
        </div>
        <div class="col-md-4">
          <div class="d-grid">
            <a href="#" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#naziEraModal">
              <i class="fas fa-shield me-2"></i>Nazi-Era Unchecked (<?php echo $stats['nazi_era_unchecked'] ?>)
            </a>
          </div>
        </div>
      </div>
  ...
  <div class="card">
    <div class="card-header">
      <h6 class="mb-0"><i class="fas fa-circle-info me-2"></i>About Provenance Tracking</h6>
    </div>
    <div class="card-body">
      <div class="row">
        <div class="col-md-6">
