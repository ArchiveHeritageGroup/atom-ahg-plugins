      ...
      <tr>
        ...
        <td class="text-end">
          <div class="btn-group btn-group-sm">
            ...
            <form method="post" action="<?php echo url_for(['module' => 'registry', 'action' => 'adminInstitutionVerify']); ?>" class="d-inline" data-ahg-confirm="Are you sure you want to delete this institution? This cannot be undone.">
