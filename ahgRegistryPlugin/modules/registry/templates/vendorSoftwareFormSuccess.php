      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          <div class="row g-3">
            ...
            <div class="col-12">
              <label class="form-label"><?php echo __('Categories'); ?></label>
              <?php
                $cats = [
                  'ams' => __('Archival Management System'),
                  'cms' => __('Collection Management System'),
                  'dam' => __('Digital Asset Management'),
                  'ims' => __('Information Management System'),
                  'glam' => __('GLAM / DAM'),
                  'preservation' => __('Digital Preservation'),
                  'discovery' => __('Discovery / Access'),
                  'digitization' => __('Digitization'),
                  'integration' => __('Integration / Middleware'),
                  'plugin' => __('Plugin / Extension'),
                  'theme' => __('Theme / Template'),
                  'utility' => __('Utility / Tool'),
                  'other' => __('Other'),
                ];
                $rawCat = $f->category ?? '';
                $selCats = [];
                if ('' !== $rawCat) {
                  ...
                  if (is_array($decoded)) {
                    ...
                    $selCats = array_filter(array_map('trim', explode(',', (string) $rawCat)));
                  }
                }
              ?>
              <div class="row g-1">
                <?php foreach ($cats as $val => $label): ?>
                  <div class="col-md-4 col-sm-6">
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" id="sf-cat-<?php echo $val; ?>" name="category[]" value="<?php echo $val; ?>"<?php echo in_array($val, $selCats, true) ? ' checked' : ''; ?>>
                      <label class="form-check-label small" for="sf-cat-<?php echo $val; ?>"><?php echo $label; ?></label>
                    </div>
                  </div>
                <?php endforeach; ?>
              </div>
              <div class="form-text"><?php echo __('Select every category that applies — software can serve multiple sectors or functions.'); ?></div>
            </div>
            <div class="col-12">
