...
<?php
  ...
  $sortKey = $sf_request->getParameter('sort', 'sort_order');
  $sortDir = $sf_request->getParameter('dir', 'asc');
  $sortKey = in_array($sortKey, ['name', 'sort_order', 'acronym', 'publication_year', 'extension_count'], true) ? $sortKey : 'sort_order';
  ...
  $sortOptions = [
    'sort_order|asc' => __('Default'),
    'name|asc' => __('Name (A–Z)'),
    'name|desc' => __('Name (Z–A)'),
    'acronym|asc' => __('Acronym (A–Z)'),
    'publication_year|desc' => __('Newest publication'),
    'publication_year|asc' => __('Oldest publication'),
    'extension_count|desc' => __('Most extensions'),
  ];
      ...
      <?php if ('list' === $viewMode): ?>
        <div class="list-group">
          <?php foreach ($result['items'] as $item): ?>
            <?php include_partial('registry/standardListItem', ['item' => $item]); ?>
          <?php endforeach; ?>
        </div>
      <?php else: ?>
