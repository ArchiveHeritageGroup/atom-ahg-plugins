-- PSIS / AtoM-AHG - EU AI Act Article 12 record-keeping (PSIS twin of heratio).
--
-- Append-only tamper-evident chain of every AI inference call.
...
-- over the entry_hash. See the ahg/inference-receipts library on Packagist
-- for the protocol details.
--
-- Ported as-is from Heratio packages/ahg-ai-compliance/database/install.sql.
-- Schema is byte-compatible: receipts written by PSIS and Heratio can be
-- cross-verified by any consumer of the same nobulex-style test vectors.
...
-- ---------------------------------------------------------------------------
-- Merged in from database/ai_act_governance.sql on 2026-08-18.
--
