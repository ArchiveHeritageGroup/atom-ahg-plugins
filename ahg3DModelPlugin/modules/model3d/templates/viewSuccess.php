...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        <a href="<?php echo url_for(['module' => 'model3d', 'action' => 'edit', 'id' => $model->id]) ?>" class="btn btn-primary">
            <i class="fas fa-edit me-1"></i>Edit Settings
        </a>
        <?php endif ?>
        <a href="<?php echo url_for(['module' => 'model3d', 'action' => 'index']) ?>" class="btn btn-outline-secondary ms-1">
