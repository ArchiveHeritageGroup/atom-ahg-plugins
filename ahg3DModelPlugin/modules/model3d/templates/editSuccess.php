...
<nav aria-label="breadcrumb" class="mb-3">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo url_for(['module' => 'model3d', 'action' => 'index']) ?>">3D Models</a></li>
        <li class="breadcrumb-item"><a href="<?php echo url_for(['module' => 'model3d', 'action' => 'view', 'id' => $model->id]) ?>"><?php echo esc_entities($model->title ?: $model->original_filename) ?></a></li>
...
<form method="post">
    ...
    <div class="d-flex justify-content-between">
        <a href="<?php echo url_for(['module' => 'model3d', 'action' => 'view', 'id' => $model->id]) ?>" class="btn btn-outline-secondary">
