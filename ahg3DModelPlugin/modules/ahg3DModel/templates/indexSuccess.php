...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <a href="<?php echo url_for(['module' => 'ahg3DSettings', 'action' => 'index']) ?>" class="btn btn-outline-secondary">
        ...
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url_for(['module' => 'ahg3DModel', 'action' => 'view', 'id' => $model->id]) ?>">
...
<nav class="mt-3">
    <ul class="pagination justify-content-center">
        <?php if ($page > 1): ?>
        <li class="page-item">
            <a class="page-link" href="<?php echo url_for(['module' => 'ahg3DModel', 'action' => 'index', 'page' => $page - 1]) ?>">
                &laquo; Previous
            </a>
        </li>
        <?php endif ?>
        ...
        <li class="page-item <?php echo $i === $page ? 'active' : '' ?>">
            <a class="page-link" href="<?php echo url_for(['module' => 'ahg3DModel', 'action' => 'index', 'page' => $i]) ?>">
                <?php echo $i ?>
            </a>
        </li>
        <?php endfor ?>
