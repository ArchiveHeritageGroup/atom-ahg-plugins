...
$allowedFormats = $sf_data->getRaw('allowedFormats');
...
<p class="text-muted">Add a 3D model to: <strong><?php echo esc_entities($object->title) ?></strong></p>
    ...
    <div class="card-body">
        <form method="post" enctype="multipart/form-data" id="upload-form">
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="e.g., Bronze Statue - Front View">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="3" 
                                  placeholder="Describe the 3D model, its origin, scanning method, etc."></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="alt_text" name="alt_text" 
                               placeholder="A brief description for screen readers">
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between">
                <a href="/index.php/<?php echo $object->slug ?>" class="btn btn-outline-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fileInput.addEventListener('change', function() {
        if (this.files.length > 0) {
            ...
            fileSize.textContent = AhgHelpers.formatBytes(file.size);
