...
<div class="container-fluid px-0">
          ...
          <table class="table table-hover align-middle">
            ...
            <tbody>
              <?php foreach ($orders as $order): ?>
                ...
                <tr>
                  <td>
                    <a href="<?php echo url_for(['module' => 'cart', 'action' => 'orderConfirmation', 'order' => $order->order_number]); ?>">
                  ...
                  <td class="text-center">
                    ...
                    <?php if ($order->status === 'pending'): ?>
                      <a href="<?php echo url_for(['module' => 'cart', 'action' => 'payment', 'order' => $order->order_number]); ?>" 
  ...
  <div class="mt-3">
    <a href="<?php echo url_for(['module' => 'cart', 'action' => 'browse']); ?>" class="btn btn-outline-secondary">
