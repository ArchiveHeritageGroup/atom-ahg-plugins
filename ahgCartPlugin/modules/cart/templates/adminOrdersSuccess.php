...
<div class="container-fluid px-0">
            ...
            <tbody>
              <?php foreach ($orders as $order): ?>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?php echo url_for(['module' => 'cart', 'action' => 'adminOrderDetail', 'id' => $order->id]); ?>" 
  ...
  <div class="mt-4">
    <a href="<?php echo url_for(['module' => 'cart', 'action' => 'adminSettings']); ?>" class="btn btn-outline-secondary">
