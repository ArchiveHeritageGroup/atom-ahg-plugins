...
CREATE TABLE IF NOT EXISTS `ahg_payment` (
  ...
  `currency` VARCHAR(3) DEFAULT 'ZAR',
  `status` VARCHAR(60) COMMENT 'pending, processing, completed, failed, refunded' DEFAULT 'pending',
...
INSERT INTO `ahg_product_pricing` (`repository_id`, `product_type_id`, `name`, `description`, `price`, `is_active`) VALUES
