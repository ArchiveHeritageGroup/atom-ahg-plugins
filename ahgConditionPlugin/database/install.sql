...
CREATE TABLE IF NOT EXISTS `condition_damage` (
  ...
  `severity` VARCHAR(35) COMMENT 'minor, moderate, severe' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'minor',
...
CREATE TABLE IF NOT EXISTS `condition_image` (
  ...
  `image_type` VARCHAR(62) COMMENT 'general, detail, damage, before, after, raking, uv' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'general',
...
CREATE TABLE IF NOT EXISTS `condition_report` (
  ...
  `context` VARCHAR(133) COMMENT 'acquisition, loan_out, loan_in, loan_return, exhibition, storage, conservation, routine, incident, insurance, deaccession' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'routine',
  `overall_rating` VARCHAR(53) COMMENT 'excellent, good, fair, poor, unacceptable' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'good',
  `summary` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `recommendations` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `priority` VARCHAR(37) COMMENT 'low, normal, high, urgent' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'normal',
...
CREATE TABLE IF NOT EXISTS `condition_vocabulary` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `vocabulary_type` VARCHAR(79) COMMENT 'damage_type, severity, condition, priority, material, location_zone' COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `spectrum_condition_photo` (
  ...
  `photo_type` VARCHAR(57) COMMENT 'before, after, detail, damage, overall, other' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'detail',
  `caption` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `spectrum_condition_photos` (
  ...
  `category` VARCHAR(61) COMMENT 'overall, detail, damage, before, after, reference' CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'overall' COMMENT 'Photo category',
