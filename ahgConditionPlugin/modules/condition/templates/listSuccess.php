...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
        ...
        <?php if ($canManage): ?>
        <div>
            <a href="<?php echo url_for(['module' => 'condition', 'action' => 'template', 'template_action' => 'manage']) ?>" class="btn btn-primary">
        ...
        <div class="col-md-6 col-lg-4 mb-4 template-card" data-material="<?php echo $template->material_type ?>">
            <div class="card h-100 <?php echo !$template->is_active ? 'border-secondary opacity-50' : '' ?>">
                ...
                <div class="card-footer bg-transparent">
                    <a href="<?php echo url_for(['module' => 'condition', 'action' => 'template', 'template_action' => 'view', 'id' => $template->id]) ?>" class="btn btn-sm btn-outline-primary">
                        <i class="fas fa-eye me-1"></i> <?php echo __('View') ?>
                    </a>
                    <a href="<?php echo url_for(['module' => 'condition', 'action' => 'template', 'template_action' => 'export', 'id' => $template->id]) ?>" class="btn btn-sm btn-outline-secondary" download>
