...
<?php slot('content'); ?>
  ...
  <section id="content">
    ...
    <form method="post" action="<?php echo url_for([$resource, 'module' => 'securityClearance', 'action' => 'classify']); ?>">
      ...
      <section class="actions">
        <ul>
          <li><?php echo link_to(__('Cancel'), [$resource, 'module' => 'securityClearance', 'action' => 'object'], ['class' => 'c-btn']); ?></li>
          <?php if ($currentClassification): ?>
