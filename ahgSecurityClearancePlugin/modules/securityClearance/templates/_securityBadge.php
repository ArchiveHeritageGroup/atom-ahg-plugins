...
require_once sfConfig::get('sf_root_dir').'/plugins/ahgSecurityClearancePlugin/lib/Services/SecurityClearanceService.php';

$classification = SecurityClearanceService::getObjectClassification($resource->id);
...
$handlingInstructions = $classification->handling_instructions ?? null;
...
<div class="alert <?php echo $alertClass; ?> d-flex align-items-center mb-3 py-2" role="alert">
  <div class="flex-grow-1">
    ...
    <span class="badge <?php echo $badgeClass; ?> ms-2">
      <i class="fas <?php echo $classificationIcon; ?> me-1"></i>
      <?php echo $classificationName; ?>
    </span>
    <?php if ($handlingInstructions): ?>
      <br><small class="text-muted"><?php echo $handlingInstructions; ?></small>
    <?php endif; ?>
  </div>
</div>
