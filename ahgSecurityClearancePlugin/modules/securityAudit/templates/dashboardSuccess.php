...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-3">
                <a href="<?php echo url_for(['module' => 'securityClearance', 'action' => 'dashboard']) ?>" class="btn btn-outline-secondary w-100 mb-2">
                    <i class="fas fa-shield-alt"></i> <?php echo __('Security Dashboard') ?>
                </a>
            </div>
            <div class="col-md-3">
                <a href="<?php echo url_for(['module' => 'securityClearance', 'action' => 'report']) ?>" class="btn btn-outline-info w-100 mb-2">
