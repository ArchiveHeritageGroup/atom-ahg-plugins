        ...
        try {
            DB::statement("
                CREATE TABLE `{$tableName}` (
                    ...
                    `action` VARCHAR(48) COMMENT 'declassify, review, destroy, archive' NOT NULL DEFAULT 'review',
        ...
        try {
            DB::statement("
                CREATE TABLE `{$tableName}` (
                    ...
                    `validation_status` VARCHAR(48) COMMENT 'pending, valid, incomplete, rejected' DEFAULT 'pending',
