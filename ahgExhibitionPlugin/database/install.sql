...
CREATE TABLE IF NOT EXISTS `exhibition_venue` (
  ...
  `venue_type` VARCHAR(47) COMMENT 'internal, partner, external, online' COLLATE utf8mb4_unicode_ci DEFAULT 'internal',
  ...
  `accessibility_rating` VARCHAR(31) COMMENT 'none, partial, full' COLLATE utf8mb4_unicode_ci DEFAULT 'partial',
...
CREATE TABLE IF NOT EXISTS `exhibition_gallery` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gallery_type` VARCHAR(68) COMMENT 'gallery, hall, room, corridor, outdoor, foyer, stairwell' COLLATE utf8mb4_unicode_ci DEFAULT 'gallery',
...
CREATE TABLE IF NOT EXISTS `exhibition` (
  ...
  `exhibition_type` VARCHAR(59) COMMENT 'permanent, temporary, traveling, online, pop_up' COLLATE utf8mb4_unicode_ci DEFAULT 'temporary',
  `status` VARCHAR(99) COMMENT 'concept, planning, preparation, installation, open, closing, closed, archived, canceled' COLLATE utf8mb4_unicode_ci DEFAULT 'concept',
...
CREATE TABLE IF NOT EXISTS `exhibition_section` (
  ...
  `section_type` VARCHAR(61) COMMENT 'gallery, room, alcove, corridor, outdoor, virtual' COLLATE utf8mb4_unicode_ci DEFAULT 'gallery',
...
CREATE TABLE IF NOT EXISTS `exhibition_object` (
  ...
  `status` VARCHAR(78) COMMENT 'proposed, confirmed, on_loan_request, installed, removed, returned' COLLATE utf8mb4_unicode_ci DEFAULT 'proposed',
  ...
  `security_level` VARCHAR(39) COMMENT 'standard, enhanced, maximum' COLLATE utf8mb4_unicode_ci DEFAULT 'standard',
...
CREATE TABLE IF NOT EXISTS `exhibition_event` (
  ...
  `exhibition_id` bigint unsigned NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `event_type` VARCHAR(101) COMMENT 'opening, closing, tour, lecture, workshop, performance, family, school, vip, press, other' COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  ...
  `status` VARCHAR(53) COMMENT 'scheduled, confirmed, canceled, completed' COLLATE utf8mb4_unicode_ci DEFAULT 'scheduled',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_by` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `exhibition_checklist_template` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `checklist_type` VARCHAR(89) COMMENT 'planning, preparation, installation, opening, during, closing, deinstallation' COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `exhibition_checklist` (
  ...
  `status` VARCHAR(56) COMMENT 'not_started, in_progress, completed, overdue' COLLATE utf8mb4_unicode_ci DEFAULT 'not_started',
...
CREATE TABLE IF NOT EXISTS `exhibition_storyline` (
  ...
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `narrative_type` VARCHAR(154) COMMENT 'thematic, chronological, biographical, geographical, technique, custom, general, guided_tour, self_guided, educational, accessible, highlights' COLLATE utf8mb4_unicode_ci DEFAULT 'general',
  `introduction` text COLLATE utf8mb4_unicode_ci,
  `body_text` text COLLATE utf8mb4_unicode_ci,
  `conclusion` text COLLATE utf8mb4_unicode_ci,
  `sequence_order` int DEFAULT '0',
  `is_primary` tinyint(1) DEFAULT '0',
  `target_audience` VARCHAR(57) COMMENT 'general, children, students, specialists, all' COLLATE utf8mb4_unicode_ci DEFAULT 'all',
  `reading_level` VARCHAR(41) COMMENT 'basic, intermediate, advanced' COLLATE utf8mb4_unicode_ci DEFAULT 'intermediate',
...
CREATE TABLE IF NOT EXISTS `exhibition_media` (
  ...
  `exhibition_id` bigint unsigned NOT NULL,
  `section_id` bigint unsigned DEFAULT NULL,
  `media_type` VARCHAR(67) COMMENT 'image, video, audio, document, floorplan, poster, press' COLLATE utf8mb4_unicode_ci NOT NULL,
  `usage_type` VARCHAR(78) COMMENT 'promotional, installation, documentation, press, catalog, internal' COLLATE utf8mb4_unicode_ci DEFAULT 'documentation',
...
-- ============================================================================
-- heratio#146 — front-of-house space allocation (PSIS port).
-- ============================================================================
CREATE TABLE IF NOT EXISTS `ahg_exhibition_space` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `space_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'gallery' COMMENT 'one of: gallery, hall, display_case, plinth, vitrine',
  `building` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `floor` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `capacity_value` decimal(12,2) DEFAULT NULL,
  `capacity_unit` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'linear_wall_meters' COMMENT 'one of: linear_wall_meters, display_cases, plinths, square_meters',
  `lighting_lux_target` decimal(8,2) DEFAULT NULL,
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `room_width` decimal(8,2) NOT NULL DEFAULT '1200.00',
  `room_height` decimal(8,2) NOT NULL DEFAULT '700.00',
  `wall_color` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#f3f0ea',
  `floor_color` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '#d8c9ac',
  `room_w` decimal(8,2) DEFAULT NULL,
  `room_d` decimal(8,2) DEFAULT NULL,
  `room_h` decimal(8,2) DEFAULT NULL,
  `building_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `building_seq` int DEFAULT NULL,
  `bld_x` decimal(12,4) DEFAULT NULL,
  `bld_y` decimal(12,4) DEFAULT NULL,
  `bld_rot` decimal(8,2) DEFAULT NULL,
  `bld_locked` tinyint(1) NOT NULL DEFAULT '0',
  `bld_group` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `floor_level` int NOT NULL DEFAULT '0',
  `is_outdoor` tinyint(1) NOT NULL DEFAULT '0',
  `walls_json` text COLLATE utf8mb4_unicode_ci,
  `doors_json` text COLLATE utf8mb4_unicode_ci,
  `windows_json` text COLLATE utf8mb4_unicode_ci,
  `shape_json` text COLLATE utf8mb4_unicode_ci,
  `wall_colors_json` text COLLATE utf8mb4_unicode_ci,
  `wall_images_json` text COLLATE utf8mb4_unicode_ci,
  `wall_image_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ceiling_image_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `floorplan_image_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `floor_image_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `floor_grout` tinyint(1) NOT NULL DEFAULT '0',
  `floor_tile_m` decimal(8,2) DEFAULT NULL,
  `floor_grout_mm` decimal(8,2) DEFAULT NULL,
  `scan_shell_path` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `scan_shell_scale` decimal(8,2) DEFAULT NULL,
  `scan_embed_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `furniture_json` text COLLATE utf8mb4_unicode_ci,
  `stairs_json` text COLLATE utf8mb4_unicode_ci,
  `sensor_token` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `floorplan_width_m` decimal(8,2) DEFAULT NULL,
  `floorplan_height_m` decimal(8,2) DEFAULT NULL,
  `walkthrough_path_json` json DEFAULT NULL,
  `building_plan_image` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `building_plan_x` decimal(8,2) DEFAULT NULL,
  `building_plan_y` decimal(8,2) DEFAULT NULL,
  `building_plan_w` decimal(8,2) DEFAULT NULL,
  `building_plan_h` decimal(8,2) DEFAULT NULL,
  `guided_tour_json` json DEFAULT NULL,
  `ric_activity_id` bigint DEFAULT NULL,
  `intro_text` text COLLATE utf8mb4_unicode_ci,
  `room_blurb` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `ahg_exhibition_placement` (
  ...
  `size_units_used` decimal(12,2) NOT NULL DEFAULT '0.00',
  ...
  `item_w` decimal(8,2) NOT NULL DEFAULT '120.00',
  `item_h` decimal(8,2) NOT NULL DEFAULT '120.00',
  `wall` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'north',
  `z_order` int NOT NULL DEFAULT '0',
  `rotation` decimal(6,2) NOT NULL DEFAULT '0.00',
  `tour_order` int DEFAULT NULL,
  `rotation_deg` decimal(8,2) DEFAULT NULL,
  `scale` decimal(8,4) NOT NULL DEFAULT '1.0000',
  `label_visible` tinyint(1) NOT NULL DEFAULT '1',
  `wall_or_zone` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `wall_u` decimal(8,4) DEFAULT NULL,
  `wall_v` decimal(8,4) DEFAULT NULL,
  `model_tilt_x` decimal(8,2) DEFAULT NULL,
  `model_tilt_z` decimal(8,2) DEFAULT NULL,
  `spotlight` int NOT NULL DEFAULT '0',
  `display_case` tinyint(1) NOT NULL DEFAULT '0',
  `on_floor` tinyint(1) NOT NULL DEFAULT '0',
  `view_x` decimal(8,4) DEFAULT NULL,
  `view_y` decimal(8,4) DEFAULT NULL,
  `remote_peer_id` int DEFAULT NULL,
  `remote_ref` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remote_payload` json DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ix_exh_placement_space` (`exhibition_space_id`),
  KEY `ix_exh_placement_io` (`information_object_id`),
