...
CREATE TABLE IF NOT EXISTS `exhibition_venue` (
  ...
  `venue_type` enum('internal','partner','external','online') COLLATE utf8mb4_unicode_ci DEFAULT 'internal',
  ...
  `accessibility_rating` enum('none','partial','full') COLLATE utf8mb4_unicode_ci DEFAULT 'partial',
...
CREATE TABLE IF NOT EXISTS `exhibition_gallery` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `code` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gallery_type` enum('gallery','hall','room','corridor','outdoor','foyer','stairwell') COLLATE utf8mb4_unicode_ci DEFAULT 'gallery',
...
CREATE TABLE IF NOT EXISTS `exhibition` (
  ...
  `exhibition_type` enum('permanent','temporary','traveling','online','pop_up') COLLATE utf8mb4_unicode_ci DEFAULT 'temporary',
  `status` enum('concept','planning','preparation','installation','open','closing','closed','archived','canceled') COLLATE utf8mb4_unicode_ci DEFAULT 'concept',
...
CREATE TABLE IF NOT EXISTS `exhibition_section` (
  ...
  `section_type` enum('gallery','room','alcove','corridor','outdoor','virtual') COLLATE utf8mb4_unicode_ci DEFAULT 'gallery',
...
CREATE TABLE IF NOT EXISTS `exhibition_object` (
  ...
  `status` enum('proposed','confirmed','on_loan_request','installed','removed','returned') COLLATE utf8mb4_unicode_ci DEFAULT 'proposed',
  ...
  `security_level` enum('standard','enhanced','maximum') COLLATE utf8mb4_unicode_ci DEFAULT 'standard',
...
CREATE TABLE IF NOT EXISTS `exhibition_event` (
  ...
  `exhibition_id` bigint unsigned NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `event_type` enum('opening','closing','tour','lecture','workshop','performance','family','school','vip','press','other') COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  ...
  `status` enum('scheduled','confirmed','canceled','completed') COLLATE utf8mb4_unicode_ci DEFAULT 'scheduled',
  `notes` text COLLATE utf8mb4_unicode_ci,
  `created_by` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `exhibition_checklist_template` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `checklist_type` enum('planning','preparation','installation','opening','during','closing','deinstallation') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `exhibition_checklist` (
  ...
  `status` enum('not_started','in_progress','completed','overdue') COLLATE utf8mb4_unicode_ci DEFAULT 'not_started',
...
CREATE TABLE IF NOT EXISTS `exhibition_storyline` (
  ...
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8mb4_unicode_ci,
  `narrative_type` enum('thematic','chronological','biographical','geographical','technique','custom','general','guided_tour','self_guided','educational','accessible','highlights') COLLATE utf8mb4_unicode_ci DEFAULT 'general',
  `introduction` text COLLATE utf8mb4_unicode_ci,
  `body_text` text COLLATE utf8mb4_unicode_ci,
  `conclusion` text COLLATE utf8mb4_unicode_ci,
  `sequence_order` int DEFAULT '0',
  `is_primary` tinyint(1) DEFAULT '0',
  `target_audience` enum('general','children','students','specialists','all') COLLATE utf8mb4_unicode_ci DEFAULT 'all',
  `reading_level` enum('basic','intermediate','advanced') COLLATE utf8mb4_unicode_ci DEFAULT 'intermediate',
...
CREATE TABLE IF NOT EXISTS `exhibition_media` (
  ...
  `exhibition_id` bigint unsigned NOT NULL,
  `section_id` bigint unsigned DEFAULT NULL,
  `media_type` enum('image','video','audio','document','floorplan','poster','press') COLLATE utf8mb4_unicode_ci NOT NULL,
  `usage_type` enum('promotional','installation','documentation','press','catalog','internal') COLLATE utf8mb4_unicode_ci DEFAULT 'documentation',
