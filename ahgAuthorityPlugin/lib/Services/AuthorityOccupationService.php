...
/**
 * Service #9: Authority Occupation Service (#205)
 *
...
class AuthorityOccupationService
{
    ...
    {
        // Look for occupation terms in the Actor Occupation taxonomy
        // AtoM taxonomy ID may vary; check for taxonomy with name containing "occupation"
    ...
    {
        // Try to find existing occupation taxonomy
