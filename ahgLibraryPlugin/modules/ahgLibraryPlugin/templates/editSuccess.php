  ...
  <div class="row">
    ...
    <div class="col-md-4">
      ...
      <section class="card mb-4 sticky-top" style="top: 1rem; z-index: 100;">
        ...
        <div class="card-body">
          ...
          <?php if (isset($resource->id)): ?>
            <a href="<?php echo url_for(['module' => 'ahgLibraryPlugin', 'action' => 'index', 'slug' => ($resource->slug ?? '')]); ?>" class="btn btn-outline-secondary w-100 mb-2">
      ...
      <section class="card mb-4">
        ...
        <div class="card-body">
          <a href="<?php echo url_for(['module' => 'ahgLibraryPlugin', 'action' => 'browse']); ?>" class="btn btn-outline-primary w-100 mb-2">
    ...
    if (isbnInput) {
        isbnInput.addEventListener('blur', function() {
            ...
            if (isbn.length >= 10) {
                ...
                if (coverPreview) {
                    coverPreview.innerHTML =
                        '<img src="https://covers.openlibrary.org/b/isbn/' + isbn + '-M.jpg" class="img-fluid rounded shadow-sm" style="max-height:250px" onerror="this.style.display=\'none\'">' +
                        '<div class="mt-2"><small class="text-muted">Open Library</small></div>' +
