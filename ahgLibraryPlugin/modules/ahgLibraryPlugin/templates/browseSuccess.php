...
<div class="d-flex justify-content-between align-items-center mb-4">
  ...
  <div>
    <a href="<?php echo url_for(['module' => 'ahgLibraryPlugin', 'action' => 'edit']); ?>" class="btn btn-success">
        ...
        <div class="card h-100 shadow-sm">
          ...
          <div class="card-img-top bg-light d-flex align-items-center justify-content-center" style="height: 200px; overflow: hidden;">
            ...
            <?php elseif (!empty($cleanIsbn)): ?>
              <img src="https://covers.openlibrary.org/b/isbn/<?php echo $cleanIsbn; ?>-M.jpg" alt="Cover" 
                   class="img-fluid" style="max-height: 200px; width: auto;"
                   onerror="this.parentElement.innerHTML='<i class=\'fas fa-book fa-4x text-muted\'></i>'">
            <?php else: ?>
          ...
          <div class="card-body">
            <h5 class="card-title">
              <a href="<?php echo url_for(['module' => 'ahgLibraryPlugin', 'action' => 'index', 'slug' => $item['slug']]); ?>" class="text-decoration-none">
          ...
          <div class="card-footer bg-transparent">
            <div class="btn-group w-100">
              <a href="<?php echo url_for(['module' => 'ahgLibraryPlugin', 'action' => 'index', 'slug' => $item['slug']]); ?>" class="btn btn-sm btn-outline-primary">
                <i class="fas fa-eye me-1"></i><?php echo __('View'); ?>
              </a>
              <a href="<?php echo url_for(['module' => 'ahgLibraryPlugin', 'action' => 'edit', 'slug' => $item['slug']]); ?>" class="btn btn-sm btn-outline-secondary">
  ...
  <?php if ($totalPages > 1): ?>
    <nav aria-label="Page navigation" class="mt-4">
      <ul class="pagination justify-content-center">
        <?php if ($page > 1): ?>
          <li class="page-item">
            <a class="page-link" href="<?php echo url_for(['module' => 'ahgLibraryPlugin', 'action' => 'browse', 'page' => $page - 1]); ?>">
        ...
        <?php if ($startPage > 1): ?>
          <li class="page-item">
            <a class="page-link" href="<?php echo url_for(['module' => 'ahgLibraryPlugin', 'action' => 'browse', 'page' => 1]); ?>">1</a>
          </li>
          <?php if ($startPage > 2): ?>
        ...
        <?php for ($i = $startPage; $i <= $endPage; $i++): ?>
          <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
            <a class="page-link" href="<?php echo url_for(['module' => 'ahgLibraryPlugin', 'action' => 'browse', 'page' => $i]); ?>"><?php echo $i; ?></a>
          </li>
        <?php endfor; ?>
        ...
        <?php if ($endPage < $totalPages): ?>
          ...
          <?php endif; ?>
          <li class="page-item">
            <a class="page-link" href="<?php echo url_for(['module' => 'ahgLibraryPlugin', 'action' => 'browse', 'page' => $totalPages]); ?>"><?php echo $totalPages; ?></a>
          </li>
        <?php endif; ?>
