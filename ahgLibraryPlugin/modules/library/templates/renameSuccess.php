...
<?php slot('sidebar'); ?>
  <?php include_partial('library/librarySidebar', ['resource' => $resource, 'sf_user' => $sf_user]); ?>
<?php end_slot(); ?>
...
<?php slot('content'); ?>
  ...
  <?php echo $form->renderFormTag(url_for(['module' => 'library', 'action' => 'rename', 'slug' => $resource->slug]), ['id' => 'rename-form']); ?>
    ...
    <ul class="actions mb-3 nav gap-2">
      <li><?php echo link_to(__('Cancel'), ['module' => 'library', 'action' => 'index', 'slug' => $resource->slug], ['class' => 'btn atom-btn-outline-light', 'role' => 'button']); ?></li>
