...
<?php slot('context-menu'); ?>
    ...
    <section class="card mb-4">
      ...
      <div class="card-body">
        <a href="<?php echo url_for(['module' => 'library', 'action' => 'edit', 'slug' => $resource->slug]); ?>" class="btn btn-primary w-100 mb-2">
          <i class="fas fa-edit me-2"></i><?php echo __('Edit'); ?>
        </a>
        <a href="<?php echo url_for(['module' => 'library', 'action' => 'add', 'parent' => $resource->slug]); ?>" class="btn btn-success w-100 mb-2">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end w-100">
            <li><a class="dropdown-item" href="<?php echo url_for(['module' => 'library', 'action' => 'rename', 'slug' => $resource->slug]); ?>"><i class="fas fa-i-cursor me-2"></i><?php echo __('Rename'); ?></a></li>
    ...
    <script src="/plugins/ahgLibraryPlugin/web/js/JsBarcode.all.min.js"></script>
    ...
    <section class="card mb-4">
      ...
      <div class="card-body">
        ...
        <a href="<?php echo url_for(['module' => 'library', 'action' => 'index', 'slug' => $resource->parent->slug]); ?>" class="btn btn-outline-secondary w-100 mb-2">
