...
-- Create terms in taxonomy 34 (Level of Description)
-- First create object entries, then term, term_i18n, and slug
...
INSERT INTO slug (object_id, slug) VALUES (@book_id, 'book');
...
INSERT INTO slug (object_id, slug) VALUES (@mono_id, 'monograph');
...
INSERT INTO slug (object_id, slug) VALUES (@peri_id, 'periodical');
...
INSERT INTO slug (object_id, slug) VALUES (@jour_id, 'journal');
...
INSERT INTO slug (object_id, slug) VALUES (@arti_id, 'article');
...
INSERT INTO slug (object_id, slug) VALUES (@manu_id, 'manuscript');
INSERT IGNORE INTO level_of_description_sector (term_id, sector, display_order) VALUES (@manu_id, 'library', 50);

-- Document (may already exist, so check first)
INSERT INTO level_of_description_sector (term_id, sector, display_order)
SELECT t.id, 'library', 60
FROM term t
JOIN term_i18n ti ON t.id = ti.id AND ti.culture = 'en'
WHERE t.taxonomy_id = 34 AND ti.name = 'Document'
ON DUPLICATE KEY UPDATE display_order = 60;

-- Register plugin
INSERT IGNORE INTO atom_plugin (name, is_enabled, version) VALUES
('ahgLibraryPlugin', 1, '1.0.0');
