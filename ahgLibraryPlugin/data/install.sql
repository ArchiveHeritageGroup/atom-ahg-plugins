...
-- Book
SET @book_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Book' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
-- Monograph
SET @mono_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Monograph' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
-- Periodical
SET @peri_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Periodical' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
-- Journal
SET @jour_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Journal' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
-- Article
SET @arti_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Article' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
-- Manuscript
SET @manu_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Manuscript' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
...
SET @doc_exists = (SELECT id FROM term t JOIN term_i18n ti ON t.id=ti.id WHERE t.taxonomy_id=34 AND ti.name='Document' LIMIT 1);
INSERT INTO object (class_name, created_at, updated_at)
