...
Online help system with searchable documentation, contextual help, and FlexSearch-powered instant search
...
cd tmp-fetch && git sparse-checkout set ahgHelpPlugin && cd ..
mv tmp-fetch/ahgHelpPlugin ./ahgHelpPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgHelpPlugin/database/install.sql
