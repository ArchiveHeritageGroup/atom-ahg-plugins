...
<div class="sidebar-content">
    <div class="card mb-3">
        ...
        <div class="card-body py-2">
            ...
            <a href="<?php echo url_for(['module' => 'aiCondition', 'action' => 'clients']) ?>" class="btn btn-outline-secondary btn-sm w-100 mb-2">
                <i class="fas fa-key me-1"></i><?php echo __('API Clients') ?>
            </a>
            <a href="<?php echo url_for(['module' => 'aiCondition', 'action' => 'settings']) ?>" class="btn btn-outline-secondary btn-sm w-100">
...
<p class="text-muted small mb-3"><?php echo __('AI-powered damage detection for archival materials') ?></p>
<?php end_slot() ?>

<?php slot('content') ?>
<!-- Filters -->
<div class="d-flex gap-2 mb-3 flex-wrap">
    <form method="get" action="<?php echo url_for(['module' => 'aiCondition', 'action' => 'index']) ?>" class="d-flex gap-2 flex-wrap">
    ...
    <table class="table table-hover table-sm align-middle">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><?php echo AiConditionHelper::scoreDisplay($a->overall_score) ?></td>
                <td class="text-center"><?php echo AiConditionHelper::gradeBadge($a->condition_grade) ?></td>
...
<nav>
    <ul class="pagination pagination-sm justify-content-center">
        ...
        <li class="page-item <?php echo $p === $page ? 'active' : '' ?>">
            <a class="page-link" href="<?php echo url_for(['module' => 'aiCondition', 'action' => 'index', 'page' => $p]) ?>"><?php echo $p ?></a>
        </li>
        <?php endfor ?>
    </ul>
</nav>
