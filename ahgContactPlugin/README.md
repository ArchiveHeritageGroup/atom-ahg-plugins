...
Contact information management for actors and repositories

| | |
|---|---|
| Machine name | `ahgContactPlugin` |
| Version | 1.0.0 |
| Category | ahg |
...
cd tmp-fetch && git sparse-checkout set ahgContactPlugin && cd ..
mv tmp-fetch/ahgContactPlugin ./ahgContactPlugin && rm -rf tmp-fetch

# 2. Apply the schema.
mysql -u <user> -p <database> < ahgContactPlugin/database/install.sql
