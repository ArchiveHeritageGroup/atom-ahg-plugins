...
<?php slot('content'); ?>
  ...
  <form method="post" action="<?php echo $isNew ? url_for('@donor_add_override') : url_for('@donor_edit_override?slug=' . $donor['slug']); ?>" id="editForm">
    ...
    <ul class="actions mb-3 nav gap-2">
      <?php if (!$isNew) { ?>
        <li><?php echo link_to(__('Cancel'), '@donor_view_override?slug=' . $donor['slug'], ['class' => 'btn atom-btn-outline-light', 'role' => 'button']); ?></li>
        <li><input class="btn atom-btn-outline-success" type="submit" value="<?php echo __('Save'); ?>"></li>
      <?php } else { ?>
        <li><?php echo link_to(__('Cancel'), '@donor_browse_override', ['class' => 'btn atom-btn-outline-light', 'role' => 'button']); ?></li>
